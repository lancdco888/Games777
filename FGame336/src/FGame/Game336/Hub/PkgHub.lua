...
function PkgHub:ctor(...)
    ...
    self.protoMap = {
        ...
        ['PKG_Client_Slots_DragonGiftFreeSpin'] = 'PB.Client_Slots.DragonGiftFreeSpin',
        ['PKG_Slots_Client_DragonGiftNormalRet'] = 'PB.Slots_Client.DragonGiftNormalRet',
        ['PKG_Client_Slots_DragonGiftSpecialSpin'] = 'PB.Client_Slots.DragonGiftSpecialSpin',
        ['PKG_Slots_Client_DragonGiftFreeRet'] = 'PB.Slots_Client.DragonGiftFreeRet',
        ['PKG_Slots_Client_OfflineCheck'] = 'PB.Slots_Client.OfflineCheck',
        ['PKG_Slots_Client_DragonGiftSpecialRet'] = 'PB.Slots_Client.DragonGiftSpecialRet',
        ['PKG_Slots_Client_DragonGiftEnterResumed'] = 'PB.Slots_Client.DragonGiftEnterResumed',
        ['PKG_Client_Slots_DragonGiftNormalSpin'] = 'PB.Client_Slots.DragonGiftNormalSpin',
...
function PkgHub:Pkg2Pb(pkg)
    ...
    elseif pkg.typeName == 'PKG_Slots_Client_CollectValue' then
        ...
        return pb
    elseif pkg.typeName == 'PKG_Slots_Client_DragonGiftNormalRet' then
        pb.normalSpin = {}
        ...
        for ik, iv in pairs(pkg.grids) do
            ...
            pb.normalSpin.grids[ik].SymbolBet = iv.SymbolBet
        end
        ...
        for ik, iv in pairs(pkg.lines) do
            ...
            for jk, jv in pairs(iv.lineCells) do
                ...
                pb.normalSpin.lines[ik].lineCells[jk].SymbolBet = jv.SymbolBet
            end
        end
        ...
        return pb
    elseif pkg.typeName == 'PKG_Slots_Client_DragonGiftFreeRet' then
        pb.freeSpin = {}
        ...
        for ik, iv in pairs(pkg.grids) do
            ...
            pb.freeSpin.grids[ik].SymbolBet = iv.SymbolBet
        end
        ...
        for ik, iv in pairs(pkg.lines) do
            ...
            for jk, jv in pairs(iv.lineCells) do
                ...
                pb.freeSpin.lines[ik].lineCells[jk].SymbolBet = jv.SymbolBet
            end
        end
        
        pb.freeSpin.newFreeTime = pkg.newFreeTime
        pb.freeSpin.intoSpecial = pkg.intoSpecial
        -- error("未实现字段 pb.freeSpin.lockStates 的转换")
    ...
    elseif pkg.typeName == 'PKG_Slots_Client_OfflineCheck' then
        return pb
    elseif pkg.typeName == 'PKG_Slots_Client_DragonGiftSpecialRet' then
        pb.specialSpin = {}
        ...
        for ik, iv in pairs(pkg.grids) do
            ...
            pb.specialSpin.grids[ik].SymbolBet = iv.SymbolBet
        end
        ...
        for ik, iv in pairs(pkg.lines) do
            ...
            for jk, jv in pairs(iv.lineCells) do
                ...
                pb.specialSpin.lines[ik].lineCells[jk].SymbolBet = jv.SymbolBet
            end
        end
        
        -- error("未实现字段 pb.specialSpin.addTime 的转换")
        ...
        return pb
    elseif pkg.typeName == 'PKG_Slots_Client_DragonGiftEnterResumed' then
        pb.enterBase = {}
        ...
        for ik, iv in pairs(pkg.resumedNormal.grids) do
            ...
            pb.resumedNormal.normalSpin.grids[ik].SymbolBet = iv.SymbolBet
        end
        ...
        for ik, iv in pairs(pkg.resumedNormal.lines) do
            ...
            for jk, jv in pairs(iv.lineCells) do
                ...
                pb.resumedNormal.normalSpin.lines[ik].lineCells[jk].SymbolBet = jv.SymbolBet
            end
        end
        ...
        for ik, iv in pairs(pkg.resumedFree.grids) do
            ...
            pb.resumedFree.freeSpin.grids[ik].SymbolBet = iv.SymbolBet
        end
        ...
        for ik, iv in pairs(pkg.resumedFree.lines) do
            ...
            for jk, jv in pairs(iv.lineCells) do
                ...
                pb.resumedFree.freeSpin.lines[ik].lineCells[jk].SymbolBet = jv.SymbolBet
            end
        end
        ...
        -- error("未实现字段 pb.resumedFree.freeSpin.lockStates 的转换")
        ...
        for ik, iv in pairs(pkg.resumedSpecial.grids) do
            ...
            pb.resumedSpecial.specialSpin.grids[ik].SymbolBet = iv.SymbolBet
        end
        ...
        for ik, iv in pairs(pkg.resumedSpecial.lines) do
            ...
            for jk, jv in pairs(iv.lineCells) do
                ...
                pb.resumedSpecial.specialSpin.lines[ik].lineCells[jk].SymbolBet = jv.SymbolBet
            end
        end
        
        -- error("未实现字段 pb.resumedSpecial.specialSpin.addTime 的转换")
...
function PkgHub:Pb2Pkg(pb)
    if pb._msgName_ == 'PB.Client_Slots.DragonGiftFreeSpin' then
        local pkg = PKG_Client_Slots_DragonGiftFreeSpin.Create()
        return pkg
    elseif pb._msgName_ == 'PB.Client_Slots.DragonGiftSpecialSpin' then
        local pkg = PKG_Client_Slots_DragonGiftSpecialSpin.Create()
        return pkg
    elseif pb._msgName_ == 'PB.Client_Slots.DragonGiftNormalSpin' then
        local pkg = PKG_Client_Slots_DragonGiftNormalSpin.Create()
