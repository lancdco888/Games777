...
function BaseSlot:SetVisible(value)
    -- print("BaseSlot:SetVisible::value>>>>>>>>>>>>"..(value and "true" or "false"))
...
function BaseSlot:GetOrCreateTopSymbol(index)
    -- print("BaseSlot:GetOrCreateTopSymbol>>>>>>>>>>>")
    ...
    if not render then
        ...
        render = FairyGUI.UIPackage.CreateObject("Game388", "Symbol")
...
function BaseSlot:RemoveTopSymbol()
    -- print("BaseSlot:RemoveTopSymbol>>>>>>>>>>>>>>>>>")
