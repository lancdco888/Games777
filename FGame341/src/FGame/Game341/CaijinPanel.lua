    ...
    for k, info in pairs(self.jackpotInfos) do
        ...
        if uiJackpot then
            ...
            if info["betOrMoney"] == 0 then
                ...
                uiJackpot.lobby_label.text = FConfig.Common.LotteryLobbyRateTextPrefix .. FToolSet.FixedDecimalPlaces(value, 2)
            else
                ...
                if uiJackpot.value ~= value then
                    ...
                    :OnUpdate(function(tweener)
                        ...
                        uiJackpot.lobby_label.text = FConfig.Common.LotteryLobbyRateTextPrefix .. FToolSet.FixedDecimalPlaces(text, 2)
                    end)
                    :OnComplete(function()
                        uiJackpot.tweener = nil
                    end)
