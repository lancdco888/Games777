...
function PkgHub:Pkg2Pb(pkg)
    ...
    elseif pkg.typeName == 'PKG_Slots_Client_EyesOfWealthFreeRet' then
        ...
        pb.freeSpin.intoSpecial = pkg.freeSpin.intoSpecial
    ...
    elseif pkg.typeName == 'PKG_Slots_Client_EyesOfWealthEnterResumed' then
        ...
        pb.resumedFree.freeSpin.intoSpecial = pkg.resumedFree.freeSpin.intoSpecial
        ...
        pb.resumedSpecial.specialSpin.addTime = pkg.resumedSpecial.specialSpin.addTime
        pb.resumedSpecial.specialSpin.lockStates = pkg.resumedSpecial.specialSpin.lockStates
    ...
    elseif pkg.typeName == 'PKG_Slots_Client_EyesOfWealthSpecialRet' then
        ...
        pb.specialSpin.addTime = pkg.specialSpin.addTime
        pb.specialSpin.lockStates = pkg.specialSpin.lockStates
