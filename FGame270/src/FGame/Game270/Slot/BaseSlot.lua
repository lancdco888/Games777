...
function BaseSlot:GetOrCreateTopSymbol(index, big)
    ...
    if not render then
        ...
        if big then
            render = FairyGUI.UIPackage.CreateObject(Defined.GameName, "BigSymbol")
        else
            render = FairyGUI.UIPackage.CreateObject(Defined.GameName, "Symbol")
        end
