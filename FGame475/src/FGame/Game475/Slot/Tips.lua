...
function Tips:PlayBoom()
    ...
    self.boom.movieClip:SetPlaySettings(0,-1,1,-1,
        function ()
            self.boom.visible = false
            self.boom.movieClip.playing = false
            self.boom.movieClip.frame = 0
        end
    )
    self.boom.movieClip.playing = true
end
...
function Tips:PlayTopAnim(cb, num)
    ...
    self.num.text = FToolSet.NumToStr(self.num_number)
