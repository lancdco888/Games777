...
CodeGen_slot_271_md5 ="#*MD5<9ec71eb86ad5a3d6fef5067efe3b1776>*#"

--[[
Sugar请求特殊旋转图形
]]
PKG_DragonKing_NormalSpin = {
    typeName = "PKG_DragonKing_NormalSpin",
    typeId = 30691,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DragonKing_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.DragonKing.Cell>
        o.wildBet = 0 -- Int32
        ...
        o.lines = {} -- List<PKG.DragonKing.Line>
        --[[
        是否进入收集游戏
        ]]
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_DragonKing_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- wildBet
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_DragonKing_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoCollect
...
PKG_DragonKing_NormalSpin.__index = PKG_DragonKing_NormalSpin

--[[
免费类型选择
]]
PKG_DragonKing_FreeType = {
    typeName = "PKG_DragonKing_FreeType",
    typeId = 30692,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DragonKing_FreeType)
        end
        --[[
        倍率类型
        ]]
...
PKG_DragonKing_FreeType.__index = PKG_DragonKing_FreeType

--[[
Sugar请求特殊旋转图形
]]
PKG_DragonKing_FreeSpin = {
    typeName = "PKG_DragonKing_FreeSpin",
    typeId = 30693,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DragonKing_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_DragonKing_FreeSpin.__index = PKG_DragonKing_FreeSpin

--[[
狂野蛮牛-普通结果
]]
PKG_Slots_Client_DragonKingNormalRet = {
    typeName = "PKG_Slots_Client_DragonKingNormalRet", -- : PKG_DragonKing_NormalSpin
    typeId = 30697,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DragonKingNormalRet)
        end
        PKG_DragonKing_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_DragonKing_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_DragonKing_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_DragonKingNormalRet.__index = PKG_Slots_Client_DragonKingNormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_DragonKingFreeRetType = {
    typeName = "PKG_Slots_Client_DragonKingFreeRetType", -- : PKG_DragonKing_FreeType
    typeId = 30698,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DragonKingFreeRetType)
        end
        PKG_DragonKing_FreeType.Create(o)
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- base read
        r = PKG_DragonKing_FreeType.Read(self, om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_DragonKing_FreeType.Write(self, om)
    end
}
PKG_Slots_Client_DragonKingFreeRetType.__index = PKG_Slots_Client_DragonKingFreeRetType

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_DragonKingFreeRet = {
    typeName = "PKG_Slots_Client_DragonKingFreeRet", -- : PKG_DragonKing_FreeSpin
    typeId = 30699,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DragonKingFreeRet)
        end
        PKG_DragonKing_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_DragonKing_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_DragonKing_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_DragonKingFreeRet.__index = PKG_Slots_Client_DragonKingFreeRet
...
PKG_Client_Slots_DragonKingFreeSpin = {
    typeName = "PKG_Client_Slots_DragonKingFreeSpin",
    typeId = 30696,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_DragonKingFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_DragonKingFreeSpin.__index = PKG_Client_Slots_DragonKingFreeSpin
...
PKG_Slots_Client_DragonKingEnterResumed = {
    typeName = "PKG_Slots_Client_DragonKingEnterResumed",
    typeId = 30700,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DragonKingEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_DragonKingNormalRet.Create() -- PKG.Slots_Client.DragonKingNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_DragonKingFreeRet.Create() -- PKG.Slots_Client.DragonKingFreeRet
        --[[
        恢复免费类型结果
        ]]
        o.freeType = PKG_Slots_Client_DragonKingFreeRetType.Create() -- PKG.Slots_Client.DragonKingFreeRetType
        --[[
        游戏彩金已开的数组
        ]]
        o.cells = {} -- List<Int32>
    ...
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_DragonKingNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_DragonKingFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        -- freeType
        self.freeType = PKG_Slots_Client_DragonKingFreeRetType.Create(); r = self.freeType:Read(om)
        if r ~= 0 then return r end
        -- cells
        r, len = d:Rvu32()
        if len > d:GetLeft() then return -1 end
...
PKG_Slots_Client_DragonKingEnterResumed.__index = PKG_Slots_Client_DragonKingEnterResumed

--[[
发财树 请求免费类型
]]
PKG_Client_Slots_DragonKingFreeType = {
    typeName = "PKG_Client_Slots_DragonKingFreeType",
    typeId = 30695,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_DragonKingFreeType)
        end
        --[[
        押注类型
        ]]
...
PKG_Client_Slots_DragonKingFreeType.__index = PKG_Client_Slots_DragonKingFreeType

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_DragonKingNormalSpin = {
    typeName = "PKG_Client_Slots_DragonKingNormalSpin",
    typeId = 30694,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_DragonKingNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_DragonKingNormalSpin.__index = PKG_Client_Slots_DragonKingNormalSpin
...
PKG_DragonKing_Cell = {
    typeName = "PKG_DragonKing_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DragonKing_Cell)
        end
        --[[
        点对应下标
        ]]
    ...
    Write = function(self, om)
        ...
        d:Wvi32(self.icon)
        -- backinfos
        d:Wvi32(self.backinfos)
    end
}
PKG_DragonKing_Cell.__index = PKG_DragonKing_Cell

PKG_DragonKing_Line = {
    typeName = "PKG_DragonKing_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DragonKing_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.DragonKing.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_DragonKing_Line.__index = PKG_DragonKing_Line
...
local o = ObjMgr
o.Register(PKG_DragonKing_NormalSpin)
o.Register(PKG_DragonKing_FreeType)
o.Register(PKG_DragonKing_FreeSpin)
o.Register(PKG_Slots_Client_DragonKingNormalRet)
o.Register(PKG_Slots_Client_DragonKingFreeRetType)
o.Register(PKG_Slots_Client_DragonKingFreeRet)
...
o.Register(PKG_Client_Slots_DragonKingFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_DragonKingEnterResumed)
o.Register(PKG_Client_Slots_DragonKingFreeType)
o.Register(PKG_Client_Slots_DragonKingNormalSpin)
