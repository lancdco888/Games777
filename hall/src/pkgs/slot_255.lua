...
CodeGen_slot_255_md5 ="#*MD5<29be36b0d33f4469294ae758c1bb630f>*#"

--[[
生成图形数组和相关结果的基类
]]
PKG_DiamondEternity_NormalSpin = {
    typeName = "PKG_DiamondEternity_NormalSpin",
    typeId = 30521,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DiamondEternity_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.DiamondEternity.Cell>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
        ...
        o.lines = {} -- List<PKG.DiamondEternity.Line>
        --[[
        是否进入收集游戏
        ]]
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_DiamondEternity_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_DiamondEternity_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoCollect
...
PKG_DiamondEternity_NormalSpin.__index = PKG_DiamondEternity_NormalSpin

--[[
生成图形数组和相关结果的基类
]]
PKG_DiamondEternity_FreeSpin = {
    typeName = "PKG_DiamondEternity_FreeSpin",
    typeId = 30522,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DiamondEternity_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_DiamondEternity_FreeSpin.__index = PKG_DiamondEternity_FreeSpin
...
PKG_Slots_Client_DiamondEternityNormalRet = {
    typeName = "PKG_Slots_Client_DiamondEternityNormalRet", -- : PKG_DiamondEternity_NormalSpin
    typeId = 30525,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DiamondEternityNormalRet)
        end
        PKG_DiamondEternity_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_DiamondEternity_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_DiamondEternity_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_DiamondEternityNormalRet.__index = PKG_Slots_Client_DiamondEternityNormalRet

--[[
Sugar-彩虹触发的免费游戏结果
]]
PKG_Slots_Client_DiamondEternityFreeRet = {
    typeName = "PKG_Slots_Client_DiamondEternityFreeRet", -- : PKG_DiamondEternity_FreeSpin
    typeId = 30526,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DiamondEternityFreeRet)
        end
        PKG_DiamondEternity_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        o.levelUpMoney = 0 -- Int64
        o.levelUpMoneys = {} -- List<Int64>
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_DiamondEternity_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_DiamondEternity_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_DiamondEternityFreeRet.__index = PKG_Slots_Client_DiamondEternityFreeRet
...
PKG_Client_Slots_DiamondEternityFreeSpin = {
    typeName = "PKG_Client_Slots_DiamondEternityFreeSpin",
    typeId = 30524,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_DiamondEternityFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_DiamondEternityFreeSpin.__index = PKG_Client_Slots_DiamondEternityFreeSpin
...
PKG_Slots_Client_DiamondEternityEnterResumed = {
    typeName = "PKG_Slots_Client_DiamondEternityEnterResumed",
    typeId = 30527,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DiamondEternityEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_DiamondEternityNormalRet.Create() -- PKG.Slots_Client.DiamondEternityNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_DiamondEternityFreeRet.Create() -- PKG.Slots_Client.DiamondEternityFreeRet
        --[[
        游戏彩金已开的数组
        ]]
        o.cells = {} -- List<Int32>
    ...
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_DiamondEternityNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_DiamondEternityFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        -- cells
        r, len = d:Rvu32()
        if len > d:GetLeft() then return -1 end
...
PKG_Slots_Client_DiamondEternityEnterResumed.__index = PKG_Slots_Client_DiamondEternityEnterResumed

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_DiamondEternityNormalSpin = {
    typeName = "PKG_Client_Slots_DiamondEternityNormalSpin",
    typeId = 30523,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_DiamondEternityNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_DiamondEternityNormalSpin.__index = PKG_Client_Slots_DiamondEternityNormalSpin
...
PKG_DiamondEternity_Cell = {
    typeName = "PKG_DiamondEternity_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DiamondEternity_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_DiamondEternity_Cell.__index = PKG_DiamondEternity_Cell

PKG_DiamondEternity_Line = {
    typeName = "PKG_DiamondEternity_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DiamondEternity_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.DiamondEternity.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_DiamondEternity_Line.__index = PKG_DiamondEternity_Line
...
local o = ObjMgr
o.Register(PKG_DiamondEternity_NormalSpin)
o.Register(PKG_DiamondEternity_FreeSpin)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_DiamondEternityNormalRet)
o.Register(PKG_Slots_Client_DiamondEternityFreeRet)
o.Register(PKG_Slots_Client_Leave_Success)
o.Register(PKG_Client_Slots_DiamondEternityFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_DiamondEternityEnterResumed)
o.Register(PKG_Client_Slots_DiamondEternityNormalSpin)
