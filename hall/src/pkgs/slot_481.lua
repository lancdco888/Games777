...
require('g_net')
CodeGen_slot_481_md5 ="#*MD5<d1f4ea782613822a9e1e579b7da47b04>*#"

--[[
生成图形数组和相关结果的基类
]]
PKG_GatesOfOlympus_NormalSpin = {
    typeName = "PKG_GatesOfOlympus_NormalSpin",
    typeId = 48111,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_GatesOfOlympus_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.results = PKG_GatesOfOlympus_Results.Create() -- PKG.GatesOfOlympus.Results
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
    ...
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- results
        self.results = PKG_GatesOfOlympus_Results.Create(); r = self.results:Read(om)
        if r ~= 0 then return r end
        -- intoFree
...
PKG_GatesOfOlympus_NormalSpin.__index = PKG_GatesOfOlympus_NormalSpin

--[[
生成图形数组和相关结果的基类
]]
PKG_GatesOfOlympus_FreeSpin = {
    typeName = "PKG_GatesOfOlympus_FreeSpin",
    typeId = 48112,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_GatesOfOlympus_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_GatesOfOlympus_FreeSpin.__index = PKG_GatesOfOlympus_FreeSpin

--[[
Sugar-普通结果
]]
PKG_Slots_Client_GatesOfOlympusNormalRet = {
    typeName = "PKG_Slots_Client_GatesOfOlympusNormalRet",
    typeId = 48115,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_GatesOfOlympusNormalRet)
        end
        o.normalSpin = PKG_GatesOfOlympus_NormalSpin.Create() -- PKG.GatesOfOlympus.NormalSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- normalSpin
        self.normalSpin = PKG_GatesOfOlympus_NormalSpin.Create(); r = self.normalSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_GatesOfOlympusNormalRet.__index = PKG_Slots_Client_GatesOfOlympusNormalRet

--[[
Sugar-彩虹触发的免费游戏结果
]]
PKG_Slots_Client_GatesOfOlympusFreeRet = {
    typeName = "PKG_Slots_Client_GatesOfOlympusFreeRet",
    typeId = 48116,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_GatesOfOlympusFreeRet)
        end
        o.freeSpin = PKG_GatesOfOlympus_FreeSpin.Create() -- PKG.GatesOfOlympus.FreeSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- freeSpin
        self.freeSpin = PKG_GatesOfOlympus_FreeSpin.Create(); r = self.freeSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_GatesOfOlympusFreeRet.__index = PKG_Slots_Client_GatesOfOlympusFreeRet
...
PKG_Slots_Client_GatesOfOlympusEnterResumed = {
    typeName = "PKG_Slots_Client_GatesOfOlympusEnterResumed",
    typeId = 48117,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_GatesOfOlympusEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_GatesOfOlympusNormalRet.Create() -- PKG.Slots_Client.GatesOfOlympusNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFreeRet = PKG_Slots_Client_GatesOfOlympusFreeRet.Create() -- PKG.Slots_Client.GatesOfOlympusFreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_GatesOfOlympusNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeRet
        self.resumedFreeRet = PKG_Slots_Client_GatesOfOlympusFreeRet.Create(); r = self.resumedFreeRet:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_GatesOfOlympusEnterResumed.__index = PKG_Slots_Client_GatesOfOlympusEnterResumed
...
PKG_Client_Slots_GatesOfOlympusFreeSpin = {
    typeName = "PKG_Client_Slots_GatesOfOlympusFreeSpin",
    typeId = 48114,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_GatesOfOlympusFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_GatesOfOlympusFreeSpin.__index = PKG_Client_Slots_GatesOfOlympusFreeSpin

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_GatesOfOlympusNormalSpin = {
    typeName = "PKG_Client_Slots_GatesOfOlympusNormalSpin",
    typeId = 48113,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_GatesOfOlympusNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_GatesOfOlympusNormalSpin.__index = PKG_Client_Slots_GatesOfOlympusNormalSpin
...
PKG_GatesOfOlympus_Cell = {
    typeName = "PKG_GatesOfOlympus_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_GatesOfOlympus_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_GatesOfOlympus_Cell.__index = PKG_GatesOfOlympus_Cell

PKG_GatesOfOlympus_Line = {
    typeName = "PKG_GatesOfOlympus_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_GatesOfOlympus_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.GatesOfOlympus.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        self.lineCells = o
        for i = 1, len do
            o[i] = PKG_GatesOfOlympus_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_GatesOfOlympus_Line.__index = PKG_GatesOfOlympus_Line
...
PKG_GatesOfOlympus_Result = {
    typeName = "PKG_GatesOfOlympus_Result",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_GatesOfOlympus_Result)
        end
        --[[
        生成的15个图形集合
        ]]
        o.grids = {} -- List<PKG.GatesOfOlympus.Cell>
        --[[
        (符合连线规则)
        ]]
        o.lines = {} -- List<PKG.GatesOfOlympus.Line>
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_GatesOfOlympus_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_GatesOfOlympus_Result.__index = PKG_GatesOfOlympus_Result

PKG_GatesOfOlympus_Results = {
    typeName = "PKG_GatesOfOlympus_Results",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_GatesOfOlympus_Results)
        end
        o.array = {} -- List<PKG.GatesOfOlympus.Result>
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        self.array = o
        for i = 1, len do
            o[i] = PKG_GatesOfOlympus_Result.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_GatesOfOlympus_Results.__index = PKG_GatesOfOlympus_Results
...
local o = ObjMgr
o.Register(PKG_GatesOfOlympus_NormalSpin)
o.Register(PKG_GatesOfOlympus_FreeSpin)
o.Register(PKG_Slots_Client_GatesOfOlympusNormalRet)
o.Register(PKG_Slots_Client_GatesOfOlympusFreeRet)
...
o.Register(PKG_Slots_Client_GatesOfOlympusEnterResumed)
o.Register(PKG_Slots_Client_OfflineCheck)
o.Register(PKG_Client_Slots_GatesOfOlympusFreeSpin)
o.Register(PKG_Client_Slots_GatesOfOlympusNormalSpin)
