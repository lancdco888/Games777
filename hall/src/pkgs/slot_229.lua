...
CodeGen_slot_229_md5 ="#*MD5<e0c68b5b3137f7e6f27bf025ad128f93>*#"

PKG_VegasNight_VegasNightSymbol = {
    VegasNightWild = 1,
    VegasNightBaoXiang = 2,
    VegasNightCaiJing = 3,
    VegasNightZhuanPan = 4,
    VegasNightMeiNv = 5,
    VegasNightHaoChe = 6,
    VegasNightPuKe = 7,
    VegasNightK = 8,
...
PKG_VegasNight_NormalSpin = {
    typeName = "PKG_VegasNight_NormalSpin",
    typeId = 30411,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_VegasNight_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.VegasNight.Cell>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
        ...
        o.lines = {} -- List<PKG.VegasNight.Line>
        return o
    end,
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_VegasNight_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_VegasNight_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_VegasNight_NormalSpin.__index = PKG_VegasNight_NormalSpin

--[[
生成图形数组和相关结果的基类
]]
PKG_VegasNight_FreeSpin = {
    typeName = "PKG_VegasNight_FreeSpin",
    typeId = 30412,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_VegasNight_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_VegasNight_FreeSpin.__index = PKG_VegasNight_FreeSpin

--[[
生成图形数组和相关结果的基类
]]
PKG_VegasNight_SpecialSpin = {
    typeName = "PKG_VegasNight_SpecialSpin",
    typeId = 30413,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_VegasNight_SpecialSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_VegasNight_SpecialSpin.__index = PKG_VegasNight_SpecialSpin

--[[
狂野蛮牛-普通结果
]]
PKG_Slots_Client_VegasNightNormalRet = {
    typeName = "PKG_Slots_Client_VegasNightNormalRet", -- : PKG_VegasNight_NormalSpin
    typeId = 30417,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_VegasNightNormalRet)
        end
        PKG_VegasNight_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_VegasNight_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_VegasNight_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_VegasNightNormalRet.__index = PKG_Slots_Client_VegasNightNormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_VegasNightFreeRet = {
    typeName = "PKG_Slots_Client_VegasNightFreeRet", -- : PKG_VegasNight_FreeSpin
    typeId = 30418,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_VegasNightFreeRet)
        end
        PKG_VegasNight_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_VegasNight_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_VegasNight_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_VegasNightFreeRet.__index = PKG_Slots_Client_VegasNightFreeRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_VegasNightSpecialRet = {
    typeName = "PKG_Slots_Client_VegasNightSpecialRet", -- : PKG_VegasNight_SpecialSpin
    typeId = 30419,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_VegasNightSpecialRet)
        end
        PKG_VegasNight_SpecialSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_VegasNight_SpecialSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_VegasNight_SpecialSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_VegasNightSpecialRet.__index = PKG_Slots_Client_VegasNightSpecialRet
...
PKG_Client_Slots_VegasNightSpecialSpin = {
    typeName = "PKG_Client_Slots_VegasNightSpecialSpin",
    typeId = 30416,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_VegasNightSpecialSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_VegasNightSpecialSpin.__index = PKG_Client_Slots_VegasNightSpecialSpin
...
PKG_Slots_Client_VegasNightEnterResumed = {
    typeName = "PKG_Slots_Client_VegasNightEnterResumed",
    typeId = 30420,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_VegasNightEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_VegasNightNormalRet.Create() -- PKG.Slots_Client.VegasNightNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFreeRet = PKG_Slots_Client_VegasNightFreeRet.Create() -- PKG.Slots_Client.VegasNightFreeRet
        --[[
        恢复特殊游戏结果
        ]]
        o.resumedSpecialRet = PKG_Slots_Client_VegasNightSpecialRet.Create() -- PKG.Slots_Client.VegasNightSpecialRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_VegasNightNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeRet
        self.resumedFreeRet = PKG_Slots_Client_VegasNightFreeRet.Create(); r = self.resumedFreeRet:Read(om)
        if r ~= 0 then return r end
        -- resumedSpecialRet
        self.resumedSpecialRet = PKG_Slots_Client_VegasNightSpecialRet.Create(); r = self.resumedSpecialRet:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
        ...
        -- resumedSpecialRet
        self.resumedSpecialRet:Write(om)
    end
}
PKG_Slots_Client_VegasNightEnterResumed.__index = PKG_Slots_Client_VegasNightEnterResumed

--[[
Sugar请求特殊旋转图形
]]
PKG_Client_Slots_VegasNightFreeSpin = {
    typeName = "PKG_Client_Slots_VegasNightFreeSpin",
    typeId = 30415,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_VegasNightFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_VegasNightFreeSpin.__index = PKG_Client_Slots_VegasNightFreeSpin

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_VegasNightNormalSpin = {
    typeName = "PKG_Client_Slots_VegasNightNormalSpin",
    typeId = 30414,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_VegasNightNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_VegasNightNormalSpin.__index = PKG_Client_Slots_VegasNightNormalSpin
...
PKG_VegasNight_Cell = {
    typeName = "PKG_VegasNight_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_VegasNight_Cell)
        end
        --[[
        点对应下标
        ]]
        ...
        o.icon = 0 -- PKG.VegasNight.VegasNightSymbol
        --[[
        点对应图形Id的类型 0为常规图形 其他为有奖图形 1普通奖励 2小奖分值 3中奖分值 4大奖分值 5巨奖分值
        ]]
        o.FestivalSymbolType = 0 -- Int32
        --[[
        图形的彩金值
        ]]
        o.FestivalSymbolValue = 0 -- Double
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- FestivalSymbolType
        r, self.FestivalSymbolType = d:Rvi32()
        if r ~= 0 then return r end
        -- FestivalSymbolValue
        r, self.FestivalSymbolValue = d:Rd()
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
        ...
        d:Wvi32(self.icon)
        -- FestivalSymbolType
        d:Wvi32(self.FestivalSymbolType)
        -- FestivalSymbolValue
        d:Wd(self.FestivalSymbolValue)
    end
}
PKG_VegasNight_Cell.__index = PKG_VegasNight_Cell

PKG_VegasNight_Line = {
    typeName = "PKG_VegasNight_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_VegasNight_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.VegasNight.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_VegasNight_Line.__index = PKG_VegasNight_Line
...
local o = ObjMgr
o.Register(PKG_VegasNight_NormalSpin)
o.Register(PKG_VegasNight_FreeSpin)
o.Register(PKG_VegasNight_SpecialSpin)
o.Register(PKG_Slots_Client_VegasNightNormalRet)
o.Register(PKG_Slots_Client_VegasNightFreeRet)
o.Register(PKG_Slots_Client_VegasNightSpecialRet)
...
o.Register(PKG_Client_Slots_VegasNightSpecialSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_VegasNightEnterResumed)
o.Register(PKG_Client_Slots_VegasNightFreeSpin)
o.Register(PKG_Client_Slots_VegasNightNormalSpin)
