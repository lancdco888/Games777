...
require('g_net')
CodeGen_slot_270_md5 ="#*MD5<76c1ee5263406abfee5c3cae190c1697>*#"
...
PKG_Slots_Client_EyesOfWealthNormalRet = {
    typeName = "PKG_Slots_Client_EyesOfWealthNormalRet", -- : PKG_EyesOfWealth_NormalSpin
    typeId = 30617,
    Create = function(o)
        if o == nil then
            o = {}
        ...
        PKG_EyesOfWealth_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_EyesOfWealth_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_EyesOfWealth_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_EyesOfWealthFreeRet = {
    typeName = "PKG_Slots_Client_EyesOfWealthFreeRet", -- : PKG_EyesOfWealth_FreeSpin
    typeId = 30618,
    Create = function(o)
        if o == nil then
            o = {}
        ...
        PKG_EyesOfWealth_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_EyesOfWealth_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_EyesOfWealth_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_EyesOfWealthSpecialRet = {
    typeName = "PKG_Slots_Client_EyesOfWealthSpecialRet", -- : PKG_EyesOfWealth_SpecialSpin
    typeId = 30619,
    Create = function(o)
        if o == nil then
            o = {}
        ...
        PKG_EyesOfWealth_SpecialSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_EyesOfWealth_SpecialSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_EyesOfWealth_SpecialSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
