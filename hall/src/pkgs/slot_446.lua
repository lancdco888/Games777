...
require('g_net')
CodeGen_slot_270_md5 ="#*MD5<5d9ced73c92b73150cf49a54c715e90b>*#"

--[[
Sugar请求特殊旋转图形
]]
PKG_EyesOfWealth_NormalSpin = {
    typeName = "PKG_EyesOfWealth_NormalSpin",
    typeId = 30611,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_EyesOfWealth_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.EyesOfWealth.Cell>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
        ...
        o.lines = {} -- List<PKG.EyesOfWealth.Line>
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_EyesOfWealth_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_EyesOfWealth_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- slotMoneyGift
...
PKG_EyesOfWealth_NormalSpin.__index = PKG_EyesOfWealth_NormalSpin

--[[
Sugar请求免费旋转图形
]]
PKG_EyesOfWealth_FreeSpin = {
    typeName = "PKG_EyesOfWealth_FreeSpin",
    typeId = 30612,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_EyesOfWealth_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_EyesOfWealth_FreeSpin.__index = PKG_EyesOfWealth_FreeSpin

--[[
Sugar请求特殊旋转图形
]]
PKG_EyesOfWealth_SpecialSpin = {
    typeName = "PKG_EyesOfWealth_SpecialSpin",
    typeId = 30613,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_EyesOfWealth_SpecialSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_EyesOfWealth_SpecialSpin.__index = PKG_EyesOfWealth_SpecialSpin

--[[
狂野蛮牛-普通结果
]]
PKG_Slots_Client_EyesOfWealthNormalRet = {
    typeName = "PKG_Slots_Client_EyesOfWealthNormalRet",
    typeId = 30617,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_EyesOfWealthNormalRet)
        end
        o.normalSpin = PKG_EyesOfWealth_NormalSpin.Create() -- PKG.EyesOfWealth.NormalSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- normalSpin
        self.normalSpin = PKG_EyesOfWealth_NormalSpin.Create(); r = self.normalSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_EyesOfWealthNormalRet.__index = PKG_Slots_Client_EyesOfWealthNormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_EyesOfWealthFreeRet = {
    typeName = "PKG_Slots_Client_EyesOfWealthFreeRet",
    typeId = 30618,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_EyesOfWealthFreeRet)
        end
        o.freeSpin = PKG_EyesOfWealth_FreeSpin.Create() -- PKG.EyesOfWealth.FreeSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- freeSpin
        self.freeSpin = PKG_EyesOfWealth_FreeSpin.Create(); r = self.freeSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_EyesOfWealthFreeRet.__index = PKG_Slots_Client_EyesOfWealthFreeRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_EyesOfWealthSpecialRet = {
    typeName = "PKG_Slots_Client_EyesOfWealthSpecialRet",
    typeId = 30619,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_EyesOfWealthSpecialRet)
        end
        o.specialSpin = PKG_EyesOfWealth_SpecialSpin.Create() -- PKG.EyesOfWealth.SpecialSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- specialSpin
        self.specialSpin = PKG_EyesOfWealth_SpecialSpin.Create(); r = self.specialSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_EyesOfWealthSpecialRet.__index = PKG_Slots_Client_EyesOfWealthSpecialRet
...
PKG_Client_Slots_EyesOfWealthSpecialSpin = {
    typeName = "PKG_Client_Slots_EyesOfWealthSpecialSpin",
    typeId = 30616,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_EyesOfWealthSpecialSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_EyesOfWealthSpecialSpin.__index = PKG_Client_Slots_EyesOfWealthSpecialSpin
...
PKG_Slots_Client_EyesOfWealthEnterResumed = {
    typeName = "PKG_Slots_Client_EyesOfWealthEnterResumed",
    typeId = 30620,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_EyesOfWealthEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_EyesOfWealthNormalRet.Create() -- PKG.Slots_Client.EyesOfWealthNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_EyesOfWealthFreeRet.Create() -- PKG.Slots_Client.EyesOfWealthFreeRet
        --[[
        恢复特殊游戏结果
        ]]
        o.resumedSpecial = PKG_Slots_Client_EyesOfWealthSpecialRet.Create() -- PKG.Slots_Client.EyesOfWealthSpecialRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_EyesOfWealthNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_EyesOfWealthFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        -- resumedSpecial
        self.resumedSpecial = PKG_Slots_Client_EyesOfWealthSpecialRet.Create(); r = self.resumedSpecial:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_EyesOfWealthEnterResumed.__index = PKG_Slots_Client_EyesOfWealthEnterResumed

--[[
财富之眼 请求免费类型
]]
PKG_Client_Slots_EyesOfWealthFreeSpin = {
    typeName = "PKG_Client_Slots_EyesOfWealthFreeSpin",
    typeId = 30615,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_EyesOfWealthFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_EyesOfWealthFreeSpin.__index = PKG_Client_Slots_EyesOfWealthFreeSpin

--[[
财富之眼  普通旋转
]]
PKG_Client_Slots_EyesOfWealthNormalSpin = {
    typeName = "PKG_Client_Slots_EyesOfWealthNormalSpin",
    typeId = 30614,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_EyesOfWealthNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_EyesOfWealthNormalSpin.__index = PKG_Client_Slots_EyesOfWealthNormalSpin
...
PKG_EyesOfWealth_Cell = {
    typeName = "PKG_EyesOfWealth_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_EyesOfWealth_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_EyesOfWealth_Cell.__index = PKG_EyesOfWealth_Cell

PKG_EyesOfWealth_Line = {
    typeName = "PKG_EyesOfWealth_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_EyesOfWealth_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.EyesOfWealth.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_EyesOfWealth_Line.__index = PKG_EyesOfWealth_Line
...
local o = ObjMgr
o.Register(PKG_EyesOfWealth_NormalSpin)
o.Register(PKG_EyesOfWealth_FreeSpin)
o.Register(PKG_EyesOfWealth_SpecialSpin)
o.Register(PKG_Slots_Client_EyesOfWealthNormalRet)
o.Register(PKG_Slots_Client_EyesOfWealthFreeRet)
o.Register(PKG_Slots_Client_EyesOfWealthSpecialRet)
...
o.Register(PKG_Client_Slots_EyesOfWealthSpecialSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_EyesOfWealthEnterResumed)
o.Register(PKG_Client_Slots_EyesOfWealthFreeSpin)
o.Register(PKG_Client_Slots_EyesOfWealthNormalSpin)
