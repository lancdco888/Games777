...
CodeGen_slot_302_md5 ="#*MD5<68f6fc9e1a019bf78ea10d5d3c19ebdf>*#"

--[[
Sugar请求特殊旋转图形
]]
PKG_DoublePanda_NormalSpin = {
    typeName = "PKG_DoublePanda_NormalSpin",
    typeId = 30781,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DoublePanda_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.DoublePanda.Cell>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
        ...
        o.lines = {} -- List<PKG.DoublePanda.Line>
        return o
    end,
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_DoublePanda_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_DoublePanda_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_DoublePanda_NormalSpin.__index = PKG_DoublePanda_NormalSpin

--[[
Sugar请求免费旋转图形
]]
PKG_DoublePanda_FreeSpin = {
    typeName = "PKG_DoublePanda_FreeSpin",
    typeId = 30782,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DoublePanda_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_DoublePanda_FreeSpin.__index = PKG_DoublePanda_FreeSpin
...
PKG_Slots_Client_DoublePandaNormalRet = {
    typeName = "PKG_Slots_Client_DoublePandaNormalRet", -- : PKG_DoublePanda_NormalSpin
    typeId = 30785,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DoublePandaNormalRet)
        end
        PKG_DoublePanda_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_DoublePanda_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_DoublePanda_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_DoublePandaNormalRet.__index = PKG_Slots_Client_DoublePandaNormalRet

--[[
财神赐宝 免费游戏结果
]]
PKG_Slots_Client_DoublePandaFreeRet = {
    typeName = "PKG_Slots_Client_DoublePandaFreeRet", -- : PKG_DoublePanda_FreeSpin
    typeId = 30786,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DoublePandaFreeRet)
        end
        PKG_DoublePanda_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_DoublePanda_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_DoublePanda_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_DoublePandaFreeRet.__index = PKG_Slots_Client_DoublePandaFreeRet
...
PKG_Client_Slots_DoublePandaFreeSpin = {
    typeName = "PKG_Client_Slots_DoublePandaFreeSpin",
    typeId = 30784,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_DoublePandaFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_DoublePandaFreeSpin.__index = PKG_Client_Slots_DoublePandaFreeSpin
...
PKG_Slots_Client_DoublePandaEnterResumed = {
    typeName = "PKG_Slots_Client_DoublePandaEnterResumed",
    typeId = 30787,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DoublePandaEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_DoublePandaNormalRet.Create() -- PKG.Slots_Client.DoublePandaNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_DoublePandaFreeRet.Create() -- PKG.Slots_Client.DoublePandaFreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_DoublePandaNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_DoublePandaFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_DoublePandaEnterResumed.__index = PKG_Slots_Client_DoublePandaEnterResumed

--[[
财神赐宝  普通旋转
]]
PKG_Client_Slots_DoublePandaNormalSpin = {
    typeName = "PKG_Client_Slots_DoublePandaNormalSpin",
    typeId = 30783,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_DoublePandaNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_DoublePandaNormalSpin.__index = PKG_Client_Slots_DoublePandaNormalSpin
...
PKG_DoublePanda_Cell = {
    typeName = "PKG_DoublePanda_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DoublePanda_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_DoublePanda_Cell.__index = PKG_DoublePanda_Cell

PKG_DoublePanda_Line = {
    typeName = "PKG_DoublePanda_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DoublePanda_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.DoublePanda.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_DoublePanda_Line.__index = PKG_DoublePanda_Line
...
local o = ObjMgr
o.Register(PKG_DoublePanda_NormalSpin)
o.Register(PKG_DoublePanda_FreeSpin)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_DoublePandaNormalRet)
o.Register(PKG_Slots_Client_DoublePandaFreeRet)
o.Register(PKG_Slots_Client_Leave_Success)
o.Register(PKG_Client_Slots_DoublePandaFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_DoublePandaEnterResumed)
o.Register(PKG_Client_Slots_DoublePandaNormalSpin)
