...
CodeGen_slot_234_md5 ="#*MD5<09e8c6f1e26e5a328c47f6a695c31405>*#"

PKG_Sevens7_Sevens7Symbol = {
    SymbolWild = 1,
    SymbolFire = 2,
    Symbol777 = 3,
    SymbolAplle = 4,
...
PKG_Sevens7_NormalSpin = {
    typeName = "PKG_Sevens7_NormalSpin",
    typeId = 30431,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Sevens7_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.Sevens7.Cell>
        o.lineShow = {} -- List<Int32>
        --[[
        是否进入特殊游戏
        ]]
        ...
        o.lines = {} -- List<PKG.Sevens7.Line>
        o.winShow = {} -- List<Int32>
        return o
    end,
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_Sevens7_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- lineShow
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_Sevens7_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- winShow
...
PKG_Sevens7_NormalSpin.__index = PKG_Sevens7_NormalSpin

--[[
生成图形数组和相关结果的基类
]]
PKG_Sevens7_SpecialSpin = {
    typeName = "PKG_Sevens7_SpecialSpin",
    typeId = 30432,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Sevens7_SpecialSpin)
        end
        o.type = 0 -- Int32
        o.winmony = 0 -- Double
        --[[
...
PKG_Sevens7_SpecialSpin.__index = PKG_Sevens7_SpecialSpin

--[[
狂野蛮牛-普通结果
]]
PKG_Slots_Client_Sevens7NormalRet = {
    typeName = "PKG_Slots_Client_Sevens7NormalRet", -- : PKG_Sevens7_NormalSpin
    typeId = 30435,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_Sevens7NormalRet)
        end
        PKG_Sevens7_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_Sevens7_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_Sevens7_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_Sevens7NormalRet.__index = PKG_Slots_Client_Sevens7NormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_Sevens7SpecialRet = {
    typeName = "PKG_Slots_Client_Sevens7SpecialRet", -- : PKG_Sevens7_SpecialSpin
    typeId = 30436,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_Sevens7SpecialRet)
        end
        PKG_Sevens7_SpecialSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_Sevens7_SpecialSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_Sevens7_SpecialSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_Sevens7SpecialRet.__index = PKG_Slots_Client_Sevens7SpecialRet
...
PKG_Client_Slots_Sevens7SpecialSpin = {
    typeName = "PKG_Client_Slots_Sevens7SpecialSpin",
    typeId = 30434,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_Sevens7SpecialSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_Sevens7SpecialSpin.__index = PKG_Client_Slots_Sevens7SpecialSpin
...
PKG_Slots_Client_Sevens7EnterResumed = {
    typeName = "PKG_Slots_Client_Sevens7EnterResumed",
    typeId = 30437,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_Sevens7EnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_Sevens7NormalRet.Create() -- PKG.Slots_Client.Sevens7NormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFreeRet = PKG_Slots_Client_Sevens7SpecialRet.Create() -- PKG.Slots_Client.Sevens7SpecialRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_Sevens7NormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeRet
        self.resumedFreeRet = PKG_Slots_Client_Sevens7SpecialRet.Create(); r = self.resumedFreeRet:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_Sevens7EnterResumed.__index = PKG_Slots_Client_Sevens7EnterResumed

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_Sevens7NormalSpin = {
    typeName = "PKG_Client_Slots_Sevens7NormalSpin",
    typeId = 30433,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_Sevens7NormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_Sevens7NormalSpin.__index = PKG_Client_Slots_Sevens7NormalSpin
...
PKG_Sevens7_Cell = {
    typeName = "PKG_Sevens7_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Sevens7_Cell)
        end
        --[[
        点对应下标
        ]]
        ...
        o.icon = 0 -- PKG.Sevens7.Sevens7Symbol
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_Sevens7_Cell.__index = PKG_Sevens7_Cell

PKG_Sevens7_Line = {
    typeName = "PKG_Sevens7_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Sevens7_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.Sevens7.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_Sevens7_Line.__index = PKG_Sevens7_Line
...
local o = ObjMgr
o.Register(PKG_Sevens7_NormalSpin)
o.Register(PKG_Sevens7_SpecialSpin)
o.Register(PKG_Slots_Client_Sevens7NormalRet)
o.Register(PKG_Slots_Client_Sevens7SpecialRet)
...
o.Register(PKG_Client_Slots_Sevens7SpecialSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_Sevens7EnterResumed)
o.Register(PKG_Client_Slots_Sevens7NormalSpin)
