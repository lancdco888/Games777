...
CodeGen_slot_303_md5 ="#*MD5<b3f4d15d41f63a4d0cd2608c50c333dd>*#"

--[[
Sugar请求特殊旋转图形
]]
PKG_TigerGarden_NormalSpin = {
    typeName = "PKG_TigerGarden_NormalSpin",
    typeId = 30771,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_TigerGarden_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.TigerGarden.Cell>
        --[[
        哪些图标会换成替代
        ]]
        o.changeWild = {} -- List<Int32>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
        ...
        o.lines = {} -- List<PKG.TigerGarden.Line>
        return o
    end,
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_TigerGarden_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- changeWild
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_TigerGarden_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_TigerGarden_NormalSpin.__index = PKG_TigerGarden_NormalSpin

--[[
Sugar请求免费旋转图形
]]
PKG_TigerGarden_FreeSpin = {
    typeName = "PKG_TigerGarden_FreeSpin",
    typeId = 30772,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_TigerGarden_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_TigerGarden_FreeSpin.__index = PKG_TigerGarden_FreeSpin

--[[
Sugar请求免费旋转图形
]]
PKG_TigerGarden_SpcSpin = {
    typeName = "PKG_TigerGarden_SpcSpin",
    typeId = 30773,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_TigerGarden_SpcSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_TigerGarden_SpcSpin.__index = PKG_TigerGarden_SpcSpin

--[[
财神赐宝-普通结果
]]
PKG_Slots_Client_TigerGardenNormalRet = {
    typeName = "PKG_Slots_Client_TigerGardenNormalRet", -- : PKG_TigerGarden_NormalSpin
    typeId = 30777,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_TigerGardenNormalRet)
        end
        PKG_TigerGarden_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_TigerGarden_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_TigerGarden_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_TigerGardenNormalRet.__index = PKG_Slots_Client_TigerGardenNormalRet

--[[
财神赐宝 免费游戏结果
]]
PKG_Slots_Client_TigerGardenFreeRet = {
    typeName = "PKG_Slots_Client_TigerGardenFreeRet", -- : PKG_TigerGarden_FreeSpin
    typeId = 30778,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_TigerGardenFreeRet)
        end
        PKG_TigerGarden_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_TigerGarden_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_TigerGarden_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_TigerGardenFreeRet.__index = PKG_Slots_Client_TigerGardenFreeRet

--[[
财神赐宝 免费游戏结果
]]
PKG_Slots_Client_TigerGardenSpcRet = {
    typeName = "PKG_Slots_Client_TigerGardenSpcRet", -- : PKG_TigerGarden_SpcSpin
    typeId = 30779,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_TigerGardenSpcRet)
        end
        PKG_TigerGarden_SpcSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_TigerGarden_SpcSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_TigerGarden_SpcSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_TigerGardenSpcRet.__index = PKG_Slots_Client_TigerGardenSpcRet
...
PKG_Client_Slots_TigerGardenSpcSpin = {
    typeName = "PKG_Client_Slots_TigerGardenSpcSpin",
    typeId = 30776,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_TigerGardenSpcSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_TigerGardenSpcSpin.__index = PKG_Client_Slots_TigerGardenSpcSpin
...
PKG_Slots_Client_TigerGardenEnterResumed = {
    typeName = "PKG_Slots_Client_TigerGardenEnterResumed",
    typeId = 30780,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_TigerGardenEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_TigerGardenNormalRet.Create() -- PKG.Slots_Client.TigerGardenNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_TigerGardenFreeRet.Create() -- PKG.Slots_Client.TigerGardenFreeRet
        o.resumedSpc = PKG_Slots_Client_TigerGardenSpcRet.Create() -- PKG.Slots_Client.TigerGardenSpcRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_TigerGardenNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_TigerGardenFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        -- resumedSpc
        self.resumedSpc = PKG_Slots_Client_TigerGardenSpcRet.Create(); r = self.resumedSpc:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
        ...
        -- resumedSpc
        self.resumedSpc:Write(om)
    end
}
PKG_Slots_Client_TigerGardenEnterResumed.__index = PKG_Slots_Client_TigerGardenEnterResumed

--[[
财神赐宝 请求免费类型
]]
PKG_Client_Slots_TigerGardenFreeSpin = {
    typeName = "PKG_Client_Slots_TigerGardenFreeSpin",
    typeId = 30775,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_TigerGardenFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_TigerGardenFreeSpin.__index = PKG_Client_Slots_TigerGardenFreeSpin

--[[
财神赐宝  普通旋转
]]
PKG_Client_Slots_TigerGardenNormalSpin = {
    typeName = "PKG_Client_Slots_TigerGardenNormalSpin",
    typeId = 30774,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_TigerGardenNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_TigerGardenNormalSpin.__index = PKG_Client_Slots_TigerGardenNormalSpin
...
PKG_TigerGarden_Cell = {
    typeName = "PKG_TigerGarden_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_TigerGarden_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_TigerGarden_Cell.__index = PKG_TigerGarden_Cell

PKG_TigerGarden_Line = {
    typeName = "PKG_TigerGarden_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_TigerGarden_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.TigerGarden.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_TigerGarden_Line.__index = PKG_TigerGarden_Line
...
local o = ObjMgr
o.Register(PKG_TigerGarden_NormalSpin)
o.Register(PKG_TigerGarden_FreeSpin)
o.Register(PKG_TigerGarden_SpcSpin)
o.Register(PKG_Slots_Client_TigerGardenNormalRet)
o.Register(PKG_Slots_Client_TigerGardenFreeRet)
o.Register(PKG_Slots_Client_TigerGardenSpcRet)
...
o.Register(PKG_Client_Slots_TigerGardenSpcSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_TigerGardenEnterResumed)
o.Register(PKG_Client_Slots_TigerGardenFreeSpin)
o.Register(PKG_Client_Slots_TigerGardenNormalSpin)
