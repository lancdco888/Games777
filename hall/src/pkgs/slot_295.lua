...
CodeGen_slot_274_md5 ="#*MD5<a3da716d2b7a220357e2941b5ccfdc1d>*#"

--[[
Sugar请求特殊旋转图形
]]
PKG_WealthGold2_NormalSpin = {
    typeName = "PKG_WealthGold2_NormalSpin",
    typeId = 30601,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_WealthGold2_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.WealthGold2.Cell>
        o.wildBet = 0 -- Int32
        --[[
        是否进入免费游戏
        ]]
        ...
        o.lines = {} -- List<PKG.WealthGold2.Line>
        return o
    end,
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_WealthGold2_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- wildBet
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_WealthGold2_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_WealthGold2_NormalSpin.__index = PKG_WealthGold2_NormalSpin

--[[
免费类型选择
]]
PKG_WealthGold2_FreeType = {
    typeName = "PKG_WealthGold2_FreeType",
    typeId = 30602,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_WealthGold2_FreeType)
        end
        --[[
        倍率类型
        ]]
...
PKG_WealthGold2_FreeType.__index = PKG_WealthGold2_FreeType

--[[
Sugar请求免费旋转图形
]]
PKG_WealthGold2_FreeSpin = {
    typeName = "PKG_WealthGold2_FreeSpin",
    typeId = 30603,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_WealthGold2_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_WealthGold2_FreeSpin.__index = PKG_WealthGold2_FreeSpin

--[[
狂野蛮牛-普通结果
]]
PKG_Slots_Client_WealthGold2NormalRet = {
    typeName = "PKG_Slots_Client_WealthGold2NormalRet", -- : PKG_WealthGold2_NormalSpin
    typeId = 30607,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_WealthGold2NormalRet)
        end
        PKG_WealthGold2_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_WealthGold2_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_WealthGold2_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_WealthGold2NormalRet.__index = PKG_Slots_Client_WealthGold2NormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_WealthGold2FreeRetType = {
    typeName = "PKG_Slots_Client_WealthGold2FreeRetType", -- : PKG_WealthGold2_FreeType
    typeId = 30608,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_WealthGold2FreeRetType)
        end
        PKG_WealthGold2_FreeType.Create(o)
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- base read
        r = PKG_WealthGold2_FreeType.Read(self, om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_WealthGold2_FreeType.Write(self, om)
    end
}
PKG_Slots_Client_WealthGold2FreeRetType.__index = PKG_Slots_Client_WealthGold2FreeRetType

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_WealthGold2FreeRet = {
    typeName = "PKG_Slots_Client_WealthGold2FreeRet", -- : PKG_WealthGold2_FreeSpin
    typeId = 30609,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_WealthGold2FreeRet)
        end
        PKG_WealthGold2_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_WealthGold2_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_WealthGold2_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_WealthGold2FreeRet.__index = PKG_Slots_Client_WealthGold2FreeRet
...
PKG_Client_Slots_WealthGold2FreeSpin = {
    typeName = "PKG_Client_Slots_WealthGold2FreeSpin",
    typeId = 30606,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_WealthGold2FreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_WealthGold2FreeSpin.__index = PKG_Client_Slots_WealthGold2FreeSpin
...
PKG_Slots_Client_WealthGold2EnterResumed = {
    typeName = "PKG_Slots_Client_WealthGold2EnterResumed",
    typeId = 30610,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_WealthGold2EnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_WealthGold2NormalRet.Create() -- PKG.Slots_Client.WealthGold2NormalRet
        --[[
        恢复免费游戏类型
        ]]
        o.freeType = PKG_Slots_Client_WealthGold2FreeRetType.Create() -- PKG.Slots_Client.WealthGold2FreeRetType
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_WealthGold2FreeRet.Create() -- PKG.Slots_Client.WealthGold2FreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_WealthGold2NormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- freeType
        self.freeType = PKG_Slots_Client_WealthGold2FreeRetType.Create(); r = self.freeType:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_WealthGold2FreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_WealthGold2EnterResumed.__index = PKG_Slots_Client_WealthGold2EnterResumed

--[[
发财树 请求免费类型
]]
PKG_Client_Slots_WealthGold2FreeType = {
    typeName = "PKG_Client_Slots_WealthGold2FreeType",
    typeId = 30605,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_WealthGold2FreeType)
        end
        --[[
        押注类型
        ]]
...
PKG_Client_Slots_WealthGold2FreeType.__index = PKG_Client_Slots_WealthGold2FreeType

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_WealthGold2NormalSpin = {
    typeName = "PKG_Client_Slots_WealthGold2NormalSpin",
    typeId = 30604,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_WealthGold2NormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_WealthGold2NormalSpin.__index = PKG_Client_Slots_WealthGold2NormalSpin
...
PKG_WealthGold2_Cell = {
    typeName = "PKG_WealthGold2_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_WealthGold2_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_WealthGold2_Cell.__index = PKG_WealthGold2_Cell

PKG_WealthGold2_Line = {
    typeName = "PKG_WealthGold2_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_WealthGold2_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.WealthGold2.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_WealthGold2_Line.__index = PKG_WealthGold2_Line
...
local o = ObjMgr
o.Register(PKG_WealthGold2_NormalSpin)
o.Register(PKG_WealthGold2_FreeType)
o.Register(PKG_WealthGold2_FreeSpin)
o.Register(PKG_Slots_Client_WealthGold2NormalRet)
o.Register(PKG_Slots_Client_WealthGold2FreeRetType)
o.Register(PKG_Slots_Client_WealthGold2FreeRet)
...
o.Register(PKG_Client_Slots_WealthGold2FreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_WealthGold2EnterResumed)
o.Register(PKG_Client_Slots_WealthGold2FreeType)
o.Register(PKG_Client_Slots_WealthGold2NormalSpin)
