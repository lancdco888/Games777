...
CodeGen_slot_291_md5 ="#*MD5<9d06f7d962e26ed390f2d54e09c63821>*#"

--[[
Sugar请求特殊旋转图形
]]
PKG_MoonFestival_NormalSpin = {
    typeName = "PKG_MoonFestival_NormalSpin",
    typeId = 30731,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_MoonFestival_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.MoonFestival.Cell>
        --[[
        (符合连线规则)
        ]]
        o.lines = {} -- List<PKG.MoonFestival.Line>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_MoonFestival_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- lines
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_MoonFestival_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
...
PKG_MoonFestival_NormalSpin.__index = PKG_MoonFestival_NormalSpin

--[[
生成图形数组和相关结果的基类
]]
PKG_MoonFestival_FreeSpin = {
    typeName = "PKG_MoonFestival_FreeSpin",
    typeId = 30732,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_MoonFestival_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_MoonFestival_FreeSpin.__index = PKG_MoonFestival_FreeSpin
...
PKG_Slots_Client_MoonFestivalNormalRet = {
    typeName = "PKG_Slots_Client_MoonFestivalNormalRet", -- : PKG_MoonFestival_NormalSpin
    typeId = 30735,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_MoonFestivalNormalRet)
        end
        PKG_MoonFestival_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_MoonFestival_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_MoonFestival_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_MoonFestivalNormalRet.__index = PKG_Slots_Client_MoonFestivalNormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_MoonFestivalFreeRet = {
    typeName = "PKG_Slots_Client_MoonFestivalFreeRet", -- : PKG_MoonFestival_FreeSpin
    typeId = 30736,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_MoonFestivalFreeRet)
        end
        PKG_MoonFestival_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_MoonFestival_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_MoonFestival_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_MoonFestivalFreeRet.__index = PKG_Slots_Client_MoonFestivalFreeRet
...
PKG_Client_Slots_MoonFestivalFreeSpin = {
    typeName = "PKG_Client_Slots_MoonFestivalFreeSpin",
    typeId = 30734,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_MoonFestivalFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_MoonFestivalFreeSpin.__index = PKG_Client_Slots_MoonFestivalFreeSpin
...
PKG_Slots_Client_MoonFestivalEnterResumed = {
    typeName = "PKG_Slots_Client_MoonFestivalEnterResumed",
    typeId = 30737,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_MoonFestivalEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_MoonFestivalNormalRet.Create() -- PKG.Slots_Client.MoonFestivalNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFreeRet = PKG_Slots_Client_MoonFestivalFreeRet.Create() -- PKG.Slots_Client.MoonFestivalFreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_MoonFestivalNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeRet
        self.resumedFreeRet = PKG_Slots_Client_MoonFestivalFreeRet.Create(); r = self.resumedFreeRet:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_MoonFestivalEnterResumed.__index = PKG_Slots_Client_MoonFestivalEnterResumed

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_MoonFestivalNormalSpin = {
    typeName = "PKG_Client_Slots_MoonFestivalNormalSpin",
    typeId = 30733,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_MoonFestivalNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_MoonFestivalNormalSpin.__index = PKG_Client_Slots_MoonFestivalNormalSpin
...
PKG_MoonFestival_Cell = {
    typeName = "PKG_MoonFestival_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_MoonFestival_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_MoonFestival_Cell.__index = PKG_MoonFestival_Cell

PKG_MoonFestival_Line = {
    typeName = "PKG_MoonFestival_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_MoonFestival_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.MoonFestival.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_MoonFestival_Line.__index = PKG_MoonFestival_Line
...
local o = ObjMgr
o.Register(PKG_MoonFestival_NormalSpin)
o.Register(PKG_MoonFestival_FreeSpin)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_MoonFestivalNormalRet)
o.Register(PKG_Slots_Client_MoonFestivalFreeRet)
o.Register(PKG_Slots_Client_Leave_Success)
o.Register(PKG_Client_Slots_MoonFestivalFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_MoonFestivalEnterResumed)
o.Register(PKG_Client_Slots_MoonFestivalNormalSpin)
