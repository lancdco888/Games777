...
CodeGen_slot_297_md5 ="#*MD5<c91891627665bbb27b9744e5a72ad2a1>*#"

--[[
Sugar请求特殊旋转图形
]]
PKG_PandaGold_NormalSpin = {
    typeName = "PKG_PandaGold_NormalSpin",
    typeId = 30761,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_PandaGold_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.PandaGold.Cell>
        --[[
        哪些图标会换成替代
        ]]
        ...
        o.lines = {} -- List<PKG.PandaGold.Line>
        return o
    end,
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_PandaGold_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- changeWild
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_PandaGold_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_PandaGold_NormalSpin.__index = PKG_PandaGold_NormalSpin

--[[
Sugar请求免费旋转图形
]]
PKG_PandaGold_FreeSpin = {
    typeName = "PKG_PandaGold_FreeSpin",
    typeId = 30762,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_PandaGold_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_PandaGold_FreeSpin.__index = PKG_PandaGold_FreeSpin
...
PKG_Slots_Client_PandaGoldNormalRet = {
    typeName = "PKG_Slots_Client_PandaGoldNormalRet", -- : PKG_PandaGold_NormalSpin
    typeId = 30765,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_PandaGoldNormalRet)
        end
        PKG_PandaGold_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_PandaGold_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_PandaGold_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_PandaGoldNormalRet.__index = PKG_Slots_Client_PandaGoldNormalRet

--[[
财神赐宝 免费游戏结果
]]
PKG_Slots_Client_PandaGoldFreeRet = {
    typeName = "PKG_Slots_Client_PandaGoldFreeRet", -- : PKG_PandaGold_FreeSpin
    typeId = 30766,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_PandaGoldFreeRet)
        end
        PKG_PandaGold_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_PandaGold_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_PandaGold_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_PandaGoldFreeRet.__index = PKG_Slots_Client_PandaGoldFreeRet
...
PKG_Client_Slots_PandaGoldFreeSpin = {
    typeName = "PKG_Client_Slots_PandaGoldFreeSpin",
    typeId = 30764,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_PandaGoldFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_PandaGoldFreeSpin.__index = PKG_Client_Slots_PandaGoldFreeSpin
...
PKG_Slots_Client_PandaGoldEnterResumed = {
    typeName = "PKG_Slots_Client_PandaGoldEnterResumed",
    typeId = 30767,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_PandaGoldEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_PandaGoldNormalRet.Create() -- PKG.Slots_Client.PandaGoldNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_PandaGoldFreeRet.Create() -- PKG.Slots_Client.PandaGoldFreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_PandaGoldNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_PandaGoldFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_PandaGoldEnterResumed.__index = PKG_Slots_Client_PandaGoldEnterResumed

--[[
财神赐宝  普通旋转
]]
PKG_Client_Slots_PandaGoldNormalSpin = {
    typeName = "PKG_Client_Slots_PandaGoldNormalSpin",
    typeId = 30763,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_PandaGoldNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_PandaGoldNormalSpin.__index = PKG_Client_Slots_PandaGoldNormalSpin
...
PKG_PandaGold_Cell = {
    typeName = "PKG_PandaGold_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_PandaGold_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_PandaGold_Cell.__index = PKG_PandaGold_Cell

PKG_PandaGold_Line = {
    typeName = "PKG_PandaGold_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_PandaGold_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.PandaGold.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_PandaGold_Line.__index = PKG_PandaGold_Line
...
local o = ObjMgr
o.Register(PKG_PandaGold_NormalSpin)
o.Register(PKG_PandaGold_FreeSpin)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_PandaGoldNormalRet)
o.Register(PKG_Slots_Client_PandaGoldFreeRet)
o.Register(PKG_Slots_Client_Leave_Success)
o.Register(PKG_Client_Slots_PandaGoldFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_PandaGoldEnterResumed)
o.Register(PKG_Client_Slots_PandaGoldNormalSpin)
