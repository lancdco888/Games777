...
CodeGen_slot_317_md5 ="#*MD5<b1fee5ec1507cb06f201c310e605981e>*#"

--[[
免费类型选择
]]
PKG_JinJiBaoXi_FreeType = {
    typeName = "PKG_JinJiBaoXi_FreeType",
    typeId = 30562,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_JinJiBaoXi_FreeType)
        end
        --[[
        倍率类型
        ]]
        o.type = 0 -- Int32
        o.freeIntoValue = 0 -- Double
        return o
    end,
    ...
    Write = function(self, om)
        ...
        d:Wvi32(self.type)
        -- freeIntoValue
        d:Wd(self.freeIntoValue)
    end
}
PKG_JinJiBaoXi_FreeType.__index = PKG_JinJiBaoXi_FreeType

--[[
Sugar请求特殊旋转图形
]]
PKG_JinJiBaoXi_NormalSpin = {
    typeName = "PKG_JinJiBaoXi_NormalSpin",
    typeId = 30561,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_JinJiBaoXi_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.JinJiBaoXi.Cell>
        o.wildBet = 0 -- Int32
        --[[
        是否进入免费游戏
        ]]
        ...
        o.lines = {} -- List<PKG.JinJiBaoXi.Line>
        --[[
        是否进入收集游戏
        ]]
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_JinJiBaoXi_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- wildBet
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_JinJiBaoXi_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoCollect
...
PKG_JinJiBaoXi_NormalSpin.__index = PKG_JinJiBaoXi_NormalSpin

--[[
Sugar请求免费旋转图形
]]
PKG_JinJiBaoXi_FreeSpin = {
    typeName = "PKG_JinJiBaoXi_FreeSpin",
    typeId = 30563,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_JinJiBaoXi_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_JinJiBaoXi_FreeSpin.__index = PKG_JinJiBaoXi_FreeSpin

--[[
Sugar请求特殊旋转图形
]]
PKG_JinJiBaoXi_SpecialSpin = {
    typeName = "PKG_JinJiBaoXi_SpecialSpin",
    typeId = 30564,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_JinJiBaoXi_SpecialSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_JinJiBaoXi_SpecialSpin.__index = PKG_JinJiBaoXi_SpecialSpin

--[[
狂野蛮牛-普通结果
]]
PKG_Slots_Client_JinJiBaoXiNormalRet = {
    typeName = "PKG_Slots_Client_JinJiBaoXiNormalRet", -- : PKG_JinJiBaoXi_NormalSpin
    typeId = 30569,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_JinJiBaoXiNormalRet)
        end
        PKG_JinJiBaoXi_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_JinJiBaoXi_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_JinJiBaoXi_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_JinJiBaoXiNormalRet.__index = PKG_Slots_Client_JinJiBaoXiNormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_JinJiBaoXiFreeTypeRet = {
    typeName = "PKG_Slots_Client_JinJiBaoXiFreeTypeRet", -- : PKG_JinJiBaoXi_FreeType
    typeId = 30570,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_JinJiBaoXiFreeTypeRet)
        end
        PKG_JinJiBaoXi_FreeType.Create(o)
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- base read
        r = PKG_JinJiBaoXi_FreeType.Read(self, om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_JinJiBaoXi_FreeType.Write(self, om)
    end
}
PKG_Slots_Client_JinJiBaoXiFreeTypeRet.__index = PKG_Slots_Client_JinJiBaoXiFreeTypeRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_JinJiBaoXiFreeRet = {
    typeName = "PKG_Slots_Client_JinJiBaoXiFreeRet", -- : PKG_JinJiBaoXi_FreeSpin
    typeId = 30571,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_JinJiBaoXiFreeRet)
        end
        PKG_JinJiBaoXi_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_JinJiBaoXi_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_JinJiBaoXi_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_JinJiBaoXiFreeRet.__index = PKG_Slots_Client_JinJiBaoXiFreeRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_JinJiBaoXiSpecialSpinRet = {
    typeName = "PKG_Slots_Client_JinJiBaoXiSpecialSpinRet", -- : PKG_JinJiBaoXi_SpecialSpin
    typeId = 30572,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_JinJiBaoXiSpecialSpinRet)
        end
        PKG_JinJiBaoXi_SpecialSpin.Create(o)
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- base read
        r = PKG_JinJiBaoXi_SpecialSpin.Read(self, om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_JinJiBaoXi_SpecialSpin.Write(self, om)
    end
}
PKG_Slots_Client_JinJiBaoXiSpecialSpinRet.__index = PKG_Slots_Client_JinJiBaoXiSpecialSpinRet
...
PKG_Client_Slots_JinJiBaoXiSpecialSpin = {
    typeName = "PKG_Client_Slots_JinJiBaoXiSpecialSpin",
    typeId = 30568,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_JinJiBaoXiSpecialSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_JinJiBaoXiSpecialSpin.__index = PKG_Client_Slots_JinJiBaoXiSpecialSpin
...
PKG_Slots_Client_JinJiBaoXiEnterResumed = {
    typeName = "PKG_Slots_Client_JinJiBaoXiEnterResumed",
    typeId = 30573,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_JinJiBaoXiEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_JinJiBaoXiNormalRet.Create() -- PKG.Slots_Client.JinJiBaoXiNormalRet
        --[[
        恢复免费游戏类型
        ]]
        o.resumedFreeType = PKG_Slots_Client_JinJiBaoXiFreeTypeRet.Create() -- PKG.Slots_Client.JinJiBaoXiFreeTypeRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_JinJiBaoXiFreeRet.Create() -- PKG.Slots_Client.JinJiBaoXiFreeRet
        --[[
        恢复特殊游戏结果
        ]]
        o.specialRet = PKG_Slots_Client_JinJiBaoXiSpecialSpinRet.Create() -- PKG.Slots_Client.JinJiBaoXiSpecialSpinRet
        o.MoneyA = 0 -- Double
        o.MoneyB = 0 -- Double
        return o
    end,
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_JinJiBaoXiNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeType
        self.resumedFreeType = PKG_Slots_Client_JinJiBaoXiFreeTypeRet.Create(); r = self.resumedFreeType:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_JinJiBaoXiFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        -- specialRet
        self.specialRet = PKG_Slots_Client_JinJiBaoXiSpecialSpinRet.Create(); r = self.specialRet:Read(om)
        if r ~= 0 then return r end
        -- MoneyA
        r, self.MoneyA = d:Rd()
        if r ~= 0 then return r end
...
PKG_Slots_Client_JinJiBaoXiEnterResumed.__index = PKG_Slots_Client_JinJiBaoXiEnterResumed

--[[
Sugar请求免费旋转图形
]]
PKG_Client_Slots_JinJiBaoXiFreeSpin = {
    typeName = "PKG_Client_Slots_JinJiBaoXiFreeSpin",
    typeId = 30567,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_JinJiBaoXiFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_JinJiBaoXiFreeSpin.__index = PKG_Client_Slots_JinJiBaoXiFreeSpin

--[[
发财树 请求免费类型
]]
PKG_Client_Slots_JinJiBaoXiFreeType = {
    typeName = "PKG_Client_Slots_JinJiBaoXiFreeType",
    typeId = 30566,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_JinJiBaoXiFreeType)
        end
        --[[
        押注类型
        ]]
...
PKG_Client_Slots_JinJiBaoXiFreeType.__index = PKG_Client_Slots_JinJiBaoXiFreeType

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_JinJiBaoXiNormalSpin = {
    typeName = "PKG_Client_Slots_JinJiBaoXiNormalSpin",
    typeId = 30565,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_JinJiBaoXiNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_JinJiBaoXiNormalSpin.__index = PKG_Client_Slots_JinJiBaoXiNormalSpin
...
PKG_JinJiBaoXi_Cell = {
    typeName = "PKG_JinJiBaoXi_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_JinJiBaoXi_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_JinJiBaoXi_Cell.__index = PKG_JinJiBaoXi_Cell

PKG_JinJiBaoXi_Line = {
    typeName = "PKG_JinJiBaoXi_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_JinJiBaoXi_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.JinJiBaoXi.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_JinJiBaoXi_Line.__index = PKG_JinJiBaoXi_Line
...
local o = ObjMgr
o.Register(PKG_JinJiBaoXi_FreeType)
o.Register(PKG_JinJiBaoXi_NormalSpin)
o.Register(PKG_JinJiBaoXi_FreeSpin)
o.Register(PKG_JinJiBaoXi_SpecialSpin)
o.Register(PKG_Slots_Client_JinJiBaoXiNormalRet)
o.Register(PKG_Slots_Client_JinJiBaoXiFreeTypeRet)
o.Register(PKG_Slots_Client_JinJiBaoXiFreeRet)
o.Register(PKG_Slots_Client_JinJiBaoXiSpecialSpinRet)
...
o.Register(PKG_Client_Slots_JinJiBaoXiSpecialSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_JinJiBaoXiEnterResumed)
o.Register(PKG_Client_Slots_JinJiBaoXiFreeSpin)
o.Register(PKG_Client_Slots_JinJiBaoXiFreeType)
o.Register(PKG_Client_Slots_JinJiBaoXiNormalSpin)
