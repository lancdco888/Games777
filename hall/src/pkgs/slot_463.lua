...
-- require('g_net')
CodeGen_slot_363_md5 ="#*MD5<25e088030418ae27832ae997f6c672e9>*#"

--[[
旋转结果
]]
PKG_DragonTigerLuck_NormalSpin = {
    typeName = "PKG_DragonTigerLuck_NormalSpin",
    typeId = 36320,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DragonTigerLuck_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.gridsA = {} -- List<PKG.DragonTigerLuck.Cell>
        o.gridsB = {} -- List<PKG.DragonTigerLuck.Cell>
        --[[
        (符合连线规则)
        ]]
        o.lines = {} -- List<PKG.DragonTigerLuck.Line>
        --[[
        玩家点击类型  1上  2下 3上下
        ]]
        o.typeXX = 11 -- Int32
    ...
    Read = function(self, om)
        ...
        self.gridsA = o
        for i = 1, len do
            o[i] = PKG_DragonTigerLuck_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- gridsB
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_DragonTigerLuck_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- typeXX
        r, self.typeXX = d:Rvi32()
        if r ~= 0 then return r end
        return 0
    end,
...
PKG_DragonTigerLuck_NormalSpin.__index = PKG_DragonTigerLuck_NormalSpin
...
PKG_Slots_Client_DragonTigerLuckNormalRet = {
    typeName = "PKG_Slots_Client_DragonTigerLuckNormalRet",
    typeId = 36310,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DragonTigerLuckNormalRet)
        end
        o.spinResult = PKG_DragonTigerLuck_NormalSpin.Create() -- PKG.DragonTigerLuck.NormalSpin
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- spinResult
        self.spinResult = PKG_DragonTigerLuck_NormalSpin.Create(); r = self.spinResult:Read(om)
        if r ~= 0 then return r end
        -- slotMoneyGift
...
PKG_Slots_Client_DragonTigerLuckNormalRet.__index = PKG_Slots_Client_DragonTigerLuckNormalRet
...
PKG_Client_Slots_DragonTigerLuckNormalSpin = {
    typeName = "PKG_Client_Slots_DragonTigerLuckNormalSpin",
    typeId = 36301,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_DragonTigerLuckNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_DragonTigerLuckNormalSpin.__index = PKG_Client_Slots_DragonTigerLuckNormalSpin
...
PKG_Slots_Client_DragonTigerLuckEnterResumed = {
    typeName = "PKG_Slots_Client_DragonTigerLuckEnterResumed",
    typeId = 36311,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DragonTigerLuckEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_DragonTigerLuckNormalRet.Create() -- PKG.Slots_Client.DragonTigerLuckNormalRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_DragonTigerLuckNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_DragonTigerLuckEnterResumed.__index = PKG_Slots_Client_DragonTigerLuckEnterResumed
...
PKG_DragonTigerLuck_Cell = {
    typeName = "PKG_DragonTigerLuck_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DragonTigerLuck_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_DragonTigerLuck_Cell.__index = PKG_DragonTigerLuck_Cell
...
PKG_DragonTigerLuck_Line = {
    typeName = "PKG_DragonTigerLuck_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DragonTigerLuck_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
...
PKG_DragonTigerLuck_Line.__index = PKG_DragonTigerLuck_Line
...
local o = ObjMgr
o.Register(PKG_DragonTigerLuck_NormalSpin)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_DragonTigerLuckNormalRet)
...
o.Register(PKG_Client_Slots_DragonTigerLuckNormalSpin)
...
o.Register(PKG_Slots_Client_DragonTigerLuckEnterResumed)
