...
CodeGen_slot_360_md5 ="#*MD5<aeb4855a9ad04c60def9b9bc137c8dfc>*#"

PKG_LuckyBull_NormalSpin = {
    typeName = "PKG_LuckyBull_NormalSpin",
    typeId = 36000,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_LuckyBull_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.curWinCoin = 0 -- Double
        --[[
        生成的15个图形集合
        ]]
        o.grids = {} -- List<PKG.LuckyBull.Cell>
        --[[
        (符合连线规则)
        ]]
        o.lines = {} -- List<PKG.LuckyBull.Line>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_LuckyBull_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- lines
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_LuckyBull_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
...
PKG_LuckyBull_NormalSpin.__index = PKG_LuckyBull_NormalSpin

PKG_LuckyBull_FreeSpin = {
    typeName = "PKG_LuckyBull_FreeSpin",
    typeId = 36001,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_LuckyBull_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_LuckyBull_FreeSpin.__index = PKG_LuckyBull_FreeSpin
...
PKG_Slots_Client_LuckyBullNormalRet = {
    typeName = "PKG_Slots_Client_LuckyBullNormalRet",
    typeId = 36010,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_LuckyBullNormalRet)
        end
        o.normalSpin = PKG_LuckyBull_NormalSpin.Create() -- PKG.LuckyBull.NormalSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- normalSpin
        self.normalSpin = PKG_LuckyBull_NormalSpin.Create(); r = self.normalSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_LuckyBullNormalRet.__index = PKG_Slots_Client_LuckyBullNormalRet

--[[
免费旋转
]]
PKG_Slots_Client_LuckyBullFreeRet = {
    typeName = "PKG_Slots_Client_LuckyBullFreeRet",
    typeId = 36011,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_LuckyBullFreeRet)
        end
        o.freeSpin = PKG_LuckyBull_FreeSpin.Create() -- PKG.LuckyBull.FreeSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- freeSpin
        self.freeSpin = PKG_LuckyBull_FreeSpin.Create(); r = self.freeSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_LuckyBullFreeRet.__index = PKG_Slots_Client_LuckyBullFreeRet
...
PKG_Client_Slots_LuckyBullFreeSpin = {
    typeName = "PKG_Client_Slots_LuckyBullFreeSpin",
    typeId = 36021,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_LuckyBullFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_LuckyBullFreeSpin.__index = PKG_Client_Slots_LuckyBullFreeSpin
...
PKG_Slots_Client_LuckyBullEnterResumed = {
    typeName = "PKG_Slots_Client_LuckyBullEnterResumed",
    typeId = 36012,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_LuckyBullEnterResumed)
        end
        --[[
        押注等级
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_LuckyBullNormalRet.Create() -- PKG.Slots_Client.LuckyBullNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_LuckyBullFreeRet.Create() -- PKG.Slots_Client.LuckyBullFreeRet
        o.status = 0 -- Int32
        return o
    end,
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_LuckyBullNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_LuckyBullFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        -- status
...
PKG_Slots_Client_LuckyBullEnterResumed.__index = PKG_Slots_Client_LuckyBullEnterResumed

--[[
请求获取生成图形
]]
PKG_Client_Slots_LuckyBullNormalSpin = {
    typeName = "PKG_Client_Slots_LuckyBullNormalSpin",
    typeId = 36020,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_LuckyBullNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_LuckyBullNormalSpin.__index = PKG_Client_Slots_LuckyBullNormalSpin
...
PKG_LuckyBull_Cell = {
    typeName = "PKG_LuckyBull_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_LuckyBull_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_LuckyBull_Cell.__index = PKG_LuckyBull_Cell

PKG_LuckyBull_Line = {
    typeName = "PKG_LuckyBull_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_LuckyBull_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.LuckyBull.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_LuckyBull_Line.__index = PKG_LuckyBull_Line
...
local o = ObjMgr
o.Register(PKG_LuckyBull_NormalSpin)
o.Register(PKG_LuckyBull_FreeSpin)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_LuckyBullNormalRet)
o.Register(PKG_Slots_Client_LuckyBullFreeRet)
o.Register(PKG_Slots_Client_Leave_Success)
o.Register(PKG_Client_Slots_LuckyBullFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_LuckyBullEnterResumed)
o.Register(PKG_Client_Slots_LuckyBullNormalSpin)
