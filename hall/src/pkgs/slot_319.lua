...
CodeGen_slot_258_md5 ="#*MD5<bdbd2cc9d9dd35b3045e90f370abb371>*#"

--[[
Sugar请求特殊旋转图形
]]
PKG_DancingDrums_NormalSpin = {
    typeName = "PKG_DancingDrums_NormalSpin",
    typeId = 30541,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DancingDrums_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.DancingDrums.Cell>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
        ...
        o.lines = {} -- List<PKG.DancingDrums.Line>
        --[[
        是否进入收集游戏
        ]]
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_DancingDrums_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_DancingDrums_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoCollect
...
PKG_DancingDrums_NormalSpin.__index = PKG_DancingDrums_NormalSpin

--[[
免费类型选择
]]
PKG_DancingDrums_FreeType = {
    typeName = "PKG_DancingDrums_FreeType",
    typeId = 30542,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DancingDrums_FreeType)
        end
        --[[
        倍率类型
        ]]
...
PKG_DancingDrums_FreeType.__index = PKG_DancingDrums_FreeType

--[[
Sugar请求特殊旋转图形
]]
PKG_DancingDrums_FreeSpin = {
    typeName = "PKG_DancingDrums_FreeSpin",
    typeId = 30543,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DancingDrums_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_DancingDrums_FreeSpin.__index = PKG_DancingDrums_FreeSpin

--[[
狂野蛮牛-普通结果
]]
PKG_Slots_Client_DancingDrumsNormalRet = {
    typeName = "PKG_Slots_Client_DancingDrumsNormalRet", -- : PKG_DancingDrums_NormalSpin
    typeId = 30547,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DancingDrumsNormalRet)
        end
        PKG_DancingDrums_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_DancingDrums_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_DancingDrums_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_DancingDrumsNormalRet.__index = PKG_Slots_Client_DancingDrumsNormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_DancingDrumsFreeRetType = {
    typeName = "PKG_Slots_Client_DancingDrumsFreeRetType", -- : PKG_DancingDrums_FreeType
    typeId = 30548,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DancingDrumsFreeRetType)
        end
        PKG_DancingDrums_FreeType.Create(o)
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- base read
        r = PKG_DancingDrums_FreeType.Read(self, om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_DancingDrums_FreeType.Write(self, om)
    end
}
PKG_Slots_Client_DancingDrumsFreeRetType.__index = PKG_Slots_Client_DancingDrumsFreeRetType

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_DancingDrumsFreeRet = {
    typeName = "PKG_Slots_Client_DancingDrumsFreeRet", -- : PKG_DancingDrums_FreeSpin
    typeId = 30549,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DancingDrumsFreeRet)
        end
        PKG_DancingDrums_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_DancingDrums_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_DancingDrums_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_DancingDrumsFreeRet.__index = PKG_Slots_Client_DancingDrumsFreeRet
...
PKG_Client_Slots_DancingDrumsFreeSpin = {
    typeName = "PKG_Client_Slots_DancingDrumsFreeSpin",
    typeId = 30546,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_DancingDrumsFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_DancingDrumsFreeSpin.__index = PKG_Client_Slots_DancingDrumsFreeSpin
...
PKG_Slots_Client_DancingDrumsEnterResumed = {
    typeName = "PKG_Slots_Client_DancingDrumsEnterResumed",
    typeId = 30550,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DancingDrumsEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_DancingDrumsNormalRet.Create() -- PKG.Slots_Client.DancingDrumsNormalRet
        --[[
        恢复免费游戏类型
        ]]
        o.freeType = PKG_Slots_Client_DancingDrumsFreeRetType.Create() -- PKG.Slots_Client.DancingDrumsFreeRetType
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_DancingDrumsFreeRet.Create() -- PKG.Slots_Client.DancingDrumsFreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_DancingDrumsNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- freeType
        self.freeType = PKG_Slots_Client_DancingDrumsFreeRetType.Create(); r = self.freeType:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_DancingDrumsFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_DancingDrumsEnterResumed.__index = PKG_Slots_Client_DancingDrumsEnterResumed

--[[
发财树 请求免费类型
]]
PKG_Client_Slots_DancingDrumsFreeType = {
    typeName = "PKG_Client_Slots_DancingDrumsFreeType",
    typeId = 30545,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_DancingDrumsFreeType)
        end
        --[[
        押注类型
        ]]
...
PKG_Client_Slots_DancingDrumsFreeType.__index = PKG_Client_Slots_DancingDrumsFreeType

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_DancingDrumsNormalSpin = {
    typeName = "PKG_Client_Slots_DancingDrumsNormalSpin",
    typeId = 30544,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_DancingDrumsNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_DancingDrumsNormalSpin.__index = PKG_Client_Slots_DancingDrumsNormalSpin
...
PKG_DancingDrums_Cell = {
    typeName = "PKG_DancingDrums_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DancingDrums_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_DancingDrums_Cell.__index = PKG_DancingDrums_Cell

PKG_DancingDrums_Line = {
    typeName = "PKG_DancingDrums_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DancingDrums_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.DancingDrums.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_DancingDrums_Line.__index = PKG_DancingDrums_Line
...
local o = ObjMgr
o.Register(PKG_DancingDrums_NormalSpin)
o.Register(PKG_DancingDrums_FreeType)
o.Register(PKG_DancingDrums_FreeSpin)
o.Register(PKG_Slots_Client_DancingDrumsNormalRet)
o.Register(PKG_Slots_Client_DancingDrumsFreeRetType)
o.Register(PKG_Slots_Client_DancingDrumsFreeRet)
...
o.Register(PKG_Client_Slots_DancingDrumsFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_DancingDrumsEnterResumed)
o.Register(PKG_Client_Slots_DancingDrumsFreeType)
o.Register(PKG_Client_Slots_DancingDrumsNormalSpin)
