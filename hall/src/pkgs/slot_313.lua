...
CodeGen_slot_282_md5 ="#*MD5<7f0016dfb5fd72e2ecb11be1e7cab7a5>*#"

--[[
Sugar请求特殊旋转图形
]]
PKG_NvXia_NormalSpin = {
    typeName = "PKG_NvXia_NormalSpin",
    typeId = 30651,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_NvXia_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_NvXia_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_NvXia_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_NvXia_NormalSpin.__index = PKG_NvXia_NormalSpin

--[[
Sugar请求免费旋转图形
]]
PKG_NvXia_FreeSpin = {
    typeName = "PKG_NvXia_FreeSpin",
    typeId = 30652,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_NvXia_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_NvXia_FreeSpin.__index = PKG_NvXia_FreeSpin

--[[
Sugar请求免费旋转图形
]]
PKG_NvXia_SpecialSpin = {
    typeName = "PKG_NvXia_SpecialSpin",
    typeId = 30653,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_NvXia_SpecialSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_NvXia_SpecialSpin.__index = PKG_NvXia_SpecialSpin

--[[
财神赐宝-普通结果
]]
PKG_Slots_Client_NvXiaNormalRet = {
    typeName = "PKG_Slots_Client_NvXiaNormalRet", -- : PKG_NvXia_NormalSpin
    typeId = 30657,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_NvXiaNormalRet)
        end
        PKG_NvXia_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_NvXia_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_NvXia_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_NvXiaNormalRet.__index = PKG_Slots_Client_NvXiaNormalRet

--[[
财神赐宝 免费游戏结果
]]
PKG_Slots_Client_NvXiaFreeRet = {
    typeName = "PKG_Slots_Client_NvXiaFreeRet", -- : PKG_NvXia_FreeSpin
    typeId = 30658,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_NvXiaFreeRet)
        end
        PKG_NvXia_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_NvXia_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_NvXia_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_NvXiaFreeRet.__index = PKG_Slots_Client_NvXiaFreeRet

--[[
财神赐宝 免费游戏结果
]]
PKG_Slots_Client_NvXiaSpecialRet = {
    typeName = "PKG_Slots_Client_NvXiaSpecialRet", -- : PKG_NvXia_SpecialSpin
    typeId = 30659,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_NvXiaSpecialRet)
        end
        PKG_NvXia_SpecialSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_NvXia_SpecialSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_NvXia_SpecialSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_NvXiaSpecialRet.__index = PKG_Slots_Client_NvXiaSpecialRet
...
PKG_Client_Slots_NvXiaSpecialSpin = {
    typeName = "PKG_Client_Slots_NvXiaSpecialSpin",
    typeId = 30656,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_NvXiaSpecialSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_NvXiaSpecialSpin.__index = PKG_Client_Slots_NvXiaSpecialSpin
...
PKG_Slots_Client_NvXiaEnterResumed = {
    typeName = "PKG_Slots_Client_NvXiaEnterResumed",
    typeId = 30660,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_NvXiaEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.lvID = 0 -- Int32
        o.type = 0 -- Int32
        o.resumedNormal = PKG_Slots_Client_NvXiaNormalRet.Create() -- PKG.Slots_Client.NvXiaNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_NvXiaFreeRet.Create() -- PKG.Slots_Client.NvXiaFreeRet
        --[[
        恢复灯笼类型结果
        ]]
        o.resumedSpecial = PKG_Slots_Client_NvXiaSpecialRet.Create() -- PKG.Slots_Client.NvXiaSpecialRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_NvXiaNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_NvXiaFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        -- resumedSpecial
        self.resumedSpecial = PKG_Slots_Client_NvXiaSpecialRet.Create(); r = self.resumedSpecial:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_NvXiaEnterResumed.__index = PKG_Slots_Client_NvXiaEnterResumed

--[[
女侠 龙腾虎啸 请求免费类型
]]
PKG_Client_Slots_NvXiaFreeSpin = {
    typeName = "PKG_Client_Slots_NvXiaFreeSpin",
    typeId = 30655,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_NvXiaFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_NvXiaFreeSpin.__index = PKG_Client_Slots_NvXiaFreeSpin

--[[
女侠 龙腾虎啸  普通旋转
]]
PKG_Client_Slots_NvXiaNormalSpin = {
    typeName = "PKG_Client_Slots_NvXiaNormalSpin",
    typeId = 30654,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_NvXiaNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_NvXiaNormalSpin.__index = PKG_Client_Slots_NvXiaNormalSpin
...
PKG_NvXia_Cell = {
    typeName = "PKG_NvXia_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_NvXia_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_NvXia_Cell.__index = PKG_NvXia_Cell

PKG_NvXia_Line = {
    typeName = "PKG_NvXia_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_NvXia_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.NvXia.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_NvXia_Line.__index = PKG_NvXia_Line
...
local o = ObjMgr
o.Register(PKG_NvXia_NormalSpin)
o.Register(PKG_NvXia_FreeSpin)
o.Register(PKG_NvXia_SpecialSpin)
o.Register(PKG_Slots_Client_NvXiaNormalRet)
o.Register(PKG_Slots_Client_NvXiaFreeRet)
o.Register(PKG_Slots_Client_NvXiaSpecialRet)
...
o.Register(PKG_Client_Slots_NvXiaSpecialSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_NvXiaEnterResumed)
o.Register(PKG_Client_Slots_NvXiaFreeSpin)
o.Register(PKG_Client_Slots_NvXiaNormalSpin)
