...
CodeGen_slot_220_md5 ="#*MD5<a22f8f108365209d7ee40ac0de6adc3e>*#"

PKG_PandaTreasures_PandaTreasuresSymbol = {
    SymbolWild = 1,
    SymbolTurtle = 2,
    SymbolFish = 3,
    SymbolBarA = 4,
...
PKG_PandaTreasures_PandaTreasuresBase = {
    typeName = "PKG_PandaTreasures_PandaTreasuresBase",
    typeId = 30311,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_PandaTreasures_PandaTreasuresBase)
        end
        --[[
        (一次旋转押注 免费游戏为0)
        ]]
        ...
        o.grids = {} -- List<PKG.PandaTreasures.Cell>
        return o
    end,
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_PandaTreasures_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_PandaTreasures_PandaTreasuresBase.__index = PKG_PandaTreasures_PandaTreasuresBase
...
PKG_Slots_Client_PandaTreasuresNormalRet = {
    typeName = "PKG_Slots_Client_PandaTreasuresNormalRet", -- : PKG_PandaTreasures_PandaTreasuresBase
    typeId = 30315,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_PandaTreasuresNormalRet)
        end
        PKG_PandaTreasures_PandaTreasuresBase.Create(o)
        --[[
        是否进入免费游戏
        ]]
        o.avatarId = 0 -- Int32
        ...
        o.lines = {} -- List<PKG.PandaTreasures.Line>
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_PandaTreasures_PandaTreasuresBase.Read(self, om)
        if r ~= 0 then return r end
        -- avatarId
        r, self.avatarId = d:Rvi32()
        if r ~= 0 then return r end
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_PandaTreasures_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_PandaTreasures_PandaTreasuresBase.Write(self, om)
        -- avatarId
        d:Wvi32(self.avatarId)
        -- lockStates
...
PKG_Slots_Client_PandaTreasuresNormalRet.__index = PKG_Slots_Client_PandaTreasuresNormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_PandaTreasuresFreeRetType = {
    typeName = "PKG_Slots_Client_PandaTreasuresFreeRetType",
    typeId = 30316,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_PandaTreasuresFreeRetType)
        end
        --[[
        返回免费的次数
        ]]
...
PKG_Slots_Client_PandaTreasuresFreeRetType.__index = PKG_Slots_Client_PandaTreasuresFreeRetType

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_PandaTreasuresFreeRet = {
    typeName = "PKG_Slots_Client_PandaTreasuresFreeRet", -- : PKG_PandaTreasures_PandaTreasuresBase
    typeId = 30317,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_PandaTreasuresFreeRet)
        end
        PKG_PandaTreasures_PandaTreasuresBase.Create(o)
        --[[
...
PKG_Slots_Client_PandaTreasuresFreeRet.__index = PKG_Slots_Client_PandaTreasuresFreeRet

--[[
Sugar请求特殊旋转图形
]]
PKG_Client_Slots_PandaTreasuresFreeSpin = {
    typeName = "PKG_Client_Slots_PandaTreasuresFreeSpin",
    typeId = 30314,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_PandaTreasuresFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_PandaTreasuresFreeSpin.__index = PKG_Client_Slots_PandaTreasuresFreeSpin
...
PKG_Client_Slots_PandaTreasuresNormalSpin = {
    typeName = "PKG_Client_Slots_PandaTreasuresNormalSpin",
    typeId = 30312,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_PandaTreasuresNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_PandaTreasuresNormalSpin.__index = PKG_Client_Slots_PandaTreasuresNormalSpin
...
PKG_Slots_Client_PandaTreasuresEnterResumed = {
    typeName = "PKG_Slots_Client_PandaTreasuresEnterResumed",
    typeId = 30318,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_PandaTreasuresEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_PandaTreasuresNormalRet.Create() -- PKG.Slots_Client.PandaTreasuresNormalRet
        --[[
        恢复免费游戏类型
        ]]
        o.resumedFreeType = PKG_Slots_Client_PandaTreasuresFreeRetType.Create() -- PKG.Slots_Client.PandaTreasuresFreeRetType
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFreeRet = PKG_Slots_Client_PandaTreasuresFreeRet.Create() -- PKG.Slots_Client.PandaTreasuresFreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_PandaTreasuresNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeType
        self.resumedFreeType = PKG_Slots_Client_PandaTreasuresFreeRetType.Create(); r = self.resumedFreeType:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeRet
        self.resumedFreeRet = PKG_Slots_Client_PandaTreasuresFreeRet.Create(); r = self.resumedFreeRet:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_PandaTreasuresEnterResumed.__index = PKG_Slots_Client_PandaTreasuresEnterResumed

--[[
发财树 请求免费类型
]]
PKG_Client_Slots_PandaTreasuresFreeType = {
    typeName = "PKG_Client_Slots_PandaTreasuresFreeType",
    typeId = 30313,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_PandaTreasuresFreeType)
        end
        --[[
        押注类型
        ]]
...
PKG_Client_Slots_PandaTreasuresFreeType.__index = PKG_Client_Slots_PandaTreasuresFreeType
...
PKG_PandaTreasures_Cell = {
    typeName = "PKG_PandaTreasures_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_PandaTreasures_Cell)
        end
        --[[
        点对应下标
        ]]
        ...
        o.icon = 0 -- PKG.PandaTreasures.PandaTreasuresSymbol
        --[[
        图形的彩金值
        ]]
...
PKG_PandaTreasures_Cell.__index = PKG_PandaTreasures_Cell
...
PKG_PandaTreasures_Line = {
    typeName = "PKG_PandaTreasures_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_PandaTreasures_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.PandaTreasures.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_PandaTreasures_Line.__index = PKG_PandaTreasures_Line
...
local o = ObjMgr
o.Register(PKG_PandaTreasures_PandaTreasuresBase)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_PandaTreasuresNormalRet)
o.Register(PKG_Slots_Client_PandaTreasuresFreeRetType)
o.Register(PKG_Slots_Client_PandaTreasuresFreeRet)
o.Register(PKG_Client_Slots_PandaTreasuresFreeSpin)
o.Register(PKG_Slots_Client_OfflineCheck)
o.Register(PKG_Slots_Client_Leave_Success)
o.Register(PKG_Client_Slots_PandaTreasuresNormalSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_PandaTreasuresEnterResumed)
o.Register(PKG_Client_Slots_PandaTreasuresFreeType)
