...
require('g_net')
CodeGen_slot_374_md5 ="#*MD5<066749fa0a8d6164460915910e332389>*#"

--[[
Sugar请求特殊旋转图形
]]
PKG_Pompe_NormalSpin = {
    typeName = "PKG_Pompe_NormalSpin",
    typeId = 37401,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Pompe_NormalSpin)
        end
        o.betMoney = 0 -- Int64
        o.grids = {} -- List<PKG.Pompe.Cell>
        o.lines = {} -- List<PKG.Pompe.Line>
        o.gotFreeTimes = 0 -- Int32
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_Pompe_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- lines
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_Pompe_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- gotFreeTimes
        r, self.gotFreeTimes = d:Rvi32()
        if r ~= 0 then return r end
        -- curWinCoin
...
PKG_Pompe_NormalSpin.__index = PKG_Pompe_NormalSpin

--[[
Sugar请求免费旋转图形
]]
PKG_Pompe_FreeSpin = {
    typeName = "PKG_Pompe_FreeSpin",
    typeId = 37402,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Pompe_FreeSpin)
        end
        o.betMoney = 0 -- Int64
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
...
PKG_Pompe_FreeSpin.__index = PKG_Pompe_FreeSpin
...
PKG_Slots_Client_PompeNormalRet = {
    typeName = "PKG_Slots_Client_PompeNormalRet",
    typeId = 37420,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_PompeNormalRet)
        end
        o.normalSpin = PKG_Pompe_NormalSpin.Create() -- PKG.Pompe.NormalSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- normalSpin
        self.normalSpin = PKG_Pompe_NormalSpin.Create(); r = self.normalSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_PompeNormalRet.__index = PKG_Slots_Client_PompeNormalRet

--[[
免费游戏结果
]]
PKG_Slots_Client_PompeFreeRet = {
    typeName = "PKG_Slots_Client_PompeFreeRet",
    typeId = 37421,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_PompeFreeRet)
        end
        o.freeSpin = PKG_Pompe_FreeSpin.Create() -- PKG.Pompe.FreeSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- freeSpin
        self.freeSpin = PKG_Pompe_FreeSpin.Create(); r = self.freeSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_PompeFreeRet.__index = PKG_Slots_Client_PompeFreeRet
...
PKG_Client_Slots_PompeFreeSpin = {
    typeName = "PKG_Client_Slots_PompeFreeSpin",
    typeId = 37411,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_PompeFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_PompeFreeSpin.__index = PKG_Client_Slots_PompeFreeSpin
...
PKG_Slots_Client_PompeEnterResumed = {
    typeName = "PKG_Slots_Client_PompeEnterResumed",
    typeId = 37422,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_PompeEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.lvID = 0 -- Int32
        o.resumedNormal = PKG_Slots_Client_PompeNormalRet.Create() -- PKG.Slots_Client.PompeNormalRet
        o.resumedFree = PKG_Slots_Client_PompeFreeRet.Create() -- PKG.Slots_Client.PompeFreeRet
    ...
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_PompeNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_PompeFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        -- lastMsgType
...
PKG_Slots_Client_PompeEnterResumed.__index = PKG_Slots_Client_PompeEnterResumed

--[[
 普通旋转
]]
PKG_Client_Slots_PompeNormalSpin = {
    typeName = "PKG_Client_Slots_PompeNormalSpin",
    typeId = 37410,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_PompeNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_PompeNormalSpin.__index = PKG_Client_Slots_PompeNormalSpin
...
PKG_Pompe_Cell = {
    typeName = "PKG_Pompe_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Pompe_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_Pompe_Cell.__index = PKG_Pompe_Cell

PKG_Pompe_Line = {
    typeName = "PKG_Pompe_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Pompe_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.Pompe.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_Pompe_Line.__index = PKG_Pompe_Line
...
local o = ObjMgr
o.Register(PKG_Pompe_NormalSpin)
o.Register(PKG_Pompe_FreeSpin)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_PompeNormalRet)
o.Register(PKG_Slots_Client_PompeFreeRet)
o.Register(PKG_Slots_Client_Leave_Success)
o.Register(PKG_Client_Slots_PompeFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_PompeEnterResumed)
o.Register(PKG_Client_Slots_PompeNormalSpin)
