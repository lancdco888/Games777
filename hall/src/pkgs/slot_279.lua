...
CodeGen_slot_279_md5 ="#*MD5<0c0ec38e18d6ae2426f48ac1b413ce76>*#"

--[[
生成图形数组和相关结果的基类
]]
PKG_Pegasus_NormalSpin = {
    typeName = "PKG_Pegasus_NormalSpin",
    typeId = 30671,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Pegasus_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.Pegasus.Cell>
        --[[
        (符合连线规则)
        ]]
        o.lines = {} -- List<PKG.Pegasus.Line>
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_Pegasus_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- lines
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_Pegasus_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- changeWilds
...
PKG_Pegasus_NormalSpin.__index = PKG_Pegasus_NormalSpin

--[[
生成图形数组和相关结果的基类
]]
PKG_Pegasus_FreeSpin = {
    typeName = "PKG_Pegasus_FreeSpin",
    typeId = 30672,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Pegasus_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_Pegasus_FreeSpin.__index = PKG_Pegasus_FreeSpin
...
PKG_Slots_Client_PegasusNormalRet = {
    typeName = "PKG_Slots_Client_PegasusNormalRet", -- : PKG_Pegasus_NormalSpin
    typeId = 30675,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_PegasusNormalRet)
        end
        PKG_Pegasus_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_Pegasus_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_Pegasus_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_PegasusNormalRet.__index = PKG_Slots_Client_PegasusNormalRet

--[[
Sugar-彩虹触发的免费游戏结果
]]
PKG_Slots_Client_PegasusFreeRet = {
    typeName = "PKG_Slots_Client_PegasusFreeRet", -- : PKG_Pegasus_FreeSpin
    typeId = 30676,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_PegasusFreeRet)
        end
        PKG_Pegasus_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        o.levelUpMoney = 0 -- Int64
        o.levelUpMoneys = {} -- List<Int64>
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_Pegasus_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_Pegasus_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_PegasusFreeRet.__index = PKG_Slots_Client_PegasusFreeRet
...
PKG_Client_Slots_PegasusFreeSpin = {
    typeName = "PKG_Client_Slots_PegasusFreeSpin",
    typeId = 30674,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_PegasusFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_PegasusFreeSpin.__index = PKG_Client_Slots_PegasusFreeSpin
...
PKG_Slots_Client_PegasusEnterResumed = {
    typeName = "PKG_Slots_Client_PegasusEnterResumed",
    typeId = 30677,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_PegasusEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_PegasusNormalRet.Create() -- PKG.Slots_Client.PegasusNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_PegasusFreeRet.Create() -- PKG.Slots_Client.PegasusFreeRet
        --[[
        游戏彩金已开的数组
        ]]
        o.cells = {} -- List<Int32>
    ...
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_PegasusNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_PegasusFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        -- cells
        r, len = d:Rvu32()
        if len > d:GetLeft() then return -1 end
...
PKG_Slots_Client_PegasusEnterResumed.__index = PKG_Slots_Client_PegasusEnterResumed

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_PegasusNormalSpin = {
    typeName = "PKG_Client_Slots_PegasusNormalSpin",
    typeId = 30673,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_PegasusNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_PegasusNormalSpin.__index = PKG_Client_Slots_PegasusNormalSpin
...
PKG_Pegasus_Cell = {
    typeName = "PKG_Pegasus_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Pegasus_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_Pegasus_Cell.__index = PKG_Pegasus_Cell

PKG_Pegasus_Line = {
    typeName = "PKG_Pegasus_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Pegasus_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.Pegasus.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_Pegasus_Line.__index = PKG_Pegasus_Line
...
local o = ObjMgr
o.Register(PKG_Pegasus_NormalSpin)
o.Register(PKG_Pegasus_FreeSpin)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_PegasusNormalRet)
o.Register(PKG_Slots_Client_PegasusFreeRet)
o.Register(PKG_Slots_Client_Leave_Success)
o.Register(PKG_Client_Slots_PegasusFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_PegasusEnterResumed)
o.Register(PKG_Client_Slots_PegasusNormalSpin)
