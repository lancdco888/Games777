...
CodeGen_slot_306_md5 ="#*MD5<d08e2ed93df25e2e9cc8a70c2ace06bc>*#"

--[[
Sugar请求特殊旋转图形
]]
PKG_HeavenEarth_NormalSpin = {
    typeName = "PKG_HeavenEarth_NormalSpin",
    typeId = 30831,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_HeavenEarth_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.HeavenEarth.Cell>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
        ...
        o.lines = {} -- List<PKG.HeavenEarth.Line>
        return o
    end,
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_HeavenEarth_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_HeavenEarth_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_HeavenEarth_NormalSpin.__index = PKG_HeavenEarth_NormalSpin

--[[
Sugar请求免费旋转图形
]]
PKG_HeavenEarth_FreeSpin = {
    typeName = "PKG_HeavenEarth_FreeSpin",
    typeId = 30832,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_HeavenEarth_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.newfreeType = 0 -- Int32
        o.newfreetime = 0 -- Int32
        o.otherfreetime = 0 -- Int32
        --[[
        中奖的线
        ]]
        o.lines = {} -- List<PKG.HeavenEarth.Line>
    ...
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- newfreeType
        r, self.newfreeType = d:Rvi32()
        if r ~= 0 then return r end
        -- newfreetime
        r, self.newfreetime = d:Rvi32()
        if r ~= 0 then return r end
        -- otherfreetime
        r, self.otherfreetime = d:Rvi32()
        if r ~= 0 then return r end
        -- lines
        r, len = d:Rvu32()
        if len > d:GetLeft() then return -1 end
    ...
    Write = function(self, om)
        ...
        -- newfreeType
        d:Wvi32(self.newfreeType)
        -- newfreetime
        d:Wvi32(self.newfreetime)
        -- otherfreetime
        d:Wvi32(self.otherfreetime)
        -- lines
        o = self.lines
        len = #o
        d:Wvu32(len)
...
PKG_HeavenEarth_FreeSpin.__index = PKG_HeavenEarth_FreeSpin
...
PKG_Slots_Client_HeavenEarthNormalRet = {
    typeName = "PKG_Slots_Client_HeavenEarthNormalRet", -- : PKG_HeavenEarth_NormalSpin
    typeId = 30835,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_HeavenEarthNormalRet)
        end
        PKG_HeavenEarth_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_HeavenEarth_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_HeavenEarth_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_HeavenEarthNormalRet.__index = PKG_Slots_Client_HeavenEarthNormalRet

--[[
财神赐宝 免费游戏结果
]]
PKG_Slots_Client_HeavenEarthFreeRet = {
    typeName = "PKG_Slots_Client_HeavenEarthFreeRet", -- : PKG_HeavenEarth_FreeSpin
    typeId = 30836,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_HeavenEarthFreeRet)
        end
        PKG_HeavenEarth_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_HeavenEarth_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_HeavenEarth_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_HeavenEarthFreeRet.__index = PKG_Slots_Client_HeavenEarthFreeRet
...
PKG_Client_Slots_HeavenEarthFreeSpin = {
    typeName = "PKG_Client_Slots_HeavenEarthFreeSpin",
    typeId = 30834,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_HeavenEarthFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_HeavenEarthFreeSpin.__index = PKG_Client_Slots_HeavenEarthFreeSpin
...
PKG_Slots_Client_HeavenEarthEnterResumed = {
    typeName = "PKG_Slots_Client_HeavenEarthEnterResumed",
    typeId = 30837,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_HeavenEarthEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_HeavenEarthNormalRet.Create() -- PKG.Slots_Client.HeavenEarthNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_HeavenEarthFreeRet.Create() -- PKG.Slots_Client.HeavenEarthFreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_HeavenEarthNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_HeavenEarthFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_HeavenEarthEnterResumed.__index = PKG_Slots_Client_HeavenEarthEnterResumed

--[[
财神赐宝  普通旋转
]]
PKG_Client_Slots_HeavenEarthNormalSpin = {
    typeName = "PKG_Client_Slots_HeavenEarthNormalSpin",
    typeId = 30833,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_HeavenEarthNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_HeavenEarthNormalSpin.__index = PKG_Client_Slots_HeavenEarthNormalSpin
...
PKG_HeavenEarth_Cell = {
    typeName = "PKG_HeavenEarth_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_HeavenEarth_Cell)
        end
        --[[
        点对应下标
        ]]
    ...
    Write = function(self, om)
        ...
        d:Wvi32(self.icon)
        -- hasDouble
        d:Wvi32(self.hasDouble)
    end
}
PKG_HeavenEarth_Cell.__index = PKG_HeavenEarth_Cell

PKG_HeavenEarth_Line = {
    typeName = "PKG_HeavenEarth_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_HeavenEarth_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.HeavenEarth.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_HeavenEarth_Line.__index = PKG_HeavenEarth_Line
...
local o = ObjMgr
o.Register(PKG_HeavenEarth_NormalSpin)
o.Register(PKG_HeavenEarth_FreeSpin)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_HeavenEarthNormalRet)
o.Register(PKG_Slots_Client_HeavenEarthFreeRet)
o.Register(PKG_Slots_Client_Leave_Success)
o.Register(PKG_Client_Slots_HeavenEarthFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_HeavenEarthEnterResumed)
o.Register(PKG_Client_Slots_HeavenEarthNormalSpin)
