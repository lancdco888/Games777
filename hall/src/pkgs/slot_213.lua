...
CodeGen_slot_213_md5 ="#*MD5<87833410b5260b9df2478e580edb0567>*#"

PKG_TigerWealth_TigerWealthSymbol = {
    SymbolWild = 1,
    SymbolTiger = 2,
    SymbolCaibao = 3,
    SymbolYellow = 4,
...
PKG_TigerWealth_TigerWealthBase = {
    typeName = "PKG_TigerWealth_TigerWealthBase",
    typeId = 30131,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_TigerWealth_TigerWealthBase)
        end
        --[[
        (一次旋转押注 免费游戏为0)
        ]]
        ...
        o.grids = {} -- List<PKG.TigerWealth.Cell>
        --[[
        哪些列要变凤凰 (3,5)
        ]]
        ...
        o.backinfos = {} -- List<PKG.TigerWealth.map>
        return o
    end,
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_TigerWealth_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- changeWilds
        ...
        self.backinfos = o
        for i = 1, len do
            o[i] = PKG_TigerWealth_map.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_TigerWealth_TigerWealthBase.__index = PKG_TigerWealth_TigerWealthBase

--[[
Sugar-普通结果
]]
PKG_Slots_Client_TigerWealthNormalRet = {
    typeName = "PKG_Slots_Client_TigerWealthNormalRet", -- : PKG_TigerWealth_TigerWealthBase
    typeId = 30245,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_TigerWealthNormalRet)
        end
        PKG_TigerWealth_TigerWealthBase.Create(o)
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
        ...
        o.lines = {} -- List<PKG.TigerWealth.Line>
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_TigerWealth_TigerWealthBase.Read(self, om)
        if r ~= 0 then return r end
        -- intoFree
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_TigerWealth_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_TigerWealth_TigerWealthBase.Write(self, om)
        -- intoFree
...
PKG_Slots_Client_TigerWealthNormalRet.__index = PKG_Slots_Client_TigerWealthNormalRet

--[[
金虎聚财213 设置免费类型返回结果
]]
PKG_Slots_Client_TigerWealthFreeRetType = {
    typeName = "PKG_Slots_Client_TigerWealthFreeRetType",
    typeId = 30246,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_TigerWealthFreeRetType)
        end
        --[[
        返回免费的次数
        ]]
...
PKG_Slots_Client_TigerWealthFreeRetType.__index = PKG_Slots_Client_TigerWealthFreeRetType

--[[
Sugar-彩虹触发的免费游戏结果
]]
PKG_Slots_Client_TigerWealthFreeRet = {
    typeName = "PKG_Slots_Client_TigerWealthFreeRet", -- : PKG_TigerWealth_TigerWealthBase
    typeId = 30247,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_TigerWealthFreeRet)
        end
        PKG_TigerWealth_TigerWealthBase.Create(o)
        --[[
...
PKG_Slots_Client_TigerWealthFreeRet.__index = PKG_Slots_Client_TigerWealthFreeRet
...
PKG_Client_Slots_TigerWealthFreeType = {
    typeName = "PKG_Client_Slots_TigerWealthFreeType",
    typeId = 30243,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_TigerWealthFreeType)
        end
        --[[
        押注类型
        ]]
...
PKG_Client_Slots_TigerWealthFreeType.__index = PKG_Client_Slots_TigerWealthFreeType
...
PKG_Slots_Client_TigerWealthEnterResumed = {
    typeName = "PKG_Slots_Client_TigerWealthEnterResumed",
    typeId = 30248,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_TigerWealthEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_TigerWealthNormalRet.Create() -- PKG.Slots_Client.TigerWealthNormalRet
        --[[
        恢复免费游戏类型
        ]]
        o.resumedFreeType = PKG_Slots_Client_TigerWealthFreeRetType.Create() -- PKG.Slots_Client.TigerWealthFreeRetType
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFreeRet = PKG_Slots_Client_TigerWealthFreeRet.Create() -- PKG.Slots_Client.TigerWealthFreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_TigerWealthNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeType
        self.resumedFreeType = PKG_Slots_Client_TigerWealthFreeRetType.Create(); r = self.resumedFreeType:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeRet
        self.resumedFreeRet = PKG_Slots_Client_TigerWealthFreeRet.Create(); r = self.resumedFreeRet:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_TigerWealthEnterResumed.__index = PKG_Slots_Client_TigerWealthEnterResumed

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_TigerWealthNormalSpin = {
    typeName = "PKG_Client_Slots_TigerWealthNormalSpin",
    typeId = 30242,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_TigerWealthNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_TigerWealthNormalSpin.__index = PKG_Client_Slots_TigerWealthNormalSpin

--[[
Sugar请求特殊旋转图形
]]
PKG_Client_Slots_TigerWealthFreeSpin = {
    typeName = "PKG_Client_Slots_TigerWealthFreeSpin",
    typeId = 30244,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_TigerWealthFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_TigerWealthFreeSpin.__index = PKG_Client_Slots_TigerWealthFreeSpin

PKG_TigerWealth_Cell = {
    typeName = "PKG_TigerWealth_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_TigerWealth_Cell)
        end
        --[[
        点对应下标
        ]]
        ...
        o.icon = 0 -- PKG.TigerWealth.TigerWealthSymbol
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_TigerWealth_Cell.__index = PKG_TigerWealth_Cell
...
PKG_TigerWealth_map = {
    typeName = "PKG_TigerWealth_map",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_TigerWealth_map)
        end
        o.index = 0 -- Int32
        o.num = 0 -- Int32
        return o
...
PKG_TigerWealth_map.__index = PKG_TigerWealth_map

PKG_TigerWealth_Line = {
    typeName = "PKG_TigerWealth_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_TigerWealth_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.TigerWealth.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_TigerWealth_Line.__index = PKG_TigerWealth_Line
...
local o = ObjMgr
o.Register(PKG_TigerWealth_TigerWealthBase)
o.Register(PKG_Slots_Client_TigerWealthNormalRet)
o.Register(PKG_Slots_Client_TigerWealthFreeRetType)
o.Register(PKG_Slots_Client_TigerWealthFreeRet)
...
o.Register(PKG_Client_Slots_TigerWealthFreeType)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_TigerWealthEnterResumed)
o.Register(PKG_Client_Slots_TigerWealthNormalSpin)
o.Register(PKG_Client_Slots_TigerWealthFreeSpin)