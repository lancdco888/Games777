...
CodeGen_slot_276_md5 ="#*MD5<0d0b59c091e8c0c853f53261f5427582>*#"

--[[
Sugar请求特殊旋转图形
]]
PKG_WealthTreasure_NormalSpin = {
    typeName = "PKG_WealthTreasure_NormalSpin",
    typeId = 30631,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_WealthTreasure_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.WealthTreasure.Cell>
        --[[
         特殊游戏的出现效果 只能是0 1 2 0就是没有
        ]]
        o.spType = 0 -- Int32
        --[[
        是否进入免费游戏
        ...
        o.lines = {} -- List<PKG.WealthTreasure.Line>
        return o
    end,
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_WealthTreasure_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- spType
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_WealthTreasure_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_WealthTreasure_NormalSpin.__index = PKG_WealthTreasure_NormalSpin

--[[
Sugar请求免费旋转图形
]]
PKG_WealthTreasure_FreeSpin = {
    typeName = "PKG_WealthTreasure_FreeSpin",
    typeId = 30632,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_WealthTreasure_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_WealthTreasure_FreeSpin.__index = PKG_WealthTreasure_FreeSpin
...
PKG_Slots_Client_WealthTreasureNormalRet = {
    typeName = "PKG_Slots_Client_WealthTreasureNormalRet", -- : PKG_WealthTreasure_NormalSpin
    typeId = 30635,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_WealthTreasureNormalRet)
        end
        PKG_WealthTreasure_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_WealthTreasure_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_WealthTreasure_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_WealthTreasureNormalRet.__index = PKG_Slots_Client_WealthTreasureNormalRet

--[[
财神赐宝 免费游戏结果
]]
PKG_Slots_Client_WealthTreasureFreeRet = {
    typeName = "PKG_Slots_Client_WealthTreasureFreeRet", -- : PKG_WealthTreasure_FreeSpin
    typeId = 30636,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_WealthTreasureFreeRet)
        end
        PKG_WealthTreasure_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_WealthTreasure_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_WealthTreasure_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_WealthTreasureFreeRet.__index = PKG_Slots_Client_WealthTreasureFreeRet
...
PKG_Client_Slots_WealthTreasureFreeSpin = {
    typeName = "PKG_Client_Slots_WealthTreasureFreeSpin",
    typeId = 30634,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_WealthTreasureFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_WealthTreasureFreeSpin.__index = PKG_Client_Slots_WealthTreasureFreeSpin
...
PKG_Slots_Client_WealthTreasureEnterResumed = {
    typeName = "PKG_Slots_Client_WealthTreasureEnterResumed",
    typeId = 30637,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_WealthTreasureEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_WealthTreasureNormalRet.Create() -- PKG.Slots_Client.WealthTreasureNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_WealthTreasureFreeRet.Create() -- PKG.Slots_Client.WealthTreasureFreeRet
        --[[
        游戏彩金已开的数组
        ]]
        o.cells = {} -- List<Int32>
    ...
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_WealthTreasureNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_WealthTreasureFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        -- cells
        r, len = d:Rvu32()
        if len > d:GetLeft() then return -1 end
...
PKG_Slots_Client_WealthTreasureEnterResumed.__index = PKG_Slots_Client_WealthTreasureEnterResumed

--[[
财神赐宝  普通旋转
]]
PKG_Client_Slots_WealthTreasureNormalSpin = {
    typeName = "PKG_Client_Slots_WealthTreasureNormalSpin",
    typeId = 30633,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_WealthTreasureNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_WealthTreasureNormalSpin.__index = PKG_Client_Slots_WealthTreasureNormalSpin
...
PKG_WealthTreasure_Cell = {
    typeName = "PKG_WealthTreasure_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_WealthTreasure_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_WealthTreasure_Cell.__index = PKG_WealthTreasure_Cell

PKG_WealthTreasure_Line = {
    typeName = "PKG_WealthTreasure_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_WealthTreasure_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.WealthTreasure.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_WealthTreasure_Line.__index = PKG_WealthTreasure_Line
...
local o = ObjMgr
o.Register(PKG_WealthTreasure_NormalSpin)
o.Register(PKG_WealthTreasure_FreeSpin)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_WealthTreasureNormalRet)
o.Register(PKG_Slots_Client_WealthTreasureFreeRet)
o.Register(PKG_Slots_Client_Leave_Success)
o.Register(PKG_Client_Slots_WealthTreasureFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_WealthTreasureEnterResumed)
o.Register(PKG_Client_Slots_WealthTreasureNormalSpin)
