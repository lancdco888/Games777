...
require('g_net')
CodeGen_slot_277_md5 ="#*MD5<be279da1552b4f45a36d8b0476653948>*#"

--[[
Sugar请求特殊旋转图形
]]
PKG_DragonGift_NormalSpin = {
    typeName = "PKG_DragonGift_NormalSpin",
    typeId = 30711,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DragonGift_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.DragonGift.Cell>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
        ...
        o.lines = {} -- List<PKG.DragonGift.Line>
        return o
    end,
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_DragonGift_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_DragonGift_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_DragonGift_NormalSpin.__index = PKG_DragonGift_NormalSpin

--[[
Sugar请求特殊旋转图形
]]
PKG_DragonGift_FreeSpin = {
    typeName = "PKG_DragonGift_FreeSpin",
    typeId = 30712,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DragonGift_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_DragonGift_FreeSpin.__index = PKG_DragonGift_FreeSpin

--[[
Sugar请求特殊旋转图形
]]
PKG_DragonGift_SpecialSpin = {
    typeName = "PKG_DragonGift_SpecialSpin",
    typeId = 30713,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DragonGift_SpecialSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_DragonGift_SpecialSpin.__index = PKG_DragonGift_SpecialSpin

--[[
狂野蛮牛-普通结果
]]
PKG_Slots_Client_DragonGiftNormalRet = {
    typeName = "PKG_Slots_Client_DragonGiftNormalRet", -- : PKG_DragonGift_NormalSpin
    typeId = 30717,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DragonGiftNormalRet)
        end
        PKG_DragonGift_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_DragonGift_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_DragonGift_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_DragonGiftNormalRet.__index = PKG_Slots_Client_DragonGiftNormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_DragonGiftFreeRet = {
    typeName = "PKG_Slots_Client_DragonGiftFreeRet", -- : PKG_DragonGift_FreeSpin
    typeId = 30718,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DragonGiftFreeRet)
        end
        PKG_DragonGift_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_DragonGift_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_DragonGift_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_DragonGiftFreeRet.__index = PKG_Slots_Client_DragonGiftFreeRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_DragonGiftSpecialRet = {
    typeName = "PKG_Slots_Client_DragonGiftSpecialRet", -- : PKG_DragonGift_SpecialSpin
    typeId = 30719,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DragonGiftSpecialRet)
        end
        PKG_DragonGift_SpecialSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_DragonGift_SpecialSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_DragonGift_SpecialSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_DragonGiftSpecialRet.__index = PKG_Slots_Client_DragonGiftSpecialRet
...
PKG_Client_Slots_DragonGiftSpecialSpin = {
    typeName = "PKG_Client_Slots_DragonGiftSpecialSpin",
    typeId = 30716,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_DragonGiftSpecialSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_DragonGiftSpecialSpin.__index = PKG_Client_Slots_DragonGiftSpecialSpin
...
PKG_Slots_Client_DragonGiftEnterResumed = {
    typeName = "PKG_Slots_Client_DragonGiftEnterResumed",
    typeId = 30720,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DragonGiftEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_DragonGiftNormalRet.Create() -- PKG.Slots_Client.DragonGiftNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_DragonGiftFreeRet.Create() -- PKG.Slots_Client.DragonGiftFreeRet
        --[[
        恢复灯笼类型结果
        ]]
        o.resumedSpecial = PKG_Slots_Client_DragonGiftSpecialRet.Create() -- PKG.Slots_Client.DragonGiftSpecialRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_DragonGiftNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_DragonGiftFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        -- resumedSpecial
        self.resumedSpecial = PKG_Slots_Client_DragonGiftSpecialRet.Create(); r = self.resumedSpecial:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_DragonGiftEnterResumed.__index = PKG_Slots_Client_DragonGiftEnterResumed

--[[
发财树 请求免费类型
]]
PKG_Client_Slots_DragonGiftFreeSpin = {
    typeName = "PKG_Client_Slots_DragonGiftFreeSpin",
    typeId = 30715,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_DragonGiftFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_DragonGiftFreeSpin.__index = PKG_Client_Slots_DragonGiftFreeSpin

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_DragonGiftNormalSpin = {
    typeName = "PKG_Client_Slots_DragonGiftNormalSpin",
    typeId = 30714,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_DragonGiftNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_DragonGiftNormalSpin.__index = PKG_Client_Slots_DragonGiftNormalSpin
...
PKG_DragonGift_Cell = {
    typeName = "PKG_DragonGift_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DragonGift_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_DragonGift_Cell.__index = PKG_DragonGift_Cell

PKG_DragonGift_Line = {
    typeName = "PKG_DragonGift_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DragonGift_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.DragonGift.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_DragonGift_Line.__index = PKG_DragonGift_Line
...
local o = ObjMgr
o.Register(PKG_DragonGift_NormalSpin)
o.Register(PKG_DragonGift_FreeSpin)
o.Register(PKG_DragonGift_SpecialSpin)
o.Register(PKG_Slots_Client_DragonGiftNormalRet)
o.Register(PKG_Slots_Client_DragonGiftFreeRet)
o.Register(PKG_Slots_Client_DragonGiftSpecialRet)
...
o.Register(PKG_Client_Slots_DragonGiftSpecialSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_DragonGiftEnterResumed)
o.Register(PKG_Client_Slots_DragonGiftFreeSpin)
o.Register(PKG_Client_Slots_DragonGiftNormalSpin)
