...
CodeGen_slot_221_md5 ="#*MD5<a0622fc2bd26b3e881c953b2481c6fe0>*#"

PKG_AfricanBuffalo_AfricanBuffaloSymbol = {
    ServerBuffaloWild = 1,
    ServerBuffaloManNiu = 2,
    ServerBuffaloCaibao = 3,
    ServerBuffaloShizi = 4,
    ServerBuffaloDaXiang = 5,
    ServerBuffaloBanMa = 6,
    ServerBuffaloLu = 7,
    ServerBuffaloA = 8,
    ServerBuffaloK = 9,
    ServerBuffaloQ = 10,
...
PKG_AfricanBuffalo_FreeSpin = {
    typeName = "PKG_AfricanBuffalo_FreeSpin",
    typeId = 30322,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_AfricanBuffalo_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.AfricanBuffalo.Cell>
        --[[
        ...
        o.lines = {} -- List<PKG.AfricanBuffalo.Line>
        return o
    end,
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_AfricanBuffalo_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- bonusWinCoin
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_AfricanBuffalo_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_AfricanBuffalo_FreeSpin.__index = PKG_AfricanBuffalo_FreeSpin

--[[
Sugar请求特殊旋转图形
]]
PKG_AfricanBuffalo_NormalSpin = {
    typeName = "PKG_AfricanBuffalo_NormalSpin",
    typeId = 30321,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_AfricanBuffalo_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_AfricanBuffalo_NormalSpin.__index = PKG_AfricanBuffalo_NormalSpin

--[[
Sugar-普通结果
]]
PKG_Slots_Client_AfricanBuffaloNormalRet = {
    typeName = "PKG_Slots_Client_AfricanBuffaloNormalRet", -- : PKG_AfricanBuffalo_NormalSpin
    typeId = 30325,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_AfricanBuffaloNormalRet)
        end
        PKG_AfricanBuffalo_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_AfricanBuffalo_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_AfricanBuffalo_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_AfricanBuffaloNormalRet.__index = PKG_Slots_Client_AfricanBuffaloNormalRet

--[[
Sugar-彩虹触发的免费游戏结果
]]
PKG_Slots_Client_AfricanBuffaloFreeRet = {
    typeName = "PKG_Slots_Client_AfricanBuffaloFreeRet", -- : PKG_AfricanBuffalo_FreeSpin
    typeId = 30326,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_AfricanBuffaloFreeRet)
        end
        PKG_AfricanBuffalo_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_AfricanBuffalo_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_AfricanBuffalo_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_AfricanBuffaloFreeRet.__index = PKG_Slots_Client_AfricanBuffaloFreeRet
...
PKG_Slots_Client_AfricanBuffaloEnterResumed = {
    typeName = "PKG_Slots_Client_AfricanBuffaloEnterResumed",
    typeId = 30327,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_AfricanBuffaloEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_AfricanBuffaloNormalRet.Create() -- PKG.Slots_Client.AfricanBuffaloNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFreeRet = PKG_Slots_Client_AfricanBuffaloFreeRet.Create() -- PKG.Slots_Client.AfricanBuffaloFreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_AfricanBuffaloNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeRet
        self.resumedFreeRet = PKG_Slots_Client_AfricanBuffaloFreeRet.Create(); r = self.resumedFreeRet:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_AfricanBuffaloEnterResumed.__index = PKG_Slots_Client_AfricanBuffaloEnterResumed

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_AfricanBuffaloNormalSpin = {
    typeName = "PKG_Client_Slots_AfricanBuffaloNormalSpin",
    typeId = 30323,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_AfricanBuffaloNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_AfricanBuffaloNormalSpin.__index = PKG_Client_Slots_AfricanBuffaloNormalSpin
...
PKG_Client_Slots_AfricanBuffaloFreeSpin = {
    typeName = "PKG_Client_Slots_AfricanBuffaloFreeSpin",
    typeId = 30324,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_AfricanBuffaloFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_AfricanBuffaloFreeSpin.__index = PKG_Client_Slots_AfricanBuffaloFreeSpin

PKG_AfricanBuffalo_Cell = {
    typeName = "PKG_AfricanBuffalo_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_AfricanBuffalo_Cell)
        end
        --[[
        点对应下标
        ]]
        ...
        o.icon = 0 -- PKG.AfricanBuffalo.AfricanBuffaloSymbol
        --[[
        替代的倍率
        ]]
        o.wildbet = 0 -- Int32
...
PKG_AfricanBuffalo_Cell.__index = PKG_AfricanBuffalo_Cell

PKG_AfricanBuffalo_Line = {
    typeName = "PKG_AfricanBuffalo_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_AfricanBuffalo_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.AfricanBuffalo.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_AfricanBuffalo_Line.__index = PKG_AfricanBuffalo_Line
...
local o = ObjMgr
o.Register(PKG_AfricanBuffalo_FreeSpin)
o.Register(PKG_AfricanBuffalo_NormalSpin)
o.Register(PKG_Slots_Client_AfricanBuffaloNormalRet)
o.Register(PKG_Slots_Client_AfricanBuffaloFreeRet)
...
o.Register(PKG_Slots_Client_AfricanBuffaloEnterResumed)
o.Register(PKG_Client_Slots_AfricanBuffaloNormalSpin)
...
o.Register(PKG_Client_Slots_AfricanBuffaloFreeSpin)