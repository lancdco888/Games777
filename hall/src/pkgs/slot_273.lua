...
CodeGen_slot_273_md5 ="#*MD5<c2fe3e7dfdbcf1171b3bb73a4ccc663a>*#"

--[[
Sugar请求特殊旋转图形
]]
PKG_KoiAnnunciation_NormalSpin = {
    typeName = "PKG_KoiAnnunciation_NormalSpin",
    typeId = 30701,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_KoiAnnunciation_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.KoiAnnunciation.Cell>
        o.wildBet = 0 -- Int32
        --[[
        是否进入免费游戏
        ]]
        ...
        o.lines = {} -- List<PKG.KoiAnnunciation.Line>
        --[[
        是否进入收集游戏
        ]]
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_KoiAnnunciation_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- wildBet
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_KoiAnnunciation_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoCollect
...
PKG_KoiAnnunciation_NormalSpin.__index = PKG_KoiAnnunciation_NormalSpin

--[[
免费类型选择
]]
PKG_KoiAnnunciation_FreeType = {
    typeName = "PKG_KoiAnnunciation_FreeType",
    typeId = 30702,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_KoiAnnunciation_FreeType)
        end
        --[[
        倍率类型
        ]]
...
PKG_KoiAnnunciation_FreeType.__index = PKG_KoiAnnunciation_FreeType

--[[
Sugar请求特殊旋转图形
]]
PKG_KoiAnnunciation_FreeSpin = {
    typeName = "PKG_KoiAnnunciation_FreeSpin",
    typeId = 30703,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_KoiAnnunciation_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_KoiAnnunciation_FreeSpin.__index = PKG_KoiAnnunciation_FreeSpin

--[[
狂野蛮牛-普通结果
]]
PKG_Slots_Client_KoiAnnunciationNormalRet = {
    typeName = "PKG_Slots_Client_KoiAnnunciationNormalRet", -- : PKG_KoiAnnunciation_NormalSpin
    typeId = 30707,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_KoiAnnunciationNormalRet)
        end
        PKG_KoiAnnunciation_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_KoiAnnunciation_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_KoiAnnunciation_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_KoiAnnunciationNormalRet.__index = PKG_Slots_Client_KoiAnnunciationNormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_KoiAnnunciationFreeRetType = {
    typeName = "PKG_Slots_Client_KoiAnnunciationFreeRetType", -- : PKG_KoiAnnunciation_FreeType
    typeId = 30708,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_KoiAnnunciationFreeRetType)
        end
        PKG_KoiAnnunciation_FreeType.Create(o)
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- base read
        r = PKG_KoiAnnunciation_FreeType.Read(self, om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_KoiAnnunciation_FreeType.Write(self, om)
    end
}
PKG_Slots_Client_KoiAnnunciationFreeRetType.__index = PKG_Slots_Client_KoiAnnunciationFreeRetType

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_KoiAnnunciationFreeRet = {
    typeName = "PKG_Slots_Client_KoiAnnunciationFreeRet", -- : PKG_KoiAnnunciation_FreeSpin
    typeId = 30709,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_KoiAnnunciationFreeRet)
        end
        PKG_KoiAnnunciation_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_KoiAnnunciation_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_KoiAnnunciation_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_KoiAnnunciationFreeRet.__index = PKG_Slots_Client_KoiAnnunciationFreeRet
...
PKG_Client_Slots_KoiAnnunciationFreeSpin = {
    typeName = "PKG_Client_Slots_KoiAnnunciationFreeSpin",
    typeId = 30706,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_KoiAnnunciationFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_KoiAnnunciationFreeSpin.__index = PKG_Client_Slots_KoiAnnunciationFreeSpin
...
PKG_Slots_Client_KoiAnnunciationEnterResumed = {
    typeName = "PKG_Slots_Client_KoiAnnunciationEnterResumed",
    typeId = 30710,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_KoiAnnunciationEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_KoiAnnunciationNormalRet.Create() -- PKG.Slots_Client.KoiAnnunciationNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_KoiAnnunciationFreeRet.Create() -- PKG.Slots_Client.KoiAnnunciationFreeRet
        --[[
        恢复免费类型结果
        ]]
        o.freeType = PKG_Slots_Client_KoiAnnunciationFreeRetType.Create() -- PKG.Slots_Client.KoiAnnunciationFreeRetType
        --[[
        游戏彩金已开的数组
        ]]
        o.cells = {} -- List<Int32>
    ...
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_KoiAnnunciationNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_KoiAnnunciationFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        -- freeType
        self.freeType = PKG_Slots_Client_KoiAnnunciationFreeRetType.Create(); r = self.freeType:Read(om)
        if r ~= 0 then return r end
        -- cells
        r, len = d:Rvu32()
        if len > d:GetLeft() then return -1 end
...
PKG_Slots_Client_KoiAnnunciationEnterResumed.__index = PKG_Slots_Client_KoiAnnunciationEnterResumed

--[[
发财树 请求免费类型
]]
PKG_Client_Slots_KoiAnnunciationFreeType = {
    typeName = "PKG_Client_Slots_KoiAnnunciationFreeType",
    typeId = 30705,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_KoiAnnunciationFreeType)
        end
        --[[
        押注类型
        ]]
...
PKG_Client_Slots_KoiAnnunciationFreeType.__index = PKG_Client_Slots_KoiAnnunciationFreeType

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_KoiAnnunciationNormalSpin = {
    typeName = "PKG_Client_Slots_KoiAnnunciationNormalSpin",
    typeId = 30704,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_KoiAnnunciationNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_KoiAnnunciationNormalSpin.__index = PKG_Client_Slots_KoiAnnunciationNormalSpin
...
PKG_KoiAnnunciation_Cell = {
    typeName = "PKG_KoiAnnunciation_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_KoiAnnunciation_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_KoiAnnunciation_Cell.__index = PKG_KoiAnnunciation_Cell

PKG_KoiAnnunciation_Line = {
    typeName = "PKG_KoiAnnunciation_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_KoiAnnunciation_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.KoiAnnunciation.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_KoiAnnunciation_Line.__index = PKG_KoiAnnunciation_Line
...
local o = ObjMgr
o.Register(PKG_KoiAnnunciation_NormalSpin)
o.Register(PKG_KoiAnnunciation_FreeType)
o.Register(PKG_KoiAnnunciation_FreeSpin)
o.Register(PKG_Slots_Client_KoiAnnunciationNormalRet)
o.Register(PKG_Slots_Client_KoiAnnunciationFreeRetType)
o.Register(PKG_Slots_Client_KoiAnnunciationFreeRet)
...
o.Register(PKG_Client_Slots_KoiAnnunciationFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_KoiAnnunciationEnterResumed)
o.Register(PKG_Client_Slots_KoiAnnunciationFreeType)
o.Register(PKG_Client_Slots_KoiAnnunciationNormalSpin)
