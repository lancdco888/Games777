...
require('g_net')
CodeGen_slot_466_md5 ="#*MD5<56f088d74d686a4f30e120a4ce9efbaf>*#"

--[[
狂野蛮牛-普通结果
]]
PKG_Slots_Client_PandaTreasureNormalRet = {
    typeName = "PKG_Slots_Client_PandaTreasureNormalRet",
    typeId = 46615,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_PandaTreasureNormalRet)
        end
        o.normalSpin = PKG_PandaTreasure_NormalSpin.Create() -- PKG.PandaTreasure.NormalSpin
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- normalSpin
        self.normalSpin = PKG_PandaTreasure_NormalSpin.Create(); r = self.normalSpin:Read(om)
...
PKG_Slots_Client_PandaTreasureNormalRet.__index = PKG_Slots_Client_PandaTreasureNormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_PandaTreasureFreeRetType = {
    typeName = "PKG_Slots_Client_PandaTreasureFreeRetType",
    typeId = 46616,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_PandaTreasureFreeRetType)
        end
        o.freeType = PKG_PandaTreasure_FreeType.Create() -- PKG.PandaTreasure.FreeType
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- freeType
        self.freeType = PKG_PandaTreasure_FreeType.Create(); r = self.freeType:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_PandaTreasureFreeRetType.__index = PKG_Slots_Client_PandaTreasureFreeRetType

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_PandaTreasureFreeRet = {
    typeName = "PKG_Slots_Client_PandaTreasureFreeRet",
    typeId = 46617,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_PandaTreasureFreeRet)
        end
        o.freeSpin = PKG_PandaTreasure_FreeSpin.Create() -- PKG.PandaTreasure.FreeSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- freeSpin
        self.freeSpin = PKG_PandaTreasure_FreeSpin.Create(); r = self.freeSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_PandaTreasureFreeRet.__index = PKG_Slots_Client_PandaTreasureFreeRet
...
PKG_Client_Slots_PandaTreasureFreeSpin = {
    typeName = "PKG_Client_Slots_PandaTreasureFreeSpin",
    typeId = 46614,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_PandaTreasureFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_PandaTreasureFreeSpin.__index = PKG_Client_Slots_PandaTreasureFreeSpin
...
PKG_Slots_Client_PandaTreasureEnterResumed = {
    typeName = "PKG_Slots_Client_PandaTreasureEnterResumed",
    typeId = 46618,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_PandaTreasureEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_PandaTreasureNormalRet.Create() -- PKG.Slots_Client.PandaTreasureNormalRet
        --[[
        恢复免费游戏类型
        ]]
        o.freeType = PKG_Slots_Client_PandaTreasureFreeRetType.Create() -- PKG.Slots_Client.PandaTreasureFreeRetType
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_PandaTreasureFreeRet.Create() -- PKG.Slots_Client.PandaTreasureFreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_PandaTreasureNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- freeType
        self.freeType = PKG_Slots_Client_PandaTreasureFreeRetType.Create(); r = self.freeType:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_PandaTreasureFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_PandaTreasureEnterResumed.__index = PKG_Slots_Client_PandaTreasureEnterResumed

--[[
发财树 请求免费类型
]]
PKG_Client_Slots_PandaTreasureFreeType = {
    typeName = "PKG_Client_Slots_PandaTreasureFreeType",
    typeId = 46613,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_PandaTreasureFreeType)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_PandaTreasureFreeType.__index = PKG_Client_Slots_PandaTreasureFreeType

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_PandaTreasureNormalSpin = {
    typeName = "PKG_Client_Slots_PandaTreasureNormalSpin",
    typeId = 46612,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_PandaTreasureNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_PandaTreasureNormalSpin.__index = PKG_Client_Slots_PandaTreasureNormalSpin
...
PKG_PandaTreasure_Cell = {
    typeName = "PKG_PandaTreasure_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_PandaTreasure_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_PandaTreasure_Cell.__index = PKG_PandaTreasure_Cell

PKG_PandaTreasure_Line = {
    typeName = "PKG_PandaTreasure_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_PandaTreasure_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.PandaTreasure.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        self.lineCells = o
        for i = 1, len do
            o[i] = PKG_PandaTreasure_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_PandaTreasure_Line.__index = PKG_PandaTreasure_Line
...
PKG_PandaTreasure_NormalSpin = {
    typeName = "PKG_PandaTreasure_NormalSpin",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_PandaTreasure_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.PandaTreasure.Cell>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
        ...
        o.lines = {} -- List<PKG.PandaTreasure.Line>
        --[[
        大奖锁定
        ]]
    ...
    Read = function(self, om)
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_PandaTreasure_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- lockStates
...
PKG_PandaTreasure_NormalSpin.__index = PKG_PandaTreasure_NormalSpin

PKG_PandaTreasure_FreeType = {
    typeName = "PKG_PandaTreasure_FreeType",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_PandaTreasure_FreeType)
        end
        --[[
        返回免费的次数
        ]]
        ...
        o.openlist = {} -- List<Int32>
        --[[
        顺序 剩下没有开的东西
        ]]
        o.ohterlist = {} -- List<Int32>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_PandaTreasure_FreeType.__index = PKG_PandaTreasure_FreeType

PKG_PandaTreasure_FreeSpin = {
    typeName = "PKG_PandaTreasure_FreeSpin",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_PandaTreasure_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_PandaTreasure_FreeSpin.__index = PKG_PandaTreasure_FreeSpin
...
local o = ObjMgr
o.Register(PKG_Slots_Client_PandaTreasureNormalRet)
o.Register(PKG_Slots_Client_PandaTreasureFreeRetType)
o.Register(PKG_Slots_Client_PandaTreasureFreeRet)
...
o.Register(PKG_Client_Slots_PandaTreasureFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_PandaTreasureEnterResumed)
o.Register(PKG_Client_Slots_PandaTreasureFreeType)
o.Register(PKG_Client_Slots_PandaTreasureNormalSpin)
