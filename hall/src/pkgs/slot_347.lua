...
require('g_net')
CodeGen_slot_347_md5 ="#*MD5<795c9e137c32619fc9e7fda84b0d11a2>*#"

--[[
狂野蛮牛-普通结果
]]
PKG_HappyLantern_NormalSpin = {
    typeName = "PKG_HappyLantern_NormalSpin",
    typeId = 34700,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_HappyLantern_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.HappyLantern.Cell>
        --[[
        freeType 普通 0 免费1 免费进灯笼 2 直接6灯笼进  就是3
        ]]
        o.freeType = 0 -- Int32
        --[[
        freetime 免费次数 普通 这盘就要知道免费次数
        ]]
        o.freetime = 0 -- Int32
        --[[
        是否进入特别游戏
        ...
        o.lines = {} -- List<PKG.HappyLantern.Line>
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_HappyLantern_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- freeType
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_HappyLantern_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- slotMoneyGift
...
PKG_HappyLantern_NormalSpin.__index = PKG_HappyLantern_NormalSpin

--[[
狂野蛮牛-普通结果
]]
PKG_HappyLantern_FreeSpin = {
    typeName = "PKG_HappyLantern_FreeSpin",
    typeId = 34701,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_HappyLantern_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_HappyLantern_FreeSpin.__index = PKG_HappyLantern_FreeSpin

--[[
狂野蛮牛-普通结果
]]
PKG_HappyLantern_SpecialSpin = {
    typeName = "PKG_HappyLantern_SpecialSpin",
    typeId = 34702,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_HappyLantern_SpecialSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_HappyLantern_SpecialSpin.__index = PKG_HappyLantern_SpecialSpin

--[[
狂野蛮牛-普通结果
]]
PKG_Slots_Client_HappyLanternNormalRet = {
    typeName = "PKG_Slots_Client_HappyLanternNormalRet",
    typeId = 34710,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_HappyLanternNormalRet)
        end
        o.normalSpin = PKG_HappyLantern_NormalSpin.Create() -- PKG.HappyLantern.NormalSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- normalSpin
        self.normalSpin = PKG_HappyLantern_NormalSpin.Create(); r = self.normalSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_HappyLanternNormalRet.__index = PKG_Slots_Client_HappyLanternNormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_HappyLanternFreeRet = {
    typeName = "PKG_Slots_Client_HappyLanternFreeRet",
    typeId = 34712,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_HappyLanternFreeRet)
        end
        o.freeSpin = PKG_HappyLantern_FreeSpin.Create() -- PKG.HappyLantern.FreeSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- freeSpin
        self.freeSpin = PKG_HappyLantern_FreeSpin.Create(); r = self.freeSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_HappyLanternFreeRet.__index = PKG_Slots_Client_HappyLanternFreeRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_HappyLanternSpecialRet = {
    typeName = "PKG_Slots_Client_HappyLanternSpecialRet",
    typeId = 34713,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_HappyLanternSpecialRet)
        end
        o.specialSpin = PKG_HappyLantern_SpecialSpin.Create() -- PKG.HappyLantern.SpecialSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- specialSpin
        self.specialSpin = PKG_HappyLantern_SpecialSpin.Create(); r = self.specialSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_HappyLanternSpecialRet.__index = PKG_Slots_Client_HappyLanternSpecialRet
...
PKG_Client_Slots_HappyLanternFreeSpin = {
    typeName = "PKG_Client_Slots_HappyLanternFreeSpin",
    typeId = 34722,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_HappyLanternFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_HappyLanternFreeSpin.__index = PKG_Client_Slots_HappyLanternFreeSpin
...
PKG_Slots_Client_HappyLanternFreeTypeRet = {
    typeName = "PKG_Slots_Client_HappyLanternFreeTypeRet",
    typeId = 34711,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_HappyLanternFreeTypeRet)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Slots_Client_HappyLanternFreeTypeRet.__index = PKG_Slots_Client_HappyLanternFreeTypeRet

--[[
狂野蛮牛 -断线重连数据恢复
]]
PKG_Slots_Client_HappyLanternEnterResumed = {
    typeName = "PKG_Slots_Client_HappyLanternEnterResumed",
    typeId = 34714,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_HappyLanternEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_HappyLanternNormalRet.Create() -- PKG.Slots_Client.HappyLanternNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_HappyLanternFreeRet.Create() -- PKG.Slots_Client.HappyLanternFreeRet
        --[[
        恢复特殊游戏结果
        ]]
        o.resumedSpecial = PKG_Slots_Client_HappyLanternSpecialRet.Create() -- PKG.Slots_Client.HappyLanternSpecialRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_HappyLanternNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_HappyLanternFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        -- resumedSpecial
        self.resumedSpecial = PKG_Slots_Client_HappyLanternSpecialRet.Create(); r = self.resumedSpecial:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_HappyLanternEnterResumed.__index = PKG_Slots_Client_HappyLanternEnterResumed

--[[
财富之眼 请求免费类型
]]
PKG_Client_Slots_HappyLanternFreeType = {
    typeName = "PKG_Client_Slots_HappyLanternFreeType",
    typeId = 34721,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_HappyLanternFreeType)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_HappyLanternFreeType.__index = PKG_Client_Slots_HappyLanternFreeType

--[[
财富之眼  普通旋转
]]
PKG_Client_Slots_HappyLanternNormalSpin = {
    typeName = "PKG_Client_Slots_HappyLanternNormalSpin",
    typeId = 34720,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_HappyLanternNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_HappyLanternNormalSpin.__index = PKG_Client_Slots_HappyLanternNormalSpin

--[[
财富之眼 请求特殊旋转图形
]]
PKG_Client_Slots_HappyLanternSpecialSpin = {
    typeName = "PKG_Client_Slots_HappyLanternSpecialSpin",
    typeId = 34723,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_HappyLanternSpecialSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_HappyLanternSpecialSpin.__index = PKG_Client_Slots_HappyLanternSpecialSpin
...
PKG_HappyLantern_Cell = {
    typeName = "PKG_HappyLantern_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_HappyLantern_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_HappyLantern_Cell.__index = PKG_HappyLantern_Cell

PKG_HappyLantern_Line = {
    typeName = "PKG_HappyLantern_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_HappyLantern_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.HappyLantern.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_HappyLantern_Line.__index = PKG_HappyLantern_Line
...
local o = ObjMgr
o.Register(PKG_HappyLantern_NormalSpin)
o.Register(PKG_HappyLantern_FreeSpin)
o.Register(PKG_HappyLantern_SpecialSpin)
o.Register(PKG_Slots_Client_HappyLanternNormalRet)
o.Register(PKG_Slots_Client_HappyLanternFreeRet)
o.Register(PKG_Slots_Client_HappyLanternSpecialRet)
...
o.Register(PKG_Client_Slots_HappyLanternFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_HappyLanternFreeTypeRet)
o.Register(PKG_Slots_Client_HappyLanternEnterResumed)
o.Register(PKG_Client_Slots_HappyLanternFreeType)
o.Register(PKG_Client_Slots_HappyLanternNormalSpin)
o.Register(PKG_Client_Slots_HappyLanternSpecialSpin)