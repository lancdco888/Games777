...
CodeGen_slot_208_md5 ="#*MD5<b636bc34da1112f0aa66dffbd975bd60>*#"

PKG_LuckyDiamond_LuckyDiamondSymbol = {
    LuckyDiamondWild = 1,
    LuckyDiamondCherry = 2,
    LuckyDiamondOrange = 3,
    LuckyDiamondGrape = 4,
    LuckyDiamondWatermelon = 5,
    LuckyDiamondBell = 6,
    LuckyDiamondBar1 = 7,
    LuckyDiamondBar2 = 8,
    LuckyDiamondBar3 = 9,
...
PKG_LuckyDiamond_LuckyDiamondBase = {
    typeName = "PKG_LuckyDiamond_LuckyDiamondBase",
    typeId = 30381,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_LuckyDiamond_LuckyDiamondBase)
        end
        --[[
        总押注(一次旋转 免费游戏为0)
        ]]
        ...
        o.grids = {} -- List<PKG.LuckyDiamond.Cell>
        return o
    end,
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_LuckyDiamond_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_LuckyDiamond_LuckyDiamondBase.__index = PKG_LuckyDiamond_LuckyDiamondBase
...
PKG_Slots_Client_LuckyDiamondSpinNormalRet = {
    typeName = "PKG_Slots_Client_LuckyDiamondSpinNormalRet", -- : PKG_LuckyDiamond_LuckyDiamondBase
    typeId = 30384,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_LuckyDiamondSpinNormalRet)
        end
        PKG_LuckyDiamond_LuckyDiamondBase.Create(o)
        --[[
        免费游戏
        ]]
        o.FreeLine = null -- Nullable<PKG.LuckyDiamond.Line>
        --[[
        lightning resipn
        ]]
        o.lines = {} -- List<PKG.LuckyDiamond.Line>
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_LuckyDiamond_LuckyDiamondBase.Read(self, om)
        if r ~= 0 then return r end
        -- FreeLine
        r, n = d:Ru8(); if r ~= 0 then return r end; if n == 0 then self.FreeLine = null else self.FreeLine = PKG_LuckyDiamond_Line.Create(); r = self.FreeLine:Read(om) end
        if r ~= 0 then return r end
        -- lines
        r, len = d:Rvu32()
        if len > d:GetLeft() then return -1 end
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_LuckyDiamond_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_LuckyDiamond_LuckyDiamondBase.Write(self, om)
        -- FreeLine
        if self.FreeLine == null then d:Wu8(0) else d:Wu8(1); self.FreeLine:Write(om) end
        -- lines
        o = self.lines
        len = #o
        d:Wvu32(len)
...
PKG_Slots_Client_LuckyDiamondSpinNormalRet.__index = PKG_Slots_Client_LuckyDiamondSpinNormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_LuckyDiamondFreeRet = {
    typeName = "PKG_Slots_Client_LuckyDiamondFreeRet", -- : PKG_LuckyDiamond_LuckyDiamondBase
    typeId = 30385,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_LuckyDiamondFreeRet)
        end
        PKG_LuckyDiamond_LuckyDiamondBase.Create(o)
        --[[
...
PKG_Slots_Client_LuckyDiamondFreeRet.__index = PKG_Slots_Client_LuckyDiamondFreeRet
...
PKG_Client_Slots_LuckyDiamondNormalSpin = {
    typeName = "PKG_Client_Slots_LuckyDiamondNormalSpin",
    typeId = 30382,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_LuckyDiamondNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_LuckyDiamondNormalSpin.__index = PKG_Client_Slots_LuckyDiamondNormalSpin
...
PKG_Slots_Client_LuckyDiamondEnterResumed = {
    typeName = "PKG_Slots_Client_LuckyDiamondEnterResumed",
    typeId = 30386,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_LuckyDiamondEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = null -- Nullable<PKG.Slots_Client.LuckyDiamondSpinNormalRet>
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = null -- Nullable<PKG.Slots_Client.LuckyDiamondFreeRet>
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        r, n = d:Ru8(); if r ~= 0 then return r end; if n == 0 then self.resumedNormal = null else self.resumedNormal = PKG_Slots_Client_LuckyDiamondSpinNormalRet.Create(); r = self.resumedNormal:Read(om) end
        if r ~= 0 then return r end
        -- resumedFree
        r, n = d:Ru8(); if r ~= 0 then return r end; if n == 0 then self.resumedFree = null else self.resumedFree = PKG_Slots_Client_LuckyDiamondFreeRet.Create(); r = self.resumedFree:Read(om) end
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_LuckyDiamondEnterResumed.__index = PKG_Slots_Client_LuckyDiamondEnterResumed

--[[
Sugar请求特殊旋转图形
]]
PKG_Client_Slots_LuckyDiamondFreeSpin = {
    typeName = "PKG_Client_Slots_LuckyDiamondFreeSpin",
    typeId = 30383,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_LuckyDiamondFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_LuckyDiamondFreeSpin.__index = PKG_Client_Slots_LuckyDiamondFreeSpin
...
PKG_LuckyDiamond_Cell = {
    typeName = "PKG_LuckyDiamond_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_LuckyDiamond_Cell)
        end
        --[[
        点对应下标
        ]]
        ...
        o.icon = 0 -- PKG.LuckyDiamond.LuckyDiamondSymbol
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_LuckyDiamond_Cell.__index = PKG_LuckyDiamond_Cell
...
PKG_LuckyDiamond_Line = {
    typeName = "PKG_LuckyDiamond_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_LuckyDiamond_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.LuckyDiamond.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_LuckyDiamond_Line.__index = PKG_LuckyDiamond_Line
...
local o = ObjMgr
o.Register(PKG_LuckyDiamond_LuckyDiamondBase)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_LuckyDiamondSpinNormalRet)
o.Register(PKG_Slots_Client_LuckyDiamondFreeRet)
o.Register(PKG_Slots_Client_OfflineCheck)
o.Register(PKG_Slots_Client_Leave_Success)
o.Register(PKG_Client_Slots_LuckyDiamondNormalSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_LuckyDiamondEnterResumed)
o.Register(PKG_Client_Slots_LuckyDiamondFreeSpin)
