...
require('g_net')
CodeGen_slot_437_md5 ="#*MD5<bf72ed4c73e92891d874b08a53d47f6b>*#"

--[[
Sugar请求免费旋转图形
]]
PKG_TheKing_FreeSpin = {
    typeName = "PKG_TheKing_FreeSpin",
    typeId = 43702,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_TheKing_FreeSpin)
        end
        o.betMoney = 0 -- Int64
        ...
        o.grids = {} -- List<PKG.TheKing.Cell>
        o.lines = {} -- List<PKG.TheKing.Line>
        o.curWinCoin = 0 -- Int64
        o.emitSpecialEvent = 0 -- Int32
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_TheKing_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- lines
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_TheKing_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- curWinCoin
        ...
        if r ~= 0 then return r end
        -- emitSpecialEvent
        r, self.emitSpecialEvent = d:Rvi32()
        if r ~= 0 then return r end
        -- freeGameTotalCount
...
PKG_TheKing_FreeSpin.__index = PKG_TheKing_FreeSpin

--[[
Sugar请求特殊旋转图形
]]
PKG_TheKing_NormalSpin = {
    typeName = "PKG_TheKing_NormalSpin",
    typeId = 43701,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_TheKing_NormalSpin)
        end
        o.betMoney = 0 -- Int64
        o.grids = {} -- List<PKG.TheKing.Cell>
        o.lines = {} -- List<PKG.TheKing.Line>
...
PKG_TheKing_NormalSpin.__index = PKG_TheKing_NormalSpin

--[[
免费选择
]]
PKG_TheKing_SelectType = {
    typeName = "PKG_TheKing_SelectType",
    typeId = 43703,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_TheKing_SelectType)
        end
        o.type = 0 -- Int32
        o.times = 0 -- Int32
        o.money = 0 -- Int32
...
PKG_TheKing_SelectType.__index = PKG_TheKing_SelectType

--[[
Sugar请求免费旋转图形
]]
PKG_TheKing_SpecialSpin = {
    typeName = "PKG_TheKing_SpecialSpin",
    typeId = 43704,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_TheKing_SpecialSpin)
        end
        o.betMoney = 0 -- Int64
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
...
PKG_TheKing_SpecialSpin.__index = PKG_TheKing_SpecialSpin

--[[
普通结果
]]
PKG_Slots_Client_TheKingNormalRet = {
    typeName = "PKG_Slots_Client_TheKingNormalRet",
    typeId = 43720,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_TheKingNormalRet)
        end
        o.normalSpin = PKG_TheKing_NormalSpin.Create() -- PKG.TheKing.NormalSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- normalSpin
        self.normalSpin = PKG_TheKing_NormalSpin.Create(); r = self.normalSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_TheKingNormalRet.__index = PKG_Slots_Client_TheKingNormalRet

--[[
免费结果
]]
PKG_Slots_Client_TheKingFreeRet = {
    typeName = "PKG_Slots_Client_TheKingFreeRet",
    typeId = 43721,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_TheKingFreeRet)
        end
        o.freeSpin = PKG_TheKing_FreeSpin.Create() -- PKG.TheKing.FreeSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- freeSpin
        self.freeSpin = PKG_TheKing_FreeSpin.Create(); r = self.freeSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_TheKingFreeRet.__index = PKG_Slots_Client_TheKingFreeRet

--[[
特殊结果
]]
PKG_Slots_Client_TheKingSpecialRet = {
    typeName = "PKG_Slots_Client_TheKingSpecialRet",
    typeId = 43722,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_TheKingSpecialRet)
        end
        o.specialSpin = PKG_TheKing_SpecialSpin.Create() -- PKG.TheKing.SpecialSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- specialSpin
        self.specialSpin = PKG_TheKing_SpecialSpin.Create(); r = self.specialSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_TheKingSpecialRet.__index = PKG_Slots_Client_TheKingSpecialRet

--[[
免费类型
]]
PKG_Slots_Client_TheKingSelectRet = {
    typeName = "PKG_Slots_Client_TheKingSelectRet",
    typeId = 43723,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_TheKingSelectRet)
        end
        o.freeType = PKG_TheKing_SelectType.Create() -- PKG.TheKing.SelectType
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- freeType
        self.freeType = PKG_TheKing_SelectType.Create(); r = self.freeType:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_TheKingSelectRet.__index = PKG_Slots_Client_TheKingSelectRet
...
PKG_Client_Slots_TheKingFreeType = {
    typeName = "PKG_Client_Slots_TheKingFreeType",
    typeId = 43713,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_TheKingFreeType)
        end
        o.type = 0 -- Int32
        return o
    end,
...
PKG_Client_Slots_TheKingFreeType.__index = PKG_Client_Slots_TheKingFreeType
...
PKG_Slots_Client_TheKingEnterResumed = {
    typeName = "PKG_Slots_Client_TheKingEnterResumed",
    typeId = 43724,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_TheKingEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.lvID = 0 -- Int32
        o.resumedNormal = PKG_Slots_Client_TheKingNormalRet.Create() -- PKG.Slots_Client.TheKingNormalRet
        o.resumedFree = PKG_Slots_Client_TheKingFreeRet.Create() -- PKG.Slots_Client.TheKingFreeRet
        o.resumedSpecial = PKG_Slots_Client_TheKingSpecialRet.Create() -- PKG.Slots_Client.TheKingSpecialRet
        o.resumedSelect = PKG_Slots_Client_TheKingSelectRet.Create() -- PKG.Slots_Client.TheKingSelectRet
    ...
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_TheKingNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_TheKingFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        -- resumedSpecial
        self.resumedSpecial = PKG_Slots_Client_TheKingSpecialRet.Create(); r = self.resumedSpecial:Read(om)
        if r ~= 0 then return r end
        -- resumedSelect
        self.resumedSelect = PKG_Slots_Client_TheKingSelectRet.Create(); r = self.resumedSelect:Read(om)
        if r ~= 0 then return r end
        -- lastMsgType
...
PKG_Slots_Client_TheKingEnterResumed.__index = PKG_Slots_Client_TheKingEnterResumed

--[[
特殊旋转
]]
PKG_Client_Slots_TheKingSpecialSpin = {
    typeName = "PKG_Client_Slots_TheKingSpecialSpin",
    typeId = 43712,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_TheKingSpecialSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_TheKingSpecialSpin.__index = PKG_Client_Slots_TheKingSpecialSpin

--[[
免费旋转
]]
PKG_Client_Slots_TheKingFreeSpin = {
    typeName = "PKG_Client_Slots_TheKingFreeSpin",
    typeId = 43711,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_TheKingFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_TheKingFreeSpin.__index = PKG_Client_Slots_TheKingFreeSpin

--[[
普通旋转
]]
PKG_Client_Slots_TheKingNormalSpin = {
    typeName = "PKG_Client_Slots_TheKingNormalSpin",
    typeId = 43710,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_TheKingNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_TheKingNormalSpin.__index = PKG_Client_Slots_TheKingNormalSpin
...
PKG_TheKing_Cell = {
    typeName = "PKG_TheKing_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_TheKing_Cell)
        end
        --[[
        点对应下标
        ]]
    ...
    Write = function(self, om)
        ...
        -- lottyValue
        d:Wvi32(self.lottyValue)
    end
}
PKG_TheKing_Cell.__index = PKG_TheKing_Cell

PKG_TheKing_Line = {
    typeName = "PKG_TheKing_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_TheKing_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.TheKing.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_TheKing_Line.__index = PKG_TheKing_Line
...
local o = ObjMgr
o.Register(PKG_TheKing_FreeSpin)
o.Register(PKG_TheKing_NormalSpin)
o.Register(PKG_TheKing_SelectType)
o.Register(PKG_TheKing_SpecialSpin)
o.Register(PKG_Slots_Client_TheKingNormalRet)
o.Register(PKG_Slots_Client_TheKingFreeRet)
o.Register(PKG_Slots_Client_TheKingSpecialRet)
o.Register(PKG_Slots_Client_TheKingSelectRet)
...
o.Register(PKG_Client_Slots_TheKingFreeType)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_TheKingEnterResumed)
o.Register(PKG_Client_Slots_TheKingSpecialSpin)
o.Register(PKG_Client_Slots_TheKingFreeSpin)
o.Register(PKG_Client_Slots_TheKingNormalSpin)
