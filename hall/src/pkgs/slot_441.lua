...
require('g_net')
CodeGen_slot_441_md5 ="#*MD5<7f94bc8ca6d9abafc1eb72e9c150db23>*#"

PKG_WesternCash_NormalSpin = {
    typeName = "PKG_WesternCash_NormalSpin",
    typeId = 44100,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_WesternCash_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.WesternCash.Cell>
        --[[
        (符合连线规则)
        ]]
        o.lines = {} -- List<PKG.WesternCash.Line>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_WesternCash_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- lines
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_WesternCash_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
...
PKG_WesternCash_NormalSpin.__index = PKG_WesternCash_NormalSpin

PKG_WesternCash_FreeSpin = {
    typeName = "PKG_WesternCash_FreeSpin",
    typeId = 44101,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_WesternCash_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_WesternCash_FreeSpin.__index = PKG_WesternCash_FreeSpin

PKG_WesternCash_SpecSpin = {
    typeName = "PKG_WesternCash_SpecSpin",
    typeId = 44102,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_WesternCash_SpecSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_WesternCash_SpecSpin.__index = PKG_WesternCash_SpecSpin

--[[
转盘旋转
]]
PKG_Slots_Client_WesternCashSpecRet = {
    typeName = "PKG_Slots_Client_WesternCashSpecRet",
    typeId = 44112,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_WesternCashSpecRet)
        end
        o.specSpin = PKG_WesternCash_SpecSpin.Create() -- PKG.WesternCash.SpecSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- specSpin
        self.specSpin = PKG_WesternCash_SpecSpin.Create(); r = self.specSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_WesternCashSpecRet.__index = PKG_Slots_Client_WesternCashSpecRet

--[[
免费旋转
]]
PKG_Slots_Client_WesternCashFreeRet = {
    typeName = "PKG_Slots_Client_WesternCashFreeRet",
    typeId = 44111,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_WesternCashFreeRet)
        end
        o.freeSpin = PKG_WesternCash_FreeSpin.Create() -- PKG.WesternCash.FreeSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- freeSpin
        self.freeSpin = PKG_WesternCash_FreeSpin.Create(); r = self.freeSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_WesternCashFreeRet.__index = PKG_Slots_Client_WesternCashFreeRet

--[[
普通旋转
]]
PKG_Slots_Client_WesternCashNormalRet = {
    typeName = "PKG_Slots_Client_WesternCashNormalRet",
    typeId = 44110,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_WesternCashNormalRet)
        end
        o.normalSpin = PKG_WesternCash_NormalSpin.Create() -- PKG.WesternCash.NormalSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- normalSpin
        self.normalSpin = PKG_WesternCash_NormalSpin.Create(); r = self.normalSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_WesternCashNormalRet.__index = PKG_Slots_Client_WesternCashNormalRet
...
PKG_Slots_Client_WesternCashEnterResumed = {
    typeName = "PKG_Slots_Client_WesternCashEnterResumed",
    typeId = 44113,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_WesternCashEnterResumed)
        end
        --[[
        押注等级
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_WesternCashNormalRet.Create() -- PKG.Slots_Client.WesternCashNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_WesternCashFreeRet.Create() -- PKG.Slots_Client.WesternCashFreeRet
        --[[
        恢复落地牌游戏结果
        ]]
        o.resumedSpec = PKG_Slots_Client_WesternCashSpecRet.Create() -- PKG.Slots_Client.WesternCashSpecRet
        o.status = 0 -- Int32
        --[[
        游戏彩金已开的数组
        ]]
    ...
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_WesternCashNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_WesternCashFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        -- resumedSpec
        self.resumedSpec = PKG_Slots_Client_WesternCashSpecRet.Create(); r = self.resumedSpec:Read(om)
        if r ~= 0 then return r end
        -- status
...
PKG_Slots_Client_WesternCashEnterResumed.__index = PKG_Slots_Client_WesternCashEnterResumed
...
PKG_Client_Slots_WesternCashSpecSpin = {
    typeName = "PKG_Client_Slots_WesternCashSpecSpin",
    typeId = 44122,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_WesternCashSpecSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_WesternCashSpecSpin.__index = PKG_Client_Slots_WesternCashSpecSpin

--[[
请求免费旋转图形
]]
PKG_Client_Slots_WesternCashFreeSpin = {
    typeName = "PKG_Client_Slots_WesternCashFreeSpin",
    typeId = 44121,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_WesternCashFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_WesternCashFreeSpin.__index = PKG_Client_Slots_WesternCashFreeSpin

--[[
请求获取生成图形
]]
PKG_Client_Slots_WesternCashNormalSpin = {
    typeName = "PKG_Client_Slots_WesternCashNormalSpin",
    typeId = 44120,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_WesternCashNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_WesternCashNormalSpin.__index = PKG_Client_Slots_WesternCashNormalSpin
...
PKG_WesternCash_Cell = {
    typeName = "PKG_WesternCash_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_WesternCash_Cell)
        end
        --[[
        点对应下标
        ]]
        ...
        o.icon = 0 -- Int32
        --[[
        Normal = 1, Mini = 2, Minor = 3, Major = 4, Grand = 5, Burst = 0
        ]]
        o.spType = 0 -- Int32
        --[[
        落地牌金额
...
PKG_WesternCash_Cell.__index = PKG_WesternCash_Cell

PKG_WesternCash_Line = {
    typeName = "PKG_WesternCash_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_WesternCash_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.WesternCash.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_WesternCash_Line.__index = PKG_WesternCash_Line
...
local o = ObjMgr
o.Register(PKG_WesternCash_NormalSpin)
o.Register(PKG_WesternCash_FreeSpin)
o.Register(PKG_WesternCash_SpecSpin)
o.Register(PKG_Slots_Client_WesternCashSpecRet)
o.Register(PKG_Slots_Client_WesternCashFreeRet)
o.Register(PKG_Slots_Client_WesternCashNormalRet)
...
o.Register(PKG_Slots_Client_WesternCashEnterResumed)
...
o.Register(PKG_Client_Slots_WesternCashSpecSpin)
o.Register(PKG_Client_Slots_WesternCashFreeSpin)
o.Register(PKG_Client_Slots_WesternCashNormalSpin)
