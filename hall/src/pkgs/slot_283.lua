...
CodeGen_slot_283_md5 ="#*MD5<63363714c717860bfd2d8297568a0b29>*#"

--[[
Sugar请求特殊旋转图形
]]
PKG_LionTreasure_NormalSpin = {
    typeName = "PKG_LionTreasure_NormalSpin",
    typeId = 30721,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_LionTreasure_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.LionTreasure.Cell>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
        ...
        o.intoSpecialType = 0 -- Int32
        --[[
        (符合连线规则)
        ]]
        o.lines = {} -- List<PKG.LionTreasure.Line>
        return o
    end,
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_LionTreasure_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
        ...
        if r ~= 0 then return r end
        -- intoSpecialType
        r, self.intoSpecialType = d:Rvi32()
        if r ~= 0 then return r end
        -- lines
        r, len = d:Rvu32()
        if len > d:GetLeft() then return -1 end
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_LionTreasure_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_LionTreasure_NormalSpin.__index = PKG_LionTreasure_NormalSpin

--[[
Sugar请求免费旋转图形
]]
PKG_LionTreasure_FreeSpin = {
    typeName = "PKG_LionTreasure_FreeSpin",
    typeId = 30722,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_LionTreasure_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_LionTreasure_FreeSpin.__index = PKG_LionTreasure_FreeSpin

--[[
Sugar请求免费旋转图形
]]
PKG_LionTreasure_SpecialSpin = {
    typeName = "PKG_LionTreasure_SpecialSpin",
    typeId = 30723,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_LionTreasure_SpecialSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.bonusWinCoin = 0 -- Double
        --[[
        免费中彩金 且最后一轮是彩金 AllWinCoin 是带免费的总赢钱
        ]]
        o.AllWinCoin = 0 -- Double
        --[[
        狮子口中 可能突出了的一点渣渣
        ]]
        o.addgrids = {} -- List<PKG.LionTreasure.Cell>
        --[[
        总次数
        ]]
        o.allCount = 0 -- Int32
...
PKG_LionTreasure_SpecialSpin.__index = PKG_LionTreasure_SpecialSpin

--[[
财神赐宝-普通结果
]]
PKG_Slots_Client_LionTreasureNormalRet = {
    typeName = "PKG_Slots_Client_LionTreasureNormalRet", -- : PKG_LionTreasure_NormalSpin
    typeId = 30727,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_LionTreasureNormalRet)
        end
        PKG_LionTreasure_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_LionTreasure_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_LionTreasure_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_LionTreasureNormalRet.__index = PKG_Slots_Client_LionTreasureNormalRet

--[[
财神赐宝 免费游戏结果
]]
PKG_Slots_Client_LionTreasureFreeRet = {
    typeName = "PKG_Slots_Client_LionTreasureFreeRet", -- : PKG_LionTreasure_FreeSpin
    typeId = 30728,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_LionTreasureFreeRet)
        end
        PKG_LionTreasure_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_LionTreasure_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_LionTreasure_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_LionTreasureFreeRet.__index = PKG_Slots_Client_LionTreasureFreeRet

--[[
财神赐宝 免费游戏结果
]]
PKG_Slots_Client_LionTreasureSpecialRet = {
    typeName = "PKG_Slots_Client_LionTreasureSpecialRet", -- : PKG_LionTreasure_SpecialSpin
    typeId = 30729,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_LionTreasureSpecialRet)
        end
        PKG_LionTreasure_SpecialSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_LionTreasure_SpecialSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_LionTreasure_SpecialSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_LionTreasureSpecialRet.__index = PKG_Slots_Client_LionTreasureSpecialRet
...
PKG_Client_Slots_LionTreasureSpecialSpin = {
    typeName = "PKG_Client_Slots_LionTreasureSpecialSpin",
    typeId = 30726,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_LionTreasureSpecialSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_LionTreasureSpecialSpin.__index = PKG_Client_Slots_LionTreasureSpecialSpin
...
PKG_Slots_Client_LionTreasureEnterResumed = {
    typeName = "PKG_Slots_Client_LionTreasureEnterResumed",
    typeId = 30730,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_LionTreasureEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_LionTreasureNormalRet.Create() -- PKG.Slots_Client.LionTreasureNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_LionTreasureFreeRet.Create() -- PKG.Slots_Client.LionTreasureFreeRet
        --[[
        恢复灯笼类型结果
        ]]
        o.resumedSpecial = PKG_Slots_Client_LionTreasureSpecialRet.Create() -- PKG.Slots_Client.LionTreasureSpecialRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_LionTreasureNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_LionTreasureFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        -- resumedSpecial
        self.resumedSpecial = PKG_Slots_Client_LionTreasureSpecialRet.Create(); r = self.resumedSpecial:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_LionTreasureEnterResumed.__index = PKG_Slots_Client_LionTreasureEnterResumed

--[[
女侠 龙腾虎啸 请求免费类型
]]
PKG_Client_Slots_LionTreasureFreeSpin = {
    typeName = "PKG_Client_Slots_LionTreasureFreeSpin",
    typeId = 30725,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_LionTreasureFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_LionTreasureFreeSpin.__index = PKG_Client_Slots_LionTreasureFreeSpin

--[[
女侠 龙腾虎啸  普通旋转
]]
PKG_Client_Slots_LionTreasureNormalSpin = {
    typeName = "PKG_Client_Slots_LionTreasureNormalSpin",
    typeId = 30724,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_LionTreasureNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_LionTreasureNormalSpin.__index = PKG_Client_Slots_LionTreasureNormalSpin
...
PKG_LionTreasure_Cell = {
    typeName = "PKG_LionTreasure_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_LionTreasure_Cell)
        end
        --[[
        点对应下标
        ]]
    ...
    Write = function(self, om)
        ...
        -- SymbolColor
        d:Wvi32(self.SymbolColor)
    end
}
PKG_LionTreasure_Cell.__index = PKG_LionTreasure_Cell

PKG_LionTreasure_Line = {
    typeName = "PKG_LionTreasure_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_LionTreasure_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.LionTreasure.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_LionTreasure_Line.__index = PKG_LionTreasure_Line
...
local o = ObjMgr
o.Register(PKG_LionTreasure_NormalSpin)
o.Register(PKG_LionTreasure_FreeSpin)
o.Register(PKG_LionTreasure_SpecialSpin)
o.Register(PKG_Slots_Client_LionTreasureNormalRet)
o.Register(PKG_Slots_Client_LionTreasureFreeRet)
o.Register(PKG_Slots_Client_LionTreasureSpecialRet)
...
o.Register(PKG_Client_Slots_LionTreasureSpecialSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_LionTreasureEnterResumed)
o.Register(PKG_Client_Slots_LionTreasureFreeSpin)
o.Register(PKG_Client_Slots_LionTreasureNormalSpin)
