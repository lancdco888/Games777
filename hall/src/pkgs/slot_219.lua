...
CodeGen_slot_219_md5 ="#*MD5<55d69dc1e08967ecea2483721f651d56>*#"

PKG_EgyptianFantasy_EgyptianFantasySymbol = {
...
PKG_EgyptianFantasy_NormalSpin = {
    typeName = "PKG_EgyptianFantasy_NormalSpin",
    typeId = 30301,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_EgyptianFantasy_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.EgyptianFantasy.Cell>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
        ...
        o.lines = {} -- List<PKG.EgyptianFantasy.Line>
        --[[
        是否进入收集游戏
        ]]
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_EgyptianFantasy_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_EgyptianFantasy_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoCollect
...
PKG_EgyptianFantasy_NormalSpin.__index = PKG_EgyptianFantasy_NormalSpin

--[[
Sugar请求特殊旋转图形
]]
PKG_EgyptianFantasy_FreeSpin = {
    typeName = "PKG_EgyptianFantasy_FreeSpin",
    typeId = 30302,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_EgyptianFantasy_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_EgyptianFantasy_FreeSpin.__index = PKG_EgyptianFantasy_FreeSpin

--[[
狂野蛮牛-普通结果
]]
PKG_Slots_Client_EgyptianFantasyNormalRet = {
    typeName = "PKG_Slots_Client_EgyptianFantasyNormalRet", -- : PKG_EgyptianFantasy_NormalSpin
    typeId = 30305,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_EgyptianFantasyNormalRet)
        end
        PKG_EgyptianFantasy_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_EgyptianFantasy_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_EgyptianFantasy_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_EgyptianFantasyNormalRet.__index = PKG_Slots_Client_EgyptianFantasyNormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_EgyptianFantasyFreeRet = {
    typeName = "PKG_Slots_Client_EgyptianFantasyFreeRet", -- : PKG_EgyptianFantasy_FreeSpin
    typeId = 30306,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_EgyptianFantasyFreeRet)
        end
        PKG_EgyptianFantasy_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_EgyptianFantasy_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_EgyptianFantasy_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_EgyptianFantasyFreeRet.__index = PKG_Slots_Client_EgyptianFantasyFreeRet
...
PKG_Client_Slots_EgyptianFantasyFreeSpin = {
    typeName = "PKG_Client_Slots_EgyptianFantasyFreeSpin",
    typeId = 30304,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_EgyptianFantasyFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_EgyptianFantasyFreeSpin.__index = PKG_Client_Slots_EgyptianFantasyFreeSpin
...
PKG_Slots_Client_EgyptianFantasyEnterResumed = {
    typeName = "PKG_Slots_Client_EgyptianFantasyEnterResumed",
    typeId = 30307,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_EgyptianFantasyEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_EgyptianFantasyNormalRet.Create() -- PKG.Slots_Client.EgyptianFantasyNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFreeRet = PKG_Slots_Client_EgyptianFantasyFreeRet.Create() -- PKG.Slots_Client.EgyptianFantasyFreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_EgyptianFantasyNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeRet
        self.resumedFreeRet = PKG_Slots_Client_EgyptianFantasyFreeRet.Create(); r = self.resumedFreeRet:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_EgyptianFantasyEnterResumed.__index = PKG_Slots_Client_EgyptianFantasyEnterResumed

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_EgyptianFantasyNormalSpin = {
    typeName = "PKG_Client_Slots_EgyptianFantasyNormalSpin",
    typeId = 30303,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_EgyptianFantasyNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_EgyptianFantasyNormalSpin.__index = PKG_Client_Slots_EgyptianFantasyNormalSpin
...
PKG_EgyptianFantasy_Cell = {
    typeName = "PKG_EgyptianFantasy_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_EgyptianFantasy_Cell)
        end
        --[[
        点对应下标
        ]]
        ...
        o.icon = 0 -- PKG.EgyptianFantasy.EgyptianFantasySymbol
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_EgyptianFantasy_Cell.__index = PKG_EgyptianFantasy_Cell

PKG_EgyptianFantasy_Line = {
    typeName = "PKG_EgyptianFantasy_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_EgyptianFantasy_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.EgyptianFantasy.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_EgyptianFantasy_Line.__index = PKG_EgyptianFantasy_Line
...
local o = ObjMgr
o.Register(PKG_EgyptianFantasy_NormalSpin)
o.Register(PKG_EgyptianFantasy_FreeSpin)
o.Register(PKG_Slots_Client_EgyptianFantasyNormalRet)
o.Register(PKG_Slots_Client_EgyptianFantasyFreeRet)
...
o.Register(PKG_Client_Slots_EgyptianFantasyFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_EgyptianFantasyEnterResumed)
o.Register(PKG_Client_Slots_EgyptianFantasyNormalSpin)
