...
CodeGen_slot_251_md5 ="#*MD5<2117b5df89ccbb474b470ddcbeada131>*#"

--[[
生成图形数组和相关结果的基类
]]
PKG_Fortune5lian_NormalSpin = {
    typeName = "PKG_Fortune5lian_NormalSpin",
    typeId = 30511,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Fortune5lian_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.Fortune5lian.Cell>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
        ...
        o.lines = {} -- List<PKG.Fortune5lian.Line>
        --[[
        是否进入收集游戏
        ]]
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_Fortune5lian_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_Fortune5lian_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoCollect
...
PKG_Fortune5lian_NormalSpin.__index = PKG_Fortune5lian_NormalSpin

--[[
生成图形数组和相关结果的基类
]]
PKG_Fortune5lian_FreeSpin = {
    typeName = "PKG_Fortune5lian_FreeSpin",
    typeId = 30512,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Fortune5lian_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_Fortune5lian_FreeSpin.__index = PKG_Fortune5lian_FreeSpin
...
PKG_Slots_Client_Fortune5lianNormalRet = {
    typeName = "PKG_Slots_Client_Fortune5lianNormalRet", -- : PKG_Fortune5lian_NormalSpin
    typeId = 30515,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_Fortune5lianNormalRet)
        end
        PKG_Fortune5lian_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_Fortune5lian_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_Fortune5lian_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_Fortune5lianNormalRet.__index = PKG_Slots_Client_Fortune5lianNormalRet

--[[
Sugar-彩虹触发的免费游戏结果
]]
PKG_Slots_Client_Fortune5lianFreeRet = {
    typeName = "PKG_Slots_Client_Fortune5lianFreeRet", -- : PKG_Fortune5lian_FreeSpin
    typeId = 30516,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_Fortune5lianFreeRet)
        end
        PKG_Fortune5lian_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        o.levelUpMoney = 0 -- Int64
        o.levelUpMoneys = {} -- List<Int64>
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_Fortune5lian_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_Fortune5lian_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_Fortune5lianFreeRet.__index = PKG_Slots_Client_Fortune5lianFreeRet
...
PKG_Client_Slots_Fortune5lianFreeSpin = {
    typeName = "PKG_Client_Slots_Fortune5lianFreeSpin",
    typeId = 30514,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_Fortune5lianFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_Fortune5lianFreeSpin.__index = PKG_Client_Slots_Fortune5lianFreeSpin
...
PKG_Slots_Client_Fortune5lianEnterResumed = {
    typeName = "PKG_Slots_Client_Fortune5lianEnterResumed",
    typeId = 30517,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_Fortune5lianEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_Fortune5lianNormalRet.Create() -- PKG.Slots_Client.Fortune5lianNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFreeRet = PKG_Slots_Client_Fortune5lianFreeRet.Create() -- PKG.Slots_Client.Fortune5lianFreeRet
        --[[
        游戏彩金已开的数组
        ]]
        o.cells = {} -- List<Int32>
    ...
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_Fortune5lianNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeRet
        self.resumedFreeRet = PKG_Slots_Client_Fortune5lianFreeRet.Create(); r = self.resumedFreeRet:Read(om)
        if r ~= 0 then return r end
        -- cells
        r, len = d:Rvu32()
        if len > d:GetLeft() then return -1 end
...
PKG_Slots_Client_Fortune5lianEnterResumed.__index = PKG_Slots_Client_Fortune5lianEnterResumed

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_Fortune5lianNormalSpin = {
    typeName = "PKG_Client_Slots_Fortune5lianNormalSpin",
    typeId = 30513,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_Fortune5lianNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_Fortune5lianNormalSpin.__index = PKG_Client_Slots_Fortune5lianNormalSpin
...
PKG_Fortune5lian_Cell = {
    typeName = "PKG_Fortune5lian_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Fortune5lian_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_Fortune5lian_Cell.__index = PKG_Fortune5lian_Cell

PKG_Fortune5lian_Line = {
    typeName = "PKG_Fortune5lian_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Fortune5lian_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.Fortune5lian.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_Fortune5lian_Line.__index = PKG_Fortune5lian_Line
...
local o = ObjMgr
o.Register(PKG_Fortune5lian_NormalSpin)
o.Register(PKG_Fortune5lian_FreeSpin)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_Fortune5lianNormalRet)
o.Register(PKG_Slots_Client_Fortune5lianFreeRet)
o.Register(PKG_Slots_Client_Leave_Success)
o.Register(PKG_Client_Slots_Fortune5lianFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_Fortune5lianEnterResumed)
o.Register(PKG_Client_Slots_Fortune5lianNormalSpin)
