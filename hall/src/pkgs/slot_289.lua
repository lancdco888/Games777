...
CodeGen_slot_224_md5 ="#*MD5<816cf2a69f6bf97d07b4fc748d8ef558>*#"

PKG_ImmortalMonkey_ImmortalMonkeySymbol = {
    ServerMonkeyWild = 1,
    ServerMonkeyNine = 2,
    ServerMonkeyTen = 3,
    ServerMonkeyJ = 4,
    ...
    ServerMonkeyK = 6,
    ServerMonkeyA = 7,
    ServerMonkeyGeBuLin = 8,
    ServerMonkeyHongHaiEr = 9,
    ServerMonkeyTieShan = 10,
    ServerMonkeyNiuMoWang = 11,
    ServerMonkeyWuKong = 12
}
--[[
Sugar请求特殊旋转图形
]]
PKG_ImmortalMonkey_NormalSpin = {
    typeName = "PKG_ImmortalMonkey_NormalSpin",
    typeId = 30331,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_ImmortalMonkey_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.ImmortalMonkey.Cell>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
        ...
        o.lines = {} -- List<PKG.ImmortalMonkey.Line>
        return o
    end,
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_ImmortalMonkey_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_ImmortalMonkey_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_ImmortalMonkey_NormalSpin.__index = PKG_ImmortalMonkey_NormalSpin

--[[
生成图形数组和相关结果的基类
]]
PKG_ImmortalMonkey_FreeSpin = {
    typeName = "PKG_ImmortalMonkey_FreeSpin",
    typeId = 30332,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_ImmortalMonkey_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
    ...
    Write = function(self, om)
        ...
        d:Wvi32(self.isEnd)
        -- haveWukong
        d:Wvi32(self.haveWukong)
    end
}
PKG_ImmortalMonkey_FreeSpin.__index = PKG_ImmortalMonkey_FreeSpin

--[[
狂野蛮牛-普通结果
]]
PKG_Slots_Client_ImmortalMonkeyNormalRet = {
    typeName = "PKG_Slots_Client_ImmortalMonkeyNormalRet", -- : PKG_ImmortalMonkey_NormalSpin
    typeId = 30335,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_ImmortalMonkeyNormalRet)
        end
        PKG_ImmortalMonkey_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_ImmortalMonkey_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_ImmortalMonkey_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_ImmortalMonkeyNormalRet.__index = PKG_Slots_Client_ImmortalMonkeyNormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_ImmortalMonkeyFreeRet = {
    typeName = "PKG_Slots_Client_ImmortalMonkeyFreeRet", -- : PKG_ImmortalMonkey_FreeSpin
    typeId = 30336,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_ImmortalMonkeyFreeRet)
        end
        PKG_ImmortalMonkey_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_ImmortalMonkey_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_ImmortalMonkey_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_ImmortalMonkeyFreeRet.__index = PKG_Slots_Client_ImmortalMonkeyFreeRet
...
PKG_Client_Slots_ImmortalMonkeyFreeSpin = {
    typeName = "PKG_Client_Slots_ImmortalMonkeyFreeSpin",
    typeId = 30334,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_ImmortalMonkeyFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_ImmortalMonkeyFreeSpin.__index = PKG_Client_Slots_ImmortalMonkeyFreeSpin
...
PKG_Slots_Client_ImmortalMonkeyEnterResumed = {
    typeName = "PKG_Slots_Client_ImmortalMonkeyEnterResumed",
    typeId = 30337,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_ImmortalMonkeyEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_ImmortalMonkeyNormalRet.Create() -- PKG.Slots_Client.ImmortalMonkeyNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFreeRet = PKG_Slots_Client_ImmortalMonkeyFreeRet.Create() -- PKG.Slots_Client.ImmortalMonkeyFreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_ImmortalMonkeyNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeRet
        self.resumedFreeRet = PKG_Slots_Client_ImmortalMonkeyFreeRet.Create(); r = self.resumedFreeRet:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_ImmortalMonkeyEnterResumed.__index = PKG_Slots_Client_ImmortalMonkeyEnterResumed

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_ImmortalMonkeyNormalSpin = {
    typeName = "PKG_Client_Slots_ImmortalMonkeyNormalSpin",
    typeId = 30333,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_ImmortalMonkeyNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_ImmortalMonkeyNormalSpin.__index = PKG_Client_Slots_ImmortalMonkeyNormalSpin
...
PKG_ImmortalMonkey_Cell = {
    typeName = "PKG_ImmortalMonkey_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_ImmortalMonkey_Cell)
        end
        --[[
        点对应下标
        ]]
        ...
        o.icon = 0 -- PKG.ImmortalMonkey.ImmortalMonkeySymbol
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_ImmortalMonkey_Cell.__index = PKG_ImmortalMonkey_Cell

PKG_ImmortalMonkey_Line = {
    typeName = "PKG_ImmortalMonkey_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_ImmortalMonkey_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.ImmortalMonkey.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_ImmortalMonkey_Line.__index = PKG_ImmortalMonkey_Line
...
local o = ObjMgr
o.Register(PKG_ImmortalMonkey_NormalSpin)
o.Register(PKG_ImmortalMonkey_FreeSpin)
o.Register(PKG_Slots_Client_ImmortalMonkeyNormalRet)
o.Register(PKG_Slots_Client_ImmortalMonkeyFreeRet)
...
o.Register(PKG_Client_Slots_ImmortalMonkeyFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_ImmortalMonkeyEnterResumed)
o.Register(PKG_Client_Slots_ImmortalMonkeyNormalSpin)
