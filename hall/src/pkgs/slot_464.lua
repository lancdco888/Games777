...
CodeGen_slot_364_md5 ="#*MD5<666fb1b7c3cf0fc4388922a2ac0b15d5>*#"

PKG_GoldenElephant_NormalSpin = {
    typeName = "PKG_GoldenElephant_NormalSpin",
    typeId = 36400,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_GoldenElephant_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.GoldenElephant.Cell>
        --[[
        (符合连线规则)
        ]]
        o.lines = {} -- List<PKG.GoldenElephant.Line>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_GoldenElephant_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- lines
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_GoldenElephant_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
...
PKG_GoldenElephant_NormalSpin.__index = PKG_GoldenElephant_NormalSpin

PKG_GoldenElephant_FreeSpin = {
    typeName = "PKG_GoldenElephant_FreeSpin",
    typeId = 36401,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_GoldenElephant_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.totalFreeTime = 0 -- Int32
        --[[
        中奖数翻了几倍，最少2倍，最多20倍，该值仅用于显示，真实的钱的倍率已经翻倍过了。
        ]]
        o.doubled = 0 -- Int32
        --[[
        当前等级的百搭进度。
    ...
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- doubled
        r, self.doubled = d:Rvi32()
        if r ~= 0 then return r end
        -- wildLvl
        r, self.wildLvl = d:Rvi32()
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        ...
        d:Wvi32(self.totalFreeTime)
        -- doubled
        d:Wvi32(self.doubled)
        -- wildLvl
        d:Wvi32(self.wildLvl)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_GoldenElephant_FreeSpin.__index = PKG_GoldenElephant_FreeSpin
...
PKG_Slots_Client_GoldenElephantNormalRet = {
    typeName = "PKG_Slots_Client_GoldenElephantNormalRet",
    typeId = 36410,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_GoldenElephantNormalRet)
        end
        o.normalSpin = PKG_GoldenElephant_NormalSpin.Create() -- PKG.GoldenElephant.NormalSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- normalSpin
        self.normalSpin = PKG_GoldenElephant_NormalSpin.Create(); r = self.normalSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_GoldenElephantNormalRet.__index = PKG_Slots_Client_GoldenElephantNormalRet

--[[
免费旋转
]]
PKG_Slots_Client_GoldenElephantFreeRet = {
    typeName = "PKG_Slots_Client_GoldenElephantFreeRet",
    typeId = 36411,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_GoldenElephantFreeRet)
        end
        o.freeSpin = PKG_GoldenElephant_FreeSpin.Create() -- PKG.GoldenElephant.FreeSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- freeSpin
        self.freeSpin = PKG_GoldenElephant_FreeSpin.Create(); r = self.freeSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_GoldenElephantFreeRet.__index = PKG_Slots_Client_GoldenElephantFreeRet
...
PKG_Client_Slots_GoldenElephantFreeSpin = {
    typeName = "PKG_Client_Slots_GoldenElephantFreeSpin",
    typeId = 36421,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_GoldenElephantFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_GoldenElephantFreeSpin.__index = PKG_Client_Slots_GoldenElephantFreeSpin
...
PKG_Slots_Client_GoldenElephantEnterResumed = {
    typeName = "PKG_Slots_Client_GoldenElephantEnterResumed",
    typeId = 36412,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_GoldenElephantEnterResumed)
        end
        --[[
        押注等级
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_GoldenElephantNormalRet.Create() -- PKG.Slots_Client.GoldenElephantNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_GoldenElephantFreeRet.Create() -- PKG.Slots_Client.GoldenElephantFreeRet
        o.status = 0 -- Int32
        return o
    end,
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_GoldenElephantNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_GoldenElephantFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        -- status
...
PKG_Slots_Client_GoldenElephantEnterResumed.__index = PKG_Slots_Client_GoldenElephantEnterResumed

--[[
请求获取生成图形
]]
PKG_Client_Slots_GoldenElephantNormalSpin = {
    typeName = "PKG_Client_Slots_GoldenElephantNormalSpin",
    typeId = 36420,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_GoldenElephantNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_GoldenElephantNormalSpin.__index = PKG_Client_Slots_GoldenElephantNormalSpin
...
PKG_GoldenElephant_Cell = {
    typeName = "PKG_GoldenElephant_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_GoldenElephant_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_GoldenElephant_Cell.__index = PKG_GoldenElephant_Cell

PKG_GoldenElephant_Line = {
    typeName = "PKG_GoldenElephant_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_GoldenElephant_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.GoldenElephant.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_GoldenElephant_Line.__index = PKG_GoldenElephant_Line
...
local o = ObjMgr
o.Register(PKG_GoldenElephant_NormalSpin)
o.Register(PKG_GoldenElephant_FreeSpin)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_GoldenElephantNormalRet)
o.Register(PKG_Slots_Client_GoldenElephantFreeRet)
o.Register(PKG_Slots_Client_Leave_Success)
o.Register(PKG_Client_Slots_GoldenElephantFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_GoldenElephantEnterResumed)
o.Register(PKG_Client_Slots_GoldenElephantNormalSpin)
