...
require('g_net')
CodeGen_slot_469_md5 ="#*MD5<40cdf21f6066718c22614fc1e0f154ae>*#"

--[[
生成图形数组和相关结果的基类
]]
PKG_MightyMonkey_NormalSpin = {
    typeName = "PKG_MightyMonkey_NormalSpin",
    typeId = 46911,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_MightyMonkey_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.MightyMonkey.Cell>
        --[[
        (符合连线规则)
        ]]
        o.lines = {} -- List<PKG.MightyMonkey.Line>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
        ...
        o.enteryJPs = {} -- List<PKG.MightyMonkey.Cell>
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_MightyMonkey_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- lines
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_MightyMonkey_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
...
PKG_MightyMonkey_NormalSpin.__index = PKG_MightyMonkey_NormalSpin

--[[
生成图形数组和相关结果的基类
]]
PKG_MightyMonkey_FreeSpin = {
    typeName = "PKG_MightyMonkey_FreeSpin",
    typeId = 46912,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_MightyMonkey_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
    ...
    Write = function(self, om)
        ...
        -- accuFreeWinCoin
        d:Wd(self.accuFreeWinCoin)
    end
}
PKG_MightyMonkey_FreeSpin.__index = PKG_MightyMonkey_FreeSpin
...
PKG_Slots_Client_MightyMonkey_NormalRet = {
    typeName = "PKG_Slots_Client_MightyMonkey_NormalRet",
    typeId = 46915,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_MightyMonkey_NormalRet)
        end
        o.normalSpin = PKG_MightyMonkey_NormalSpin.Create() -- PKG.MightyMonkey.NormalSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- normalSpin
        self.normalSpin = PKG_MightyMonkey_NormalSpin.Create(); r = self.normalSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_MightyMonkey_NormalRet.__index = PKG_Slots_Client_MightyMonkey_NormalRet

--[[
Sugar-彩虹触发的免费游戏结果
]]
PKG_Slots_Client_MightyMonkey_FreeRet = {
    typeName = "PKG_Slots_Client_MightyMonkey_FreeRet",
    typeId = 46916,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_MightyMonkey_FreeRet)
        end
        o.freeSpin = PKG_MightyMonkey_FreeSpin.Create() -- PKG.MightyMonkey.FreeSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- freeSpin
        self.freeSpin = PKG_MightyMonkey_FreeSpin.Create(); r = self.freeSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_MightyMonkey_FreeRet.__index = PKG_Slots_Client_MightyMonkey_FreeRet
...
PKG_Client_Slots_MightyMonkey_FreeSpin = {
    typeName = "PKG_Client_Slots_MightyMonkey_FreeSpin",
    typeId = 46914,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_MightyMonkey_FreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_MightyMonkey_FreeSpin.__index = PKG_Client_Slots_MightyMonkey_FreeSpin
...
PKG_Slots_Client_MightyMonkey_EnterResumed = {
    typeName = "PKG_Slots_Client_MightyMonkey_EnterResumed",
    typeId = 46917,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_MightyMonkey_EnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_MightyMonkey_NormalRet.Create() -- PKG.Slots_Client.MightyMonkey_NormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFreeRet = PKG_Slots_Client_MightyMonkey_FreeRet.Create() -- PKG.Slots_Client.MightyMonkey_FreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_MightyMonkey_NormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeRet
        self.resumedFreeRet = PKG_Slots_Client_MightyMonkey_FreeRet.Create(); r = self.resumedFreeRet:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_MightyMonkey_EnterResumed.__index = PKG_Slots_Client_MightyMonkey_EnterResumed

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_MightyMonkey_NormalSpin = {
    typeName = "PKG_Client_Slots_MightyMonkey_NormalSpin",
    typeId = 46913,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_MightyMonkey_NormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_MightyMonkey_NormalSpin.__index = PKG_Client_Slots_MightyMonkey_NormalSpin
...
PKG_MightyMonkey_Cell = {
    typeName = "PKG_MightyMonkey_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_MightyMonkey_Cell)
        end
        --[[
        点对应下标
        ]]
    ...
    Write = function(self, om)
        ...
        -- isGreen
        d:Wvi32(self.isGreen)
    end
}
PKG_MightyMonkey_Cell.__index = PKG_MightyMonkey_Cell

PKG_MightyMonkey_Line = {
    typeName = "PKG_MightyMonkey_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_MightyMonkey_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.MightyMonkey.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_MightyMonkey_Line.__index = PKG_MightyMonkey_Line
...
local o = ObjMgr
o.Register(PKG_MightyMonkey_NormalSpin)
o.Register(PKG_MightyMonkey_FreeSpin)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_MightyMonkey_NormalRet)
o.Register(PKG_Slots_Client_MightyMonkey_FreeRet)
o.Register(PKG_Slots_Client_Leave_Success)
o.Register(PKG_Client_Slots_MightyMonkey_FreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_MightyMonkey_EnterResumed)
o.Register(PKG_Client_Slots_MightyMonkey_NormalSpin)
