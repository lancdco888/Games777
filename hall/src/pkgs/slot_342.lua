...
-- require('g_net')
CodeGen_slot_342_md5 ="#*MD5<42a1f3e05d1fe7e33b3fde75091a7617>*#"

PKG_HurricaneHorse_FreeSpin = {
    typeName = "PKG_HurricaneHorse_FreeSpin",
    typeId = 34201,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_HurricaneHorse_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.HurricaneHorse.Cell>
        o.wildBet = 0 -- Int32
        --[[
        ...
        o.lines = {} -- List<PKG.HurricaneHorse.Line>
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_HurricaneHorse_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- wildBet
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_HurricaneHorse_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- slotMoneyGift
...
PKG_HurricaneHorse_FreeSpin.__index = PKG_HurricaneHorse_FreeSpin

PKG_HurricaneHorse_NormalSpin = {
    typeName = "PKG_HurricaneHorse_NormalSpin",
    typeId = 34200,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_HurricaneHorse_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_HurricaneHorse_NormalSpin.__index = PKG_HurricaneHorse_NormalSpin
...
PKG_Slots_Client_HurricaneHorseFreeRet = {
    typeName = "PKG_Slots_Client_HurricaneHorseFreeRet",
    typeId = 34211,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_HurricaneHorseFreeRet)
        end
        o.freeSpin = PKG_HurricaneHorse_FreeSpin.Create() -- PKG.HurricaneHorse.FreeSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- freeSpin
        self.freeSpin = PKG_HurricaneHorse_FreeSpin.Create(); r = self.freeSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_HurricaneHorseFreeRet.__index = PKG_Slots_Client_HurricaneHorseFreeRet

--[[
普通旋转
]]
PKG_Slots_Client_HurricaneHorseNormalRet = {
    typeName = "PKG_Slots_Client_HurricaneHorseNormalRet",
    typeId = 34210,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_HurricaneHorseNormalRet)
        end
        o.normalSpin = PKG_HurricaneHorse_NormalSpin.Create() -- PKG.HurricaneHorse.NormalSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- normalSpin
        self.normalSpin = PKG_HurricaneHorse_NormalSpin.Create(); r = self.normalSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_HurricaneHorseNormalRet.__index = PKG_Slots_Client_HurricaneHorseNormalRet
...
PKG_Slots_Client_HurricaneHorseLastRes = {
    typeName = "PKG_Slots_Client_HurricaneHorseLastRes",
    typeId = 34213,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_HurricaneHorseLastRes)
        end
        o.remainData = PKG_HurricaneHorse_RemainData.Create() -- PKG.HurricaneHorse.RemainData
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- remainData
        self.remainData = PKG_HurricaneHorse_RemainData.Create(); r = self.remainData:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_HurricaneHorseLastRes.__index = PKG_Slots_Client_HurricaneHorseLastRes

--[[
断线重连
]]
PKG_Slots_Client_HurricaneHorseEnterResumed = {
    typeName = "PKG_Slots_Client_HurricaneHorseEnterResumed",
    typeId = 34212,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_HurricaneHorseEnterResumed)
        end
        --[[
        押注等级
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_HurricaneHorseNormalRet.Create() -- PKG.Slots_Client.HurricaneHorseNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_HurricaneHorseFreeRet.Create() -- PKG.Slots_Client.HurricaneHorseFreeRet
    ...
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_HurricaneHorseNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_HurricaneHorseFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        -- lastMsgType
...
PKG_Slots_Client_HurricaneHorseEnterResumed.__index = PKG_Slots_Client_HurricaneHorseEnterResumed
...
PKG_Client_Slots_HurricaneHorseLastReq = {
    typeName = "PKG_Client_Slots_HurricaneHorseLastReq",
    typeId = 34222,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_HurricaneHorseLastReq)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_HurricaneHorseLastReq.__index = PKG_Client_Slots_HurricaneHorseLastReq

--[[
请求免费旋转
]]
PKG_Client_Slots_HurricaneHorseFreeSpin = {
    typeName = "PKG_Client_Slots_HurricaneHorseFreeSpin",
    typeId = 34221,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_HurricaneHorseFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_HurricaneHorseFreeSpin.__index = PKG_Client_Slots_HurricaneHorseFreeSpin

--[[
请求普通旋转
]]
PKG_Client_Slots_HurricaneHorseNormalSpin = {
    typeName = "PKG_Client_Slots_HurricaneHorseNormalSpin",
    typeId = 34220,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_HurricaneHorseNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_HurricaneHorseNormalSpin.__index = PKG_Client_Slots_HurricaneHorseNormalSpin
...
PKG_HurricaneHorse_Cell = {
    typeName = "PKG_HurricaneHorse_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_HurricaneHorse_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_HurricaneHorse_Cell.__index = PKG_HurricaneHorse_Cell
...
PKG_HurricaneHorse_Line = {
    typeName = "PKG_HurricaneHorse_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_HurricaneHorse_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.HurricaneHorse.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_HurricaneHorse_Line.__index = PKG_HurricaneHorse_Line
...
PKG_HurricaneHorse_RemainGraph = {
    typeName = "PKG_HurricaneHorse_RemainGraph",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_HurricaneHorse_RemainGraph)
        end
        o.betMoney = 0 -- Double
        o.lvID = 0 -- Int32
        o.grids = {} -- List<PKG.HurricaneHorse.Cell>
...
PKG_HurricaneHorse_RemainGraph.__index = PKG_HurricaneHorse_RemainGraph
...
PKG_HurricaneHorse_RemainData = {
    typeName = "PKG_HurricaneHorse_RemainData",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_HurricaneHorse_RemainData)
        end
        o.graphs = {} -- List<PKG.HurricaneHorse.RemainGraph>
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        self.graphs = o
        for i = 1, len do
            o[i] = PKG_HurricaneHorse_RemainGraph.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_HurricaneHorse_RemainData.__index = PKG_HurricaneHorse_RemainData
...
local o = ObjMgr
o.Register(PKG_HurricaneHorse_FreeSpin)
o.Register(PKG_HurricaneHorse_NormalSpin)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_HurricaneHorseFreeRet)
o.Register(PKG_Slots_Client_HurricaneHorseNormalRet)
...
o.Register(PKG_Slots_Client_HurricaneHorseLastRes)
o.Register(PKG_Slots_Client_HurricaneHorseEnterResumed)
...
o.Register(PKG_Client_Slots_HurricaneHorseLastReq)
o.Register(PKG_Client_Slots_HurricaneHorseFreeSpin)
o.Register(PKG_Client_Slots_HurricaneHorseNormalSpin)
