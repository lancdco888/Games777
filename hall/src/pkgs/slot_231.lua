...
CodeGen_slot_218_md5 ="#*MD5<9c012a67b1e616a347d0c3b3b9c2287c>*#"

PKG_FortuneTree_FortuneTreeSymbol = {
    FortuneTreeWild = 1,
    FortuneTreeCaiBao = 2,
    FortuneTreeLong = 3,
    FortuneTreeFeng = 4,
...
PKG_FortuneTree_NormalSpin = {
    typeName = "PKG_FortuneTree_NormalSpin",
    typeId = 30291,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_FortuneTree_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.FortuneTree.Cell>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
        ...
        o.lines = {} -- List<PKG.FortuneTree.Line>
        --[[
        是否进入收集游戏
        ]]
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_FortuneTree_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_FortuneTree_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoCollect
...
PKG_FortuneTree_NormalSpin.__index = PKG_FortuneTree_NormalSpin

--[[
免费类型选择
]]
PKG_FortuneTree_FreeType = {
    typeName = "PKG_FortuneTree_FreeType",
    typeId = 30292,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_FortuneTree_FreeType)
        end
        --[[
        倍率类型
        ]]
...
PKG_FortuneTree_FreeType.__index = PKG_FortuneTree_FreeType

--[[
Sugar请求特殊旋转图形
]]
PKG_FortuneTree_FreeSpin = {
    typeName = "PKG_FortuneTree_FreeSpin",
    typeId = 30293,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_FortuneTree_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_FortuneTree_FreeSpin.__index = PKG_FortuneTree_FreeSpin

--[[
狂野蛮牛-普通结果
]]
PKG_Slots_Client_FortuneTreeNormalRet = {
    typeName = "PKG_Slots_Client_FortuneTreeNormalRet", -- : PKG_FortuneTree_NormalSpin
    typeId = 30297,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_FortuneTreeNormalRet)
        end
        PKG_FortuneTree_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_FortuneTree_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_FortuneTree_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_FortuneTreeNormalRet.__index = PKG_Slots_Client_FortuneTreeNormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_FortuneTreeFreeRetType = {
    typeName = "PKG_Slots_Client_FortuneTreeFreeRetType", -- : PKG_FortuneTree_FreeType
    typeId = 30298,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_FortuneTreeFreeRetType)
        end
        PKG_FortuneTree_FreeType.Create(o)
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- base read
        r = PKG_FortuneTree_FreeType.Read(self, om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_FortuneTree_FreeType.Write(self, om)
    end
}
PKG_Slots_Client_FortuneTreeFreeRetType.__index = PKG_Slots_Client_FortuneTreeFreeRetType

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_FortuneTreeFreeRet = {
    typeName = "PKG_Slots_Client_FortuneTreeFreeRet", -- : PKG_FortuneTree_FreeSpin
    typeId = 30299,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_FortuneTreeFreeRet)
        end
        PKG_FortuneTree_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_FortuneTree_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_FortuneTree_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_FortuneTreeFreeRet.__index = PKG_Slots_Client_FortuneTreeFreeRet
...
PKG_Client_Slots_FortuneTreeFreeSpin = {
    typeName = "PKG_Client_Slots_FortuneTreeFreeSpin",
    typeId = 30296,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_FortuneTreeFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_FortuneTreeFreeSpin.__index = PKG_Client_Slots_FortuneTreeFreeSpin
...
PKG_Slots_Client_FortuneTreeEnterResumed = {
    typeName = "PKG_Slots_Client_FortuneTreeEnterResumed",
    typeId = 30300,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_FortuneTreeEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_FortuneTreeNormalRet.Create() -- PKG.Slots_Client.FortuneTreeNormalRet
        --[[
        恢复免费游戏类型
        ]]
        o.resumedFreeTypeRet = PKG_Slots_Client_FortuneTreeFreeRetType.Create() -- PKG.Slots_Client.FortuneTreeFreeRetType
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFreeRet = PKG_Slots_Client_FortuneTreeFreeRet.Create() -- PKG.Slots_Client.FortuneTreeFreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_FortuneTreeNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeTypeRet
        self.resumedFreeTypeRet = PKG_Slots_Client_FortuneTreeFreeRetType.Create(); r = self.resumedFreeTypeRet:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeRet
        self.resumedFreeRet = PKG_Slots_Client_FortuneTreeFreeRet.Create(); r = self.resumedFreeRet:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_FortuneTreeEnterResumed.__index = PKG_Slots_Client_FortuneTreeEnterResumed

--[[
发财树 请求免费类型
]]
PKG_Client_Slots_FortuneTreeFreeType = {
    typeName = "PKG_Client_Slots_FortuneTreeFreeType",
    typeId = 30295,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_FortuneTreeFreeType)
        end
        --[[
        押注类型
        ]]
...
PKG_Client_Slots_FortuneTreeFreeType.__index = PKG_Client_Slots_FortuneTreeFreeType

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_FortuneTreeNormalSpin = {
    typeName = "PKG_Client_Slots_FortuneTreeNormalSpin",
    typeId = 30294,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_FortuneTreeNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_FortuneTreeNormalSpin.__index = PKG_Client_Slots_FortuneTreeNormalSpin
...
PKG_FortuneTree_Cell = {
    typeName = "PKG_FortuneTree_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_FortuneTree_Cell)
        end
        --[[
        点对应下标
        ]]
        ...
        o.icon = 0 -- PKG.FortuneTree.FortuneTreeSymbol
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_FortuneTree_Cell.__index = PKG_FortuneTree_Cell

PKG_FortuneTree_Line = {
    typeName = "PKG_FortuneTree_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_FortuneTree_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.FortuneTree.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_FortuneTree_Line.__index = PKG_FortuneTree_Line
...
local o = ObjMgr
o.Register(PKG_FortuneTree_NormalSpin)
o.Register(PKG_FortuneTree_FreeType)
o.Register(PKG_FortuneTree_FreeSpin)
o.Register(PKG_Slots_Client_FortuneTreeNormalRet)
o.Register(PKG_Slots_Client_FortuneTreeFreeRetType)
o.Register(PKG_Slots_Client_FortuneTreeFreeRet)
...
o.Register(PKG_Client_Slots_FortuneTreeFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_FortuneTreeEnterResumed)
o.Register(PKG_Client_Slots_FortuneTreeFreeType)
o.Register(PKG_Client_Slots_FortuneTreeNormalSpin)
