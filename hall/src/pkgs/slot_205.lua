...
CodeGen_slot_205_md5 ="#*MD5<89112ecb58d4fbed136be7123b1f6fbd>*#"

PKG_WealthGold_wealthGoldSymbol = {
    SymbolCaibao = 1,
    SymbolWild = 2,
    SymbolJingui = 3,
    SymbolJinyu = 4,
...
PKG_WealthGold_WealthGoldBase = {
    typeName = "PKG_WealthGold_WealthGoldBase",
    typeId = 30361,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_WealthGold_WealthGoldBase)
        end
        --[[
        (一次旋转押注 免费游戏为0)
        ]]
        ...
        o.grids = {} -- List<PKG.WealthGold.Cell>
        return o
    end,
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_WealthGold_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_WealthGold_WealthGoldBase.__index = PKG_WealthGold_WealthGoldBase
...
PKG_Slots_Client_WealthGoldNormalRet = {
    typeName = "PKG_Slots_Client_WealthGoldNormalRet", -- : PKG_WealthGold_WealthGoldBase
    typeId = 30365,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_WealthGoldNormalRet)
        end
        PKG_WealthGold_WealthGoldBase.Create(o)
        --[[
        是否进入免费游戏
        ]]
        o.avatarId = 0 -- Int32
        ...
        o.lines = {} -- List<PKG.WealthGold.Line>
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_WealthGold_WealthGoldBase.Read(self, om)
        if r ~= 0 then return r end
        -- avatarId
        r, self.avatarId = d:Rvi32()
        if r ~= 0 then return r end
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_WealthGold_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_WealthGold_WealthGoldBase.Write(self, om)
        -- avatarId
        d:Wvi32(self.avatarId)
        -- lines
        o = self.lines
...
PKG_Slots_Client_WealthGoldNormalRet.__index = PKG_Slots_Client_WealthGoldNormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_WealthGoldFreeRetType = {
    typeName = "PKG_Slots_Client_WealthGoldFreeRetType",
    typeId = 30366,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_WealthGoldFreeRetType)
        end
        --[[
        是否成功
        ]]
...
PKG_Slots_Client_WealthGoldFreeRetType.__index = PKG_Slots_Client_WealthGoldFreeRetType

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_WealthGoldFreeRet = {
    typeName = "PKG_Slots_Client_WealthGoldFreeRet", -- : PKG_WealthGold_WealthGoldBase
    typeId = 30367,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_WealthGoldFreeRet)
        end
        PKG_WealthGold_WealthGoldBase.Create(o)
        --[[
...
PKG_Slots_Client_WealthGoldFreeRet.__index = PKG_Slots_Client_WealthGoldFreeRet

--[[
Sugar请求特殊旋转图形
]]
PKG_Client_Slots_WealthGoldFreeSpin = {
    typeName = "PKG_Client_Slots_WealthGoldFreeSpin",
    typeId = 30364,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_WealthGoldFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_WealthGoldFreeSpin.__index = PKG_Client_Slots_WealthGoldFreeSpin
...
PKG_Client_Slots_WealthGoldNormalSpin = {
    typeName = "PKG_Client_Slots_WealthGoldNormalSpin",
    typeId = 30362,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_WealthGoldNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_WealthGoldNormalSpin.__index = PKG_Client_Slots_WealthGoldNormalSpin
...
PKG_Slots_Client_WealthGoldEnterResumed = {
    typeName = "PKG_Slots_Client_WealthGoldEnterResumed",
    typeId = 30368,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_WealthGoldEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_WealthGoldNormalRet.Create() -- PKG.Slots_Client.WealthGoldNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFreeType = PKG_Slots_Client_WealthGoldFreeRetType.Create() -- PKG.Slots_Client.WealthGoldFreeRetType
        --[[
        恢复特殊游戏结果
        ]]
        o.resumedFreeRet = PKG_Slots_Client_WealthGoldFreeRet.Create() -- PKG.Slots_Client.WealthGoldFreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_WealthGoldNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeType
        self.resumedFreeType = PKG_Slots_Client_WealthGoldFreeRetType.Create(); r = self.resumedFreeType:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeRet
        self.resumedFreeRet = PKG_Slots_Client_WealthGoldFreeRet.Create(); r = self.resumedFreeRet:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_WealthGoldEnterResumed.__index = PKG_Slots_Client_WealthGoldEnterResumed

--[[
Sugar请求特殊旋转图形
]]
PKG_Client_Slots_WealthGoldFreeType = {
    typeName = "PKG_Client_Slots_WealthGoldFreeType",
    typeId = 30363,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_WealthGoldFreeType)
        end
        --[[
        押注类型
        ]]
...
PKG_Client_Slots_WealthGoldFreeType.__index = PKG_Client_Slots_WealthGoldFreeType
...
PKG_WealthGold_Cell = {
    typeName = "PKG_WealthGold_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_WealthGold_Cell)
        end
        --[[
        点对应下标
        ]]
        ...
        o.icon = 0 -- PKG.WealthGold.wealthGoldSymbol
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_WealthGold_Cell.__index = PKG_WealthGold_Cell
...
PKG_WealthGold_Line = {
    typeName = "PKG_WealthGold_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_WealthGold_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.WealthGold.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_WealthGold_Line.__index = PKG_WealthGold_Line
...
local o = ObjMgr
o.Register(PKG_WealthGold_WealthGoldBase)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_WealthGoldNormalRet)
o.Register(PKG_Slots_Client_WealthGoldFreeRetType)
o.Register(PKG_Slots_Client_WealthGoldFreeRet)
o.Register(PKG_Client_Slots_WealthGoldFreeSpin)
o.Register(PKG_Slots_Client_OfflineCheck)
o.Register(PKG_Slots_Client_Leave_Success)
o.Register(PKG_Client_Slots_WealthGoldNormalSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_WealthGoldEnterResumed)
o.Register(PKG_Client_Slots_WealthGoldFreeType)
