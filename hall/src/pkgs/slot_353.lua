...
require('g_net')
CodeGen_slot_353_md5 ="#*MD5<baeb684d798ff5e82c9279add05be42e>*#"

--[[
Sugar请求特殊旋转图形
]]
PKG_Buffalo_NormalSpin = {
    typeName = "PKG_Buffalo_NormalSpin",
    typeId = 35311,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Buffalo_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_Buffalo_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_Buffalo_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- slotMoneyGift
...
PKG_Buffalo_NormalSpin.__index = PKG_Buffalo_NormalSpin

--[[
sss
]]
PKG_Buffalo_FreeType = {
    typeName = "PKG_Buffalo_FreeType",
    typeId = 35331,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Buffalo_FreeType)
        end
        o.type = 0 -- Int32
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
...
PKG_Buffalo_FreeType.__index = PKG_Buffalo_FreeType

--[[
Sugar请求免费旋转图形
]]
PKG_Buffalo_FreeSpin = {
    typeName = "PKG_Buffalo_FreeSpin",
    typeId = 35312,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Buffalo_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_Buffalo_FreeSpin.__index = PKG_Buffalo_FreeSpin

--[[
狂野蛮牛-普通结果
]]
PKG_Slots_Client_BuffaloNormalRet = {
    typeName = "PKG_Slots_Client_BuffaloNormalRet",
    typeId = 35316,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_BuffaloNormalRet)
        end
        o.normalSpin = PKG_Buffalo_NormalSpin.Create() -- PKG.Buffalo.NormalSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- normalSpin
        self.normalSpin = PKG_Buffalo_NormalSpin.Create(); r = self.normalSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_BuffaloNormalRet.__index = PKG_Slots_Client_BuffaloNormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_BuffaloFreeTypeRet = {
    typeName = "PKG_Slots_Client_BuffaloFreeTypeRet",
    typeId = 35317,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_BuffaloFreeTypeRet)
        end
        o.freetype = PKG_Buffalo_FreeType.Create() -- PKG.Buffalo.FreeType
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- freetype
        self.freetype = PKG_Buffalo_FreeType.Create(); r = self.freetype:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_BuffaloFreeTypeRet.__index = PKG_Slots_Client_BuffaloFreeTypeRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_BuffaloFreeRet = {
    typeName = "PKG_Slots_Client_BuffaloFreeRet",
    typeId = 35318,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_BuffaloFreeRet)
        end
        o.freeSpin = PKG_Buffalo_FreeSpin.Create() -- PKG.Buffalo.FreeSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- freeSpin
        self.freeSpin = PKG_Buffalo_FreeSpin.Create(); r = self.freeSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_BuffaloFreeRet.__index = PKG_Slots_Client_BuffaloFreeRet
...
PKG_Client_Slots_BuffaloFreeSpin = {
    typeName = "PKG_Client_Slots_BuffaloFreeSpin",
    typeId = 35315,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_BuffaloFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_BuffaloFreeSpin.__index = PKG_Client_Slots_BuffaloFreeSpin
...
PKG_Slots_Client_BuffaloEnterResumed = {
    typeName = "PKG_Slots_Client_BuffaloEnterResumed",
    typeId = 35320,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_BuffaloEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_BuffaloNormalRet.Create() -- PKG.Slots_Client.BuffaloNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFreeType = PKG_Slots_Client_BuffaloFreeTypeRet.Create() -- PKG.Slots_Client.BuffaloFreeTypeRet
        --[[
        恢复特殊游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_BuffaloFreeRet.Create() -- PKG.Slots_Client.BuffaloFreeRet
        --[[
        游戏彩金已开的数组
        ]]
        o.cells = {} -- List<Int32>
    ...
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_BuffaloNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeType
        self.resumedFreeType = PKG_Slots_Client_BuffaloFreeTypeRet.Create(); r = self.resumedFreeType:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_BuffaloFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        -- cells
        r, len = d:Rvu32()
        if len > d:GetLeft() then return -1 end
...
PKG_Slots_Client_BuffaloEnterResumed.__index = PKG_Slots_Client_BuffaloEnterResumed

--[[
财富之眼 请求免费类型
]]
PKG_Client_Slots_BuffaloFreeType = {
    typeName = "PKG_Client_Slots_BuffaloFreeType",
    typeId = 35314,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_BuffaloFreeType)
        end
        o.type = 1 -- Int32
        return o
    end,
...
PKG_Client_Slots_BuffaloFreeType.__index = PKG_Client_Slots_BuffaloFreeType

--[[
财富之眼  普通旋转
]]
PKG_Client_Slots_BuffaloNormalSpin = {
    typeName = "PKG_Client_Slots_BuffaloNormalSpin",
    typeId = 35313,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_BuffaloNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_BuffaloNormalSpin.__index = PKG_Client_Slots_BuffaloNormalSpin
...
PKG_Buffalo_Cell = {
    typeName = "PKG_Buffalo_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Buffalo_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_Buffalo_Cell.__index = PKG_Buffalo_Cell

PKG_Buffalo_Line = {
    typeName = "PKG_Buffalo_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Buffalo_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.Buffalo.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_Buffalo_Line.__index = PKG_Buffalo_Line
...
local o = ObjMgr
o.Register(PKG_Buffalo_NormalSpin)
o.Register(PKG_Buffalo_FreeType)
o.Register(PKG_Buffalo_FreeSpin)
o.Register(PKG_Slots_Client_BuffaloNormalRet)
o.Register(PKG_Slots_Client_BuffaloFreeTypeRet)
o.Register(PKG_Slots_Client_BuffaloFreeRet)
...
o.Register(PKG_Client_Slots_BuffaloFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_BuffaloEnterResumed)
o.Register(PKG_Client_Slots_BuffaloFreeType)
o.Register(PKG_Client_Slots_BuffaloNormalSpin)
