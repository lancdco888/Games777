...
CodeGen_slot_311_md5 ="#*MD5<5811ac58334274568d96af58d6c0bfff>*#"

--[[
免费类型选择
]]
PKG_FireLink_FreeType = {
    typeName = "PKG_FireLink_FreeType",
    typeId = 30802,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_FireLink_FreeType)
        end
        --[[
        倍率类型
        ]]
...
PKG_FireLink_FreeType.__index = PKG_FireLink_FreeType
...
PKG_Slots_Client_FireLinkNormalRet = {
    typeName = "PKG_Slots_Client_FireLinkNormalRet", -- : PKG_FireLink_NormalSpin
    typeId = 30809,
    Create = function(o)
        if o == nil then
            o = {}
        ...
        PKG_FireLink_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_FireLink_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_FireLink_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_FireLinkFreeRetType = {
    typeName = "PKG_Slots_Client_FireLinkFreeRetType", -- : PKG_FireLink_FreeType
    typeId = 30810,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_FireLinkFreeRetType)
        end
        PKG_FireLink_FreeType.Create(o)
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- base read
        r = PKG_FireLink_FreeType.Read(self, om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_FireLink_FreeType.Write(self, om)
    end
}
PKG_Slots_Client_FireLinkFreeRetType.__index = PKG_Slots_Client_FireLinkFreeRetType

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_FireLinkFreeRet = {
    typeName = "PKG_Slots_Client_FireLinkFreeRet", -- : PKG_FireLink_FreeSpin
    typeId = 30811,
    Create = function(o)
        if o == nil then
            o = {}
        ...
        PKG_FireLink_FreeSpin.Create(o)
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- base read
        r = PKG_FireLink_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_FireLink_FreeSpin.Write(self, om)
    end
}
...
PKG_Slots_Client_FireLinkSpecialRet = {
    typeName = "PKG_Slots_Client_FireLinkSpecialRet", -- : PKG_FireLink_SpecialSpin
    typeId = 30812,
    Create = function(o)
        if o == nil then
            o = {}
        ...
        PKG_FireLink_SpecialSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_FireLink_SpecialSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_FireLink_SpecialSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_FireLinkEnterResumed = {
    ...
    Create = function(o)
        ...
        o.resumedFreeType = PKG_Slots_Client_FireLinkFreeRetType.Create() -- PKG.Slots_Client.FireLinkFreeRetType
        --[[
        恢复免费游戏结果
        ]]
    ...
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- resumedFreeType
        self.resumedFreeType = PKG_Slots_Client_FireLinkFreeRetType.Create(); r = self.resumedFreeType:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
...
PKG_Client_Slots_FireLinkFreeType = {
    typeName = "PKG_Client_Slots_FireLinkFreeType",
    typeId = 30806,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_FireLinkFreeType)
        end
        --[[
        押注类型
        ]]
...
PKG_Client_Slots_FireLinkFreeType.__index = PKG_Client_Slots_FireLinkFreeType
...
local o = ObjMgr
o.Register(PKG_FireLink_FreeType)
...
o.Register(PKG_Slots_Client_FireLinkFreeRetType)
...
o.Register(PKG_Client_Slots_FireLinkFreeType)
