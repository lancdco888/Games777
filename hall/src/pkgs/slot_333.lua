...
CodeGen_slot_230_md5 ="#*MD5<dc50d349effd1b510832d016b0ffee58>*#"

PKG_FortuneCat_FortuneCatSymbol = {
    FortuneCatWild = 1,
    FortuneCatCaibao = 2,
    FortuneCatBaGua = 3,
    FortuneCatJinYu = 4,
...
PKG_FortuneCat_FreeSpin = {
    typeName = "PKG_FortuneCat_FreeSpin",
    typeId = 30422,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_FortuneCat_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.FortuneCat.Cell>
        --[[
        替代的倍率
        ]]
        o.listWild = {} -- List<PKG.FortuneCat.WildBet>
        --[[
        ...
        o.lines = {} -- List<PKG.FortuneCat.Line>
        return o
    end,
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_FortuneCat_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- listWild
        ...
        self.listWild = o
        for i = 1, len do
            o[i] = PKG_FortuneCat_WildBet.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- bonusWinCoin
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_FortuneCat_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_FortuneCat_FreeSpin.__index = PKG_FortuneCat_FreeSpin

--[[
Sugar请求特殊旋转图形
]]
PKG_FortuneCat_NormalSpin = {
    typeName = "PKG_FortuneCat_NormalSpin",
    typeId = 30421,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_FortuneCat_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_FortuneCat_NormalSpin.__index = PKG_FortuneCat_NormalSpin

--[[
狂野蛮牛-普通结果
]]
PKG_Slots_Client_FortuneCatNormalRet = {
    typeName = "PKG_Slots_Client_FortuneCatNormalRet", -- : PKG_FortuneCat_NormalSpin
    typeId = 30426,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_FortuneCatNormalRet)
        end
        PKG_FortuneCat_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_FortuneCat_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_FortuneCat_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_FortuneCatNormalRet.__index = PKG_Slots_Client_FortuneCatNormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_FortuneCatFreeRet = {
    typeName = "PKG_Slots_Client_FortuneCatFreeRet", -- : PKG_FortuneCat_FreeSpin
    typeId = 30427,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_FortuneCatFreeRet)
        end
        PKG_FortuneCat_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_FortuneCat_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_FortuneCat_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_FortuneCatFreeRet.__index = PKG_Slots_Client_FortuneCatFreeRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_FortuneCatSpecialRet = {
    typeName = "PKG_Slots_Client_FortuneCatSpecialRet", -- : PKG_FortuneCat_FreeSpin
    typeId = 30428,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_FortuneCatSpecialRet)
        end
        PKG_FortuneCat_FreeSpin.Create(o)
        --[[
...
PKG_Slots_Client_FortuneCatSpecialRet.__index = PKG_Slots_Client_FortuneCatSpecialRet
...
PKG_Client_Slots_FortuneCatSpecialSpin = {
    typeName = "PKG_Client_Slots_FortuneCatSpecialSpin",
    typeId = 30425,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_FortuneCatSpecialSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_FortuneCatSpecialSpin.__index = PKG_Client_Slots_FortuneCatSpecialSpin
...
PKG_Slots_Client_FortuneCatEnterResumed = {
    typeName = "PKG_Slots_Client_FortuneCatEnterResumed",
    typeId = 30429,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_FortuneCatEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_FortuneCatNormalRet.Create() -- PKG.Slots_Client.FortuneCatNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFreeRet = PKG_Slots_Client_FortuneCatFreeRet.Create() -- PKG.Slots_Client.FortuneCatFreeRet
        --[[
        恢复特殊游戏结果
        ]]
        o.resumedSpecialRet = PKG_Slots_Client_FortuneCatSpecialRet.Create() -- PKG.Slots_Client.FortuneCatSpecialRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_FortuneCatNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeRet
        self.resumedFreeRet = PKG_Slots_Client_FortuneCatFreeRet.Create(); r = self.resumedFreeRet:Read(om)
        if r ~= 0 then return r end
        -- resumedSpecialRet
        self.resumedSpecialRet = PKG_Slots_Client_FortuneCatSpecialRet.Create(); r = self.resumedSpecialRet:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_FortuneCatEnterResumed.__index = PKG_Slots_Client_FortuneCatEnterResumed

--[[
Sugar请求特殊旋转图形
]]
PKG_Client_Slots_FortuneCatFreeSpin = {
    typeName = "PKG_Client_Slots_FortuneCatFreeSpin",
    typeId = 30424,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_FortuneCatFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_FortuneCatFreeSpin.__index = PKG_Client_Slots_FortuneCatFreeSpin

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_FortuneCatNormalSpin = {
    typeName = "PKG_Client_Slots_FortuneCatNormalSpin",
    typeId = 30423,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_FortuneCatNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_FortuneCatNormalSpin.__index = PKG_Client_Slots_FortuneCatNormalSpin
...
PKG_FortuneCat_Cell = {
    typeName = "PKG_FortuneCat_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_FortuneCat_Cell)
        end
        --[[
        点对应下标
        ]]
        ...
        o.icon = 0 -- PKG.FortuneCat.FortuneCatSymbol
        --[[
...
PKG_FortuneCat_Cell.__index = PKG_FortuneCat_Cell

PKG_FortuneCat_Line = {
    typeName = "PKG_FortuneCat_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_FortuneCat_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.FortuneCat.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_FortuneCat_Line.__index = PKG_FortuneCat_Line
...
PKG_FortuneCat_WildBet = {
    typeName = "PKG_FortuneCat_WildBet",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_FortuneCat_WildBet)
        end
        o.index = 0 -- Int32
        o.bet = 0 -- Int32
        return o
...
PKG_FortuneCat_WildBet.__index = PKG_FortuneCat_WildBet
...
local o = ObjMgr
o.Register(PKG_FortuneCat_FreeSpin)
o.Register(PKG_FortuneCat_NormalSpin)
o.Register(PKG_Slots_Client_FortuneCatNormalRet)
o.Register(PKG_Slots_Client_FortuneCatFreeRet)
o.Register(PKG_Slots_Client_FortuneCatSpecialRet)
...
o.Register(PKG_Client_Slots_FortuneCatSpecialSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_FortuneCatEnterResumed)
o.Register(PKG_Client_Slots_FortuneCatFreeSpin)
o.Register(PKG_Client_Slots_FortuneCatNormalSpin)
