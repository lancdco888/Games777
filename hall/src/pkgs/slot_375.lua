...
require('g_net')
CodeGen_slot_375_md5 ="#*MD5<8c22a75fe2482a4fe1a732176983fc37>*#"

--[[
Sugar请求免费旋转图形
]]
PKG_EurekaTrain_FreeSpin = {
    typeName = "PKG_EurekaTrain_FreeSpin",
    typeId = 37513,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_EurekaTrain_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.EurekaTrain.Cell>
        --[[
        ...
        o.lines = {} -- List<PKG.EurekaTrain.Line>
        --[[
        免费游戏增加免费次数
        ]]
        o.addTime = 0 -- Int32
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_EurekaTrain_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- bonusWinCoin
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_EurekaTrain_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- addTime
...
PKG_EurekaTrain_FreeSpin.__index = PKG_EurekaTrain_FreeSpin

--[[
sss
]]
PKG_EurekaTrain_FreeType = {
    typeName = "PKG_EurekaTrain_FreeType",
    typeId = 37512,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_EurekaTrain_FreeType)
        end
        o.type = 0 -- Int32
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
...
PKG_EurekaTrain_FreeType.__index = PKG_EurekaTrain_FreeType

--[[
Sugar请求特殊旋转图形
]]
PKG_EurekaTrain_NormalSpin = {
    typeName = "PKG_EurekaTrain_NormalSpin",
    typeId = 37511,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_EurekaTrain_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.EurekaTrain.Cell>
        --[[
        freeType 普通 0 免费1  直接落地就是2
        ]]
        o.freeType = 0 -- Int32
        --[[
        trainType火车类型 不是火车就是 0  是火车 就会1234   分别表示 A{3*5}，B{3*5 Double}，C{3*7}，D{3*7 Double}
        ]]
        o.trainType = 0 -- Int32
        --[[
        (符合连线规则)
...
PKG_EurekaTrain_NormalSpin.__index = PKG_EurekaTrain_NormalSpin

--[[
Sugar请求免费旋转图形
]]
PKG_EurekaTrain_SpecialSpin = {
    typeName = "PKG_EurekaTrain_SpecialSpin",
    typeId = 37514,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_EurekaTrain_SpecialSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.winCoin = 0 -- Double
        o.graphs = {} -- List<PKG.EurekaTrain.Graph>
        --[[
        转盘次数为0时，返回的Bonus Win
        ]]
        o.bonusWinCoin = 0 -- Double
    ...
    Read = function(self, om)
        ...
        self.graphs = o
        for i = 1, len do
            o[i] = PKG_EurekaTrain_Graph.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- bonusWinCoin
        ...
        if r ~= 0 then return r end
        -- isFull
        r, self.isFull = d:Rvi32()
        if r ~= 0 then return r end
        -- extraSpin
        r, self.extraSpin = d:Rvi32()
        if r ~= 0 then return r end
        -- trainType
        r, self.trainType = d:Rvi32()
        if r ~= 0 then return r end
        -- AllWinCoin
        r, self.AllWinCoin = d:Rd()
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        ...
        d:Wvi32(self.isFull)
        -- extraSpin
        d:Wvi32(self.extraSpin)
        -- trainType
        d:Wvi32(self.trainType)
        -- AllWinCoin
        d:Wd(self.AllWinCoin)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_EurekaTrain_SpecialSpin.__index = PKG_EurekaTrain_SpecialSpin
...
PKG_Slots_Client_EurekaTrainNormalRet = {
    typeName = "PKG_Slots_Client_EurekaTrainNormalRet",
    typeId = 37519,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_EurekaTrainNormalRet)
        end
        o.normalSpin = PKG_EurekaTrain_NormalSpin.Create() -- PKG.EurekaTrain.NormalSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- normalSpin
        self.normalSpin = PKG_EurekaTrain_NormalSpin.Create(); r = self.normalSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_EurekaTrainNormalRet.__index = PKG_Slots_Client_EurekaTrainNormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_EurekaTrainFreeTypeRet = {
    typeName = "PKG_Slots_Client_EurekaTrainFreeTypeRet",
    typeId = 37520,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_EurekaTrainFreeTypeRet)
        end
        o.freetype = PKG_EurekaTrain_FreeType.Create() -- PKG.EurekaTrain.FreeType
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- freetype
        self.freetype = PKG_EurekaTrain_FreeType.Create(); r = self.freetype:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_EurekaTrainFreeTypeRet.__index = PKG_Slots_Client_EurekaTrainFreeTypeRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_EurekaTrainFreeRet = {
    typeName = "PKG_Slots_Client_EurekaTrainFreeRet",
    typeId = 37521,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_EurekaTrainFreeRet)
        end
        o.freeSpin = PKG_EurekaTrain_FreeSpin.Create() -- PKG.EurekaTrain.FreeSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- freeSpin
        self.freeSpin = PKG_EurekaTrain_FreeSpin.Create(); r = self.freeSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_EurekaTrainFreeRet.__index = PKG_Slots_Client_EurekaTrainFreeRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_EurekaTrainSpecialRet = {
    typeName = "PKG_Slots_Client_EurekaTrainSpecialRet",
    typeId = 37522,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_EurekaTrainSpecialRet)
        end
        o.specialSpin = PKG_EurekaTrain_SpecialSpin.Create() -- PKG.EurekaTrain.SpecialSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- specialSpin
        self.specialSpin = PKG_EurekaTrain_SpecialSpin.Create(); r = self.specialSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_EurekaTrainSpecialRet.__index = PKG_Slots_Client_EurekaTrainSpecialRet
...
PKG_Slots_Client_EurekaTrainEnterResumed = {
    typeName = "PKG_Slots_Client_EurekaTrainEnterResumed",
    typeId = 37523,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_EurekaTrainEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_EurekaTrainNormalRet.Create() -- PKG.Slots_Client.EurekaTrainNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFreeType = PKG_Slots_Client_EurekaTrainFreeTypeRet.Create() -- PKG.Slots_Client.EurekaTrainFreeTypeRet
        --[[
        恢复特殊游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_EurekaTrainFreeRet.Create() -- PKG.Slots_Client.EurekaTrainFreeRet
        --[[
        恢复特殊游戏结果
        ]]
        o.resumedSpecial = PKG_Slots_Client_EurekaTrainSpecialRet.Create() -- PKG.Slots_Client.EurekaTrainSpecialRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_EurekaTrainNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeType
        self.resumedFreeType = PKG_Slots_Client_EurekaTrainFreeTypeRet.Create(); r = self.resumedFreeType:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_EurekaTrainFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        -- resumedSpecial
        self.resumedSpecial = PKG_Slots_Client_EurekaTrainSpecialRet.Create(); r = self.resumedSpecial:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_EurekaTrainEnterResumed.__index = PKG_Slots_Client_EurekaTrainEnterResumed

--[[
请求特殊旋转图形
]]
PKG_Client_Slots_EurekaTrainSpecialSpin = {
    typeName = "PKG_Client_Slots_EurekaTrainSpecialSpin",
    typeId = 37518,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_EurekaTrainSpecialSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_EurekaTrainSpecialSpin.__index = PKG_Client_Slots_EurekaTrainSpecialSpin

--[[
请求免费旋转图形
]]
PKG_Client_Slots_EurekaTrainFreeSpin = {
    typeName = "PKG_Client_Slots_EurekaTrainFreeSpin",
    typeId = 37517,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_EurekaTrainFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_EurekaTrainFreeSpin.__index = PKG_Client_Slots_EurekaTrainFreeSpin

--[[
财富之眼 请求免费类型
]]
PKG_Client_Slots_EurekaTrainFreeType = {
    typeName = "PKG_Client_Slots_EurekaTrainFreeType",
    typeId = 37516,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_EurekaTrainFreeType)
        end
        o.type = 1 -- Int32
        return o
    end,
...
PKG_Client_Slots_EurekaTrainFreeType.__index = PKG_Client_Slots_EurekaTrainFreeType

--[[
财富之眼  普通旋转
]]
PKG_Client_Slots_EurekaTrainNormalSpin = {
    typeName = "PKG_Client_Slots_EurekaTrainNormalSpin",
    typeId = 37515,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_EurekaTrainNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_EurekaTrainNormalSpin.__index = PKG_Client_Slots_EurekaTrainNormalSpin
...
PKG_EurekaTrain_Cell = {
    typeName = "PKG_EurekaTrain_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_EurekaTrain_Cell)
        end
        --[[
        点对应下标
        ]]
    ...
    Write = function(self, om)
        ...
        -- trainStart
        d:Wvi32(self.trainStart)
    end
}
PKG_EurekaTrain_Cell.__index = PKG_EurekaTrain_Cell

PKG_EurekaTrain_Line = {
    typeName = "PKG_EurekaTrain_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_EurekaTrain_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.EurekaTrain.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_EurekaTrain_Line.__index = PKG_EurekaTrain_Line
...
PKG_EurekaTrain_Graph = {
    typeName = "PKG_EurekaTrain_Graph",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_EurekaTrain_Graph)
        end
        o.grids = {} -- List<PKG.EurekaTrain.Cell>
        o.lines = {} -- List<PKG.EurekaTrain.Line>
        return o
...
PKG_EurekaTrain_Graph.__index = PKG_EurekaTrain_Graph
...
local o = ObjMgr
o.Register(PKG_EurekaTrain_FreeSpin)
o.Register(PKG_EurekaTrain_FreeType)
o.Register(PKG_EurekaTrain_NormalSpin)
o.Register(PKG_EurekaTrain_SpecialSpin)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_EurekaTrainNormalRet)
o.Register(PKG_Slots_Client_EurekaTrainFreeTypeRet)
o.Register(PKG_Slots_Client_EurekaTrainFreeRet)
o.Register(PKG_Slots_Client_EurekaTrainSpecialRet)
...
o.Register(PKG_Slots_Client_EurekaTrainEnterResumed)
o.Register(PKG_Client_Slots_EurekaTrainSpecialSpin)
o.Register(PKG_Client_Slots_EurekaTrainFreeSpin)
o.Register(PKG_Client_Slots_EurekaTrainFreeType)
o.Register(PKG_Client_Slots_EurekaTrainNormalSpin)
