...
CodeGen_slot_293_md5 ="#*MD5<cde639fc4630659f2ae2624dbb69cc93>*#"

--[[
Sugar请求特殊旋转图形
]]
PKG_KinsRapid_NormalSpin = {
    typeName = "PKG_KinsRapid_NormalSpin",
    typeId = 30741,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_KinsRapid_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.KinsRapid.Cell>
        o.wildBet = 0 -- Int32
        --[[
        是否进入免费游戏
        ]]
        ...
        o.lines = {} -- List<PKG.KinsRapid.Line>
        return o
    end,
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_KinsRapid_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- wildBet
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_KinsRapid_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_KinsRapid_NormalSpin.__index = PKG_KinsRapid_NormalSpin

--[[
免费类型选择
]]
PKG_KinsRapid_FreeType = {
    typeName = "PKG_KinsRapid_FreeType",
    typeId = 30742,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_KinsRapid_FreeType)
        end
        --[[
        倍率类型
        ]]
...
PKG_KinsRapid_FreeType.__index = PKG_KinsRapid_FreeType

--[[
Sugar请求免费旋转图形
]]
PKG_KinsRapid_FreeSpin = {
    typeName = "PKG_KinsRapid_FreeSpin",
    typeId = 30743,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_KinsRapid_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_KinsRapid_FreeSpin.__index = PKG_KinsRapid_FreeSpin

--[[
狂野蛮牛-普通结果
]]
PKG_Slots_Client_KinsRapidNormalRet = {
    typeName = "PKG_Slots_Client_KinsRapidNormalRet", -- : PKG_KinsRapid_NormalSpin
    typeId = 30747,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_KinsRapidNormalRet)
        end
        PKG_KinsRapid_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_KinsRapid_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_KinsRapid_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_KinsRapidNormalRet.__index = PKG_Slots_Client_KinsRapidNormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_KinsRapidFreeRetType = {
    typeName = "PKG_Slots_Client_KinsRapidFreeRetType", -- : PKG_KinsRapid_FreeType
    typeId = 30748,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_KinsRapidFreeRetType)
        end
        PKG_KinsRapid_FreeType.Create(o)
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- base read
        r = PKG_KinsRapid_FreeType.Read(self, om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_KinsRapid_FreeType.Write(self, om)
    end
}
PKG_Slots_Client_KinsRapidFreeRetType.__index = PKG_Slots_Client_KinsRapidFreeRetType

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_KinsRapidFreeRet = {
    typeName = "PKG_Slots_Client_KinsRapidFreeRet", -- : PKG_KinsRapid_FreeSpin
    typeId = 30749,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_KinsRapidFreeRet)
        end
        PKG_KinsRapid_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_KinsRapid_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_KinsRapid_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_KinsRapidFreeRet.__index = PKG_Slots_Client_KinsRapidFreeRet
...
PKG_Client_Slots_KinsRapidFreeSpin = {
    typeName = "PKG_Client_Slots_KinsRapidFreeSpin",
    typeId = 30746,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_KinsRapidFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_KinsRapidFreeSpin.__index = PKG_Client_Slots_KinsRapidFreeSpin
...
PKG_Slots_Client_KinsRapidEnterResumed = {
    typeName = "PKG_Slots_Client_KinsRapidEnterResumed",
    typeId = 30750,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_KinsRapidEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_KinsRapidNormalRet.Create() -- PKG.Slots_Client.KinsRapidNormalRet
        --[[
        恢复免费游戏类型
        ]]
        o.freeType = PKG_Slots_Client_KinsRapidFreeRetType.Create() -- PKG.Slots_Client.KinsRapidFreeRetType
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_KinsRapidFreeRet.Create() -- PKG.Slots_Client.KinsRapidFreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_KinsRapidNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- freeType
        self.freeType = PKG_Slots_Client_KinsRapidFreeRetType.Create(); r = self.freeType:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_KinsRapidFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_KinsRapidEnterResumed.__index = PKG_Slots_Client_KinsRapidEnterResumed

--[[
发财树 请求免费类型
]]
PKG_Client_Slots_KinsRapidFreeType = {
    typeName = "PKG_Client_Slots_KinsRapidFreeType",
    typeId = 30745,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_KinsRapidFreeType)
        end
        --[[
        押注类型
        ]]
...
PKG_Client_Slots_KinsRapidFreeType.__index = PKG_Client_Slots_KinsRapidFreeType

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_KinsRapidNormalSpin = {
    typeName = "PKG_Client_Slots_KinsRapidNormalSpin",
    typeId = 30744,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_KinsRapidNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_KinsRapidNormalSpin.__index = PKG_Client_Slots_KinsRapidNormalSpin
...
PKG_KinsRapid_Cell = {
    typeName = "PKG_KinsRapid_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_KinsRapid_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_KinsRapid_Cell.__index = PKG_KinsRapid_Cell

PKG_KinsRapid_Line = {
    typeName = "PKG_KinsRapid_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_KinsRapid_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.KinsRapid.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_KinsRapid_Line.__index = PKG_KinsRapid_Line
...
local o = ObjMgr
o.Register(PKG_KinsRapid_NormalSpin)
o.Register(PKG_KinsRapid_FreeType)
o.Register(PKG_KinsRapid_FreeSpin)
o.Register(PKG_Slots_Client_KinsRapidNormalRet)
o.Register(PKG_Slots_Client_KinsRapidFreeRetType)
o.Register(PKG_Slots_Client_KinsRapidFreeRet)
...
o.Register(PKG_Client_Slots_KinsRapidFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_KinsRapidEnterResumed)
o.Register(PKG_Client_Slots_KinsRapidFreeType)
o.Register(PKG_Client_Slots_KinsRapidNormalSpin)
