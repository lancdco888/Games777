...
CodeGen_slot_310_md5 ="#*MD5<6c9b07814536cca376efbd3e126f46a3>*#"

--[[
Sugar请求特殊旋转图形
]]
PKG_TreeWealth_NormalSpin = {
    typeName = "PKG_TreeWealth_NormalSpin",
    typeId = 30791,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_TreeWealth_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.TreeWealth.Cell>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
        ...
        o.lines = {} -- List<PKG.TreeWealth.Line>
        --[[
        是否进入收集游戏
        ]]
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_TreeWealth_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_TreeWealth_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoCollect
...
PKG_TreeWealth_NormalSpin.__index = PKG_TreeWealth_NormalSpin

--[[
免费类型选择
]]
PKG_TreeWealth_FreeType = {
    typeName = "PKG_TreeWealth_FreeType",
    typeId = 30792,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_TreeWealth_FreeType)
        end
        --[[
        倍率类型
        ]]
...
PKG_TreeWealth_FreeType.__index = PKG_TreeWealth_FreeType

--[[
Sugar请求特殊旋转图形
]]
PKG_TreeWealth_FreeSpin = {
    typeName = "PKG_TreeWealth_FreeSpin",
    typeId = 30793,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_TreeWealth_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_TreeWealth_FreeSpin.__index = PKG_TreeWealth_FreeSpin

--[[
财富之树-普通结果
]]
PKG_Slots_Client_TreeWealthNormalRet = {
    typeName = "PKG_Slots_Client_TreeWealthNormalRet", -- : PKG_TreeWealth_NormalSpin
    typeId = 30797,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_TreeWealthNormalRet)
        end
        PKG_TreeWealth_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_TreeWealth_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_TreeWealth_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_TreeWealthNormalRet.__index = PKG_Slots_Client_TreeWealthNormalRet

--[[
财富之树 免费游戏结果
]]
PKG_Slots_Client_TreeWealthFreeRetType = {
    typeName = "PKG_Slots_Client_TreeWealthFreeRetType", -- : PKG_TreeWealth_FreeType
    typeId = 30798,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_TreeWealthFreeRetType)
        end
        PKG_TreeWealth_FreeType.Create(o)
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- base read
        r = PKG_TreeWealth_FreeType.Read(self, om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_TreeWealth_FreeType.Write(self, om)
    end
}
PKG_Slots_Client_TreeWealthFreeRetType.__index = PKG_Slots_Client_TreeWealthFreeRetType

--[[
财富之树 免费游戏结果
]]
PKG_Slots_Client_TreeWealthFreeRet = {
    typeName = "PKG_Slots_Client_TreeWealthFreeRet", -- : PKG_TreeWealth_FreeSpin
    typeId = 30799,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_TreeWealthFreeRet)
        end
        PKG_TreeWealth_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_TreeWealth_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_TreeWealth_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_TreeWealthFreeRet.__index = PKG_Slots_Client_TreeWealthFreeRet
...
PKG_Client_Slots_TreeWealthFreeSpin = {
    typeName = "PKG_Client_Slots_TreeWealthFreeSpin",
    typeId = 30796,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_TreeWealthFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_TreeWealthFreeSpin.__index = PKG_Client_Slots_TreeWealthFreeSpin
...
PKG_Slots_Client_TreeWealthEnterResumed = {
    typeName = "PKG_Slots_Client_TreeWealthEnterResumed",
    typeId = 30800,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_TreeWealthEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_TreeWealthNormalRet.Create() -- PKG.Slots_Client.TreeWealthNormalRet
        --[[
        恢复免费游戏类型
        ]]
        o.resumedFreeTypeRet = PKG_Slots_Client_TreeWealthFreeRetType.Create() -- PKG.Slots_Client.TreeWealthFreeRetType
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFreeRet = PKG_Slots_Client_TreeWealthFreeRet.Create() -- PKG.Slots_Client.TreeWealthFreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_TreeWealthNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeTypeRet
        self.resumedFreeTypeRet = PKG_Slots_Client_TreeWealthFreeRetType.Create(); r = self.resumedFreeTypeRet:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeRet
        self.resumedFreeRet = PKG_Slots_Client_TreeWealthFreeRet.Create(); r = self.resumedFreeRet:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_TreeWealthEnterResumed.__index = PKG_Slots_Client_TreeWealthEnterResumed

--[[
发财树 请求免费类型
]]
PKG_Client_Slots_TreeWealthFreeType = {
    typeName = "PKG_Client_Slots_TreeWealthFreeType",
    typeId = 30795,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_TreeWealthFreeType)
        end
        --[[
        押注类型
        ]]
...
PKG_Client_Slots_TreeWealthFreeType.__index = PKG_Client_Slots_TreeWealthFreeType

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_TreeWealthNormalSpin = {
    typeName = "PKG_Client_Slots_TreeWealthNormalSpin",
    typeId = 30794,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_TreeWealthNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_TreeWealthNormalSpin.__index = PKG_Client_Slots_TreeWealthNormalSpin
...
PKG_TreeWealth_Cell = {
    typeName = "PKG_TreeWealth_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_TreeWealth_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_TreeWealth_Cell.__index = PKG_TreeWealth_Cell

PKG_TreeWealth_Line = {
    typeName = "PKG_TreeWealth_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_TreeWealth_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.TreeWealth.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_TreeWealth_Line.__index = PKG_TreeWealth_Line
...
local o = ObjMgr
o.Register(PKG_TreeWealth_NormalSpin)
o.Register(PKG_TreeWealth_FreeType)
o.Register(PKG_TreeWealth_FreeSpin)
o.Register(PKG_Slots_Client_TreeWealthNormalRet)
o.Register(PKG_Slots_Client_TreeWealthFreeRetType)
o.Register(PKG_Slots_Client_TreeWealthFreeRet)
...
o.Register(PKG_Client_Slots_TreeWealthFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_TreeWealthEnterResumed)
o.Register(PKG_Client_Slots_TreeWealthFreeType)
o.Register(PKG_Client_Slots_TreeWealthNormalSpin)
