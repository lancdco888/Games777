...
require('g_net')
CodeGen_slot_274_md5 ="#*MD5<2f23c708b43e96218f69127712f09931>*#"

--[[
Sugar请求特殊旋转图形
]]
PKG_fafafa_WealthGold_NormalSpin = {
    typeName = "PKG_fafafa_WealthGold_NormalSpin",
    typeId = 30601,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_fafafa_WealthGold_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.fafafa_WealthGold.Cell>
        o.wildBet = 0 -- Int32
        --[[
        是否进入免费游戏
        ]]
        ...
        o.lines = {} -- List<PKG.fafafa_WealthGold.Line>
        return o
    end,
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_fafafa_WealthGold_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- wildBet
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_fafafa_WealthGold_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_fafafa_WealthGold_NormalSpin.__index = PKG_fafafa_WealthGold_NormalSpin

--[[
免费类型选择
]]
PKG_fafafa_WealthGold_FreeType = {
    typeName = "PKG_fafafa_WealthGold_FreeType",
    typeId = 30602,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_fafafa_WealthGold_FreeType)
        end
        --[[
        倍率类型
        ]]
...
PKG_fafafa_WealthGold_FreeType.__index = PKG_fafafa_WealthGold_FreeType

--[[
Sugar请求免费旋转图形
]]
PKG_fafafa_WealthGold_FreeSpin = {
    typeName = "PKG_fafafa_WealthGold_FreeSpin",
    typeId = 30603,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_fafafa_WealthGold_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_fafafa_WealthGold_FreeSpin.__index = PKG_fafafa_WealthGold_FreeSpin

--[[
狂野蛮牛-普通结果
]]
PKG_Slots_Client_fafafa_WealthGoldNormalRet = {
    typeName = "PKG_Slots_Client_fafafa_WealthGoldNormalRet", -- : PKG_fafafa_WealthGold_NormalSpin
    typeId = 30607,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_fafafa_WealthGoldNormalRet)
        end
        PKG_fafafa_WealthGold_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_fafafa_WealthGold_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_fafafa_WealthGold_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_fafafa_WealthGoldNormalRet.__index = PKG_Slots_Client_fafafa_WealthGoldNormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_fafafa_WealthGoldFreeRetType = {
    typeName = "PKG_Slots_Client_fafafa_WealthGoldFreeRetType", -- : PKG_fafafa_WealthGold_FreeType
    typeId = 30608,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_fafafa_WealthGoldFreeRetType)
        end
        PKG_fafafa_WealthGold_FreeType.Create(o)
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- base read
        r = PKG_fafafa_WealthGold_FreeType.Read(self, om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_fafafa_WealthGold_FreeType.Write(self, om)
    end
}
PKG_Slots_Client_fafafa_WealthGoldFreeRetType.__index = PKG_Slots_Client_fafafa_WealthGoldFreeRetType

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_fafafa_WealthGoldFreeRet = {
    typeName = "PKG_Slots_Client_fafafa_WealthGoldFreeRet", -- : PKG_fafafa_WealthGold_FreeSpin
    typeId = 30609,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_fafafa_WealthGoldFreeRet)
        end
        PKG_fafafa_WealthGold_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_fafafa_WealthGold_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_fafafa_WealthGold_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_fafafa_WealthGoldFreeRet.__index = PKG_Slots_Client_fafafa_WealthGoldFreeRet
...
PKG_Client_Slots_fafafa_WealthGoldFreeSpin = {
    typeName = "PKG_Client_Slots_fafafa_WealthGoldFreeSpin",
    typeId = 30606,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_fafafa_WealthGoldFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_fafafa_WealthGoldFreeSpin.__index = PKG_Client_Slots_fafafa_WealthGoldFreeSpin
...
PKG_Slots_Client_fafafa_WealthGoldEnterResumed = {
    typeName = "PKG_Slots_Client_fafafa_WealthGoldEnterResumed",
    typeId = 30610,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_fafafa_WealthGoldEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_fafafa_WealthGoldNormalRet.Create() -- PKG.Slots_Client.fafafa_WealthGoldNormalRet
        --[[
        恢复免费游戏类型
        ]]
        o.freeType = PKG_Slots_Client_fafafa_WealthGoldFreeRetType.Create() -- PKG.Slots_Client.fafafa_WealthGoldFreeRetType
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_fafafa_WealthGoldFreeRet.Create() -- PKG.Slots_Client.fafafa_WealthGoldFreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_fafafa_WealthGoldNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- freeType
        self.freeType = PKG_Slots_Client_fafafa_WealthGoldFreeRetType.Create(); r = self.freeType:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_fafafa_WealthGoldFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_fafafa_WealthGoldEnterResumed.__index = PKG_Slots_Client_fafafa_WealthGoldEnterResumed

--[[
发财树 请求免费类型
]]
PKG_Client_Slots_fafafa_WealthGoldFreeType = {
    typeName = "PKG_Client_Slots_fafafa_WealthGoldFreeType",
    typeId = 30605,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_fafafa_WealthGoldFreeType)
        end
        --[[
        押注类型
        ]]
...
PKG_Client_Slots_fafafa_WealthGoldFreeType.__index = PKG_Client_Slots_fafafa_WealthGoldFreeType

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_fafafa_WealthGoldNormalSpin = {
    typeName = "PKG_Client_Slots_fafafa_WealthGoldNormalSpin",
    typeId = 30604,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_fafafa_WealthGoldNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_fafafa_WealthGoldNormalSpin.__index = PKG_Client_Slots_fafafa_WealthGoldNormalSpin
...
PKG_fafafa_WealthGold_Cell = {
    typeName = "PKG_fafafa_WealthGold_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_fafafa_WealthGold_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_fafafa_WealthGold_Cell.__index = PKG_fafafa_WealthGold_Cell

PKG_fafafa_WealthGold_Line = {
    typeName = "PKG_fafafa_WealthGold_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_fafafa_WealthGold_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.fafafa_WealthGold.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_fafafa_WealthGold_Line.__index = PKG_fafafa_WealthGold_Line
...
local o = ObjMgr
o.Register(PKG_fafafa_WealthGold_NormalSpin)
o.Register(PKG_fafafa_WealthGold_FreeType)
o.Register(PKG_fafafa_WealthGold_FreeSpin)
o.Register(PKG_Slots_Client_fafafa_WealthGoldNormalRet)
o.Register(PKG_Slots_Client_fafafa_WealthGoldFreeRetType)
o.Register(PKG_Slots_Client_fafafa_WealthGoldFreeRet)
...
o.Register(PKG_Client_Slots_fafafa_WealthGoldFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_fafafa_WealthGoldEnterResumed)
o.Register(PKG_Client_Slots_fafafa_WealthGoldFreeType)
o.Register(PKG_Client_Slots_fafafa_WealthGoldNormalSpin)
