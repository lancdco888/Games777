...
CodeGen_slot_305_md5 ="#*MD5<f742d4fb5c6dc7cc7522d6fb20604a8f>*#"

--[[
Sugar请求特殊旋转图形
]]
PKG_RedEmpress_NormalSpin = {
    typeName = "PKG_RedEmpress_NormalSpin",
    typeId = 30821,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_RedEmpress_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.RedEmpress.Cell>
        --[[
        哪些图标会换成替代
        ]]
        ...
        o.randIntoFree = 0 -- Int32
        --[[
        (符合连线规则)
        ]]
        o.lines = {} -- List<PKG.RedEmpress.Line>
        return o
    end,
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_RedEmpress_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- changeWild
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_RedEmpress_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_RedEmpress_NormalSpin.__index = PKG_RedEmpress_NormalSpin

--[[
Sugar请求免费旋转图形
]]
PKG_RedEmpress_FreeSpin = {
    typeName = "PKG_RedEmpress_FreeSpin",
    typeId = 30822,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_RedEmpress_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_RedEmpress_FreeSpin.__index = PKG_RedEmpress_FreeSpin
...
PKG_Slots_Client_RedEmpressNormalRet = {
    typeName = "PKG_Slots_Client_RedEmpressNormalRet", -- : PKG_RedEmpress_NormalSpin
    typeId = 30825,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_RedEmpressNormalRet)
        end
        PKG_RedEmpress_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_RedEmpress_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_RedEmpress_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_RedEmpressNormalRet.__index = PKG_Slots_Client_RedEmpressNormalRet

--[[
财神赐宝 免费游戏结果
]]
PKG_Slots_Client_RedEmpressFreeRet = {
    typeName = "PKG_Slots_Client_RedEmpressFreeRet", -- : PKG_RedEmpress_FreeSpin
    typeId = 30826,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_RedEmpressFreeRet)
        end
        PKG_RedEmpress_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_RedEmpress_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_RedEmpress_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_RedEmpressFreeRet.__index = PKG_Slots_Client_RedEmpressFreeRet
...
PKG_Client_Slots_RedEmpressFreeSpin = {
    typeName = "PKG_Client_Slots_RedEmpressFreeSpin",
    typeId = 30824,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_RedEmpressFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_RedEmpressFreeSpin.__index = PKG_Client_Slots_RedEmpressFreeSpin
...
PKG_Slots_Client_RedEmpressEnterResumed = {
    typeName = "PKG_Slots_Client_RedEmpressEnterResumed",
    typeId = 30827,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_RedEmpressEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_RedEmpressNormalRet.Create() -- PKG.Slots_Client.RedEmpressNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_RedEmpressFreeRet.Create() -- PKG.Slots_Client.RedEmpressFreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_RedEmpressNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_RedEmpressFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_RedEmpressEnterResumed.__index = PKG_Slots_Client_RedEmpressEnterResumed

--[[
财神赐宝  普通旋转
]]
PKG_Client_Slots_RedEmpressNormalSpin = {
    typeName = "PKG_Client_Slots_RedEmpressNormalSpin",
    typeId = 30823,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_RedEmpressNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_RedEmpressNormalSpin.__index = PKG_Client_Slots_RedEmpressNormalSpin
...
PKG_RedEmpress_Cell = {
    typeName = "PKG_RedEmpress_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_RedEmpress_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_RedEmpress_Cell.__index = PKG_RedEmpress_Cell

PKG_RedEmpress_Line = {
    typeName = "PKG_RedEmpress_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_RedEmpress_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.RedEmpress.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_RedEmpress_Line.__index = PKG_RedEmpress_Line
...
local o = ObjMgr
o.Register(PKG_RedEmpress_NormalSpin)
o.Register(PKG_RedEmpress_FreeSpin)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_RedEmpressNormalRet)
o.Register(PKG_Slots_Client_RedEmpressFreeRet)
o.Register(PKG_Slots_Client_Leave_Success)
o.Register(PKG_Client_Slots_RedEmpressFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_RedEmpressEnterResumed)
o.Register(PKG_Client_Slots_RedEmpressNormalSpin)
