...
CodeGen_slot_278_md5 ="#*MD5<7d26f8eebf48cef698045b69dba424be>*#"

--[[
生成图形数组和相关结果的基类
]]
PKG_RichFish_NormalSpin = {
    typeName = "PKG_RichFish_NormalSpin",
    typeId = 30661,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_RichFish_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.RichFish.Cell>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
        ...
        o.lines = {} -- List<PKG.RichFish.Line>
        --[[
        是否进入收集游戏
        ]]
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_RichFish_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_RichFish_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoCollect
...
PKG_RichFish_NormalSpin.__index = PKG_RichFish_NormalSpin

--[[
生成图形数组和相关结果的基类
]]
PKG_RichFish_FreeSpin = {
    typeName = "PKG_RichFish_FreeSpin",
    typeId = 30662,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_RichFish_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
    ...
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- freeA
        r, self.freeA = d:Rvi32()
        if r ~= 0 then return r end
        -- freeB
        r, self.freeB = d:Rvi32()
        if r ~= 0 then return r end
        -- freeC
        r, self.freeC = d:Rvi32()
        if r ~= 0 then return r end
        -- intoCollect
        r, self.intoCollect = d:Rvi32()
        if r ~= 0 then return r end
...
PKG_RichFish_FreeSpin.__index = PKG_RichFish_FreeSpin
...
PKG_Slots_Client_RichFishNormalRet = {
    typeName = "PKG_Slots_Client_RichFishNormalRet", -- : PKG_RichFish_NormalSpin
    typeId = 30665,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_RichFishNormalRet)
        end
        PKG_RichFish_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_RichFish_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_RichFish_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_RichFishNormalRet.__index = PKG_Slots_Client_RichFishNormalRet

--[[
Sugar-彩虹触发的免费游戏结果
]]
PKG_Slots_Client_RichFishFreeRet = {
    typeName = "PKG_Slots_Client_RichFishFreeRet", -- : PKG_RichFish_FreeSpin
    typeId = 30666,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_RichFishFreeRet)
        end
        PKG_RichFish_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        o.levelUpMoney = 0 -- Int64
        o.levelUpMoneys = {} -- List<Int64>
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_RichFish_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_RichFish_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_RichFishFreeRet.__index = PKG_Slots_Client_RichFishFreeRet
...
PKG_Client_Slots_RichFishFreeSpin = {
    typeName = "PKG_Client_Slots_RichFishFreeSpin",
    typeId = 30664,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_RichFishFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_RichFishFreeSpin.__index = PKG_Client_Slots_RichFishFreeSpin
...
PKG_Slots_Client_RichFishEnterResumed = {
    typeName = "PKG_Slots_Client_RichFishEnterResumed",
    typeId = 30667,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_RichFishEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_RichFishNormalRet.Create() -- PKG.Slots_Client.RichFishNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_RichFishFreeRet.Create() -- PKG.Slots_Client.RichFishFreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_RichFishNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_RichFishFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_RichFishEnterResumed.__index = PKG_Slots_Client_RichFishEnterResumed

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_RichFishNormalSpin = {
    typeName = "PKG_Client_Slots_RichFishNormalSpin",
    typeId = 30663,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_RichFishNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_RichFishNormalSpin.__index = PKG_Client_Slots_RichFishNormalSpin
...
PKG_RichFish_Cell = {
    typeName = "PKG_RichFish_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_RichFish_Cell)
        end
        --[[
        点对应下标
        ]]
        ...
        o.type = 0 -- Int32
        o.wildValue = 0 -- Double
        o.wildValue2 = 0 -- Double
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- wildValue
        r, self.wildValue = d:Rd()
        if r ~= 0 then return r end
        -- wildValue2
        r, self.wildValue2 = d:Rd()
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
        ...
        d:Wd(self.wildValue)
        -- wildValue2
        d:Wd(self.wildValue2)
    end
}
PKG_RichFish_Cell.__index = PKG_RichFish_Cell

PKG_RichFish_Line = {
    typeName = "PKG_RichFish_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_RichFish_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.RichFish.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_RichFish_Line.__index = PKG_RichFish_Line
...
local o = ObjMgr
o.Register(PKG_RichFish_NormalSpin)
o.Register(PKG_RichFish_FreeSpin)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_RichFishNormalRet)
o.Register(PKG_Slots_Client_RichFishFreeRet)
o.Register(PKG_Slots_Client_Leave_Success)
o.Register(PKG_Client_Slots_RichFishFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_RichFishEnterResumed)
o.Register(PKG_Client_Slots_RichFishNormalSpin)
