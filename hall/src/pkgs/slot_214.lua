...
CodeGen_slot_214_md5 ="#*MD5<a1d881488d0710aeb371e1ce5a354b0d>*#"

PKG_GrandDragons_GrandDragonsSymbol = {
    SymbolCaibao = 1,
    SymbolWild = 2,
    SymbolJingui = 3,
    SymbolJinyu = 4,
...
PKG_GrandDragons_GrandDragonsBase = {
    typeName = "PKG_GrandDragons_GrandDragonsBase",
    typeId = 30251,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_GrandDragons_GrandDragonsBase)
        end
        --[[
        (一次旋转押注 免费游戏为0)
        ]]
        ...
        o.grids = {} -- List<PKG.GrandDragons.Cell>
        return o
    end,
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_GrandDragons_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_GrandDragons_GrandDragonsBase.__index = PKG_GrandDragons_GrandDragonsBase
...
PKG_Slots_Client_GrandDragonsNormalRet = {
    typeName = "PKG_Slots_Client_GrandDragonsNormalRet", -- : PKG_GrandDragons_GrandDragonsBase
    typeId = 30255,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_GrandDragonsNormalRet)
        end
        PKG_GrandDragons_GrandDragonsBase.Create(o)
        --[[
        是否进入免费游戏
        ]]
        o.avatarId = 0 -- Int32
        ...
        o.lines = {} -- List<PKG.GrandDragons.Line>
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_GrandDragons_GrandDragonsBase.Read(self, om)
        if r ~= 0 then return r end
        -- avatarId
        r, self.avatarId = d:Rvi32()
        if r ~= 0 then return r end
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_GrandDragons_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_GrandDragons_GrandDragonsBase.Write(self, om)
        -- avatarId
        d:Wvi32(self.avatarId)
        -- lines
        o = self.lines
...
PKG_Slots_Client_GrandDragonsNormalRet.__index = PKG_Slots_Client_GrandDragonsNormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_GrandDragonsFreeRetType = {
    typeName = "PKG_Slots_Client_GrandDragonsFreeRetType",
    typeId = 30256,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_GrandDragonsFreeRetType)
        end
        --[[
        返回免费的次数
        ]]
...
PKG_Slots_Client_GrandDragonsFreeRetType.__index = PKG_Slots_Client_GrandDragonsFreeRetType

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_GrandDragonsFreeRet = {
    typeName = "PKG_Slots_Client_GrandDragonsFreeRet", -- : PKG_GrandDragons_GrandDragonsBase
    typeId = 30257,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_GrandDragonsFreeRet)
        end
        PKG_GrandDragons_GrandDragonsBase.Create(o)
        --[[
...
PKG_Slots_Client_GrandDragonsFreeRet.__index = PKG_Slots_Client_GrandDragonsFreeRet

--[[
Sugar请求特殊旋转图形
]]
PKG_Client_Slots_GrandDragonsFreeSpin = {
    typeName = "PKG_Client_Slots_GrandDragonsFreeSpin",
    typeId = 30254,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_GrandDragonsFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_GrandDragonsFreeSpin.__index = PKG_Client_Slots_GrandDragonsFreeSpin
...
PKG_Client_Slots_GrandDragonsNormalSpin = {
    typeName = "PKG_Client_Slots_GrandDragonsNormalSpin",
    typeId = 30252,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_GrandDragonsNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_GrandDragonsNormalSpin.__index = PKG_Client_Slots_GrandDragonsNormalSpin
...
PKG_Slots_Client_GrandDragonsEnterResumed = {
    typeName = "PKG_Slots_Client_GrandDragonsEnterResumed",
    typeId = 30258,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_GrandDragonsEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_GrandDragonsNormalRet.Create() -- PKG.Slots_Client.GrandDragonsNormalRet
        --[[
        恢复免费游戏类型
        ]]
        o.resumedFreeType = PKG_Slots_Client_GrandDragonsFreeRetType.Create() -- PKG.Slots_Client.GrandDragonsFreeRetType
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFreeRet = PKG_Slots_Client_GrandDragonsFreeRet.Create() -- PKG.Slots_Client.GrandDragonsFreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_GrandDragonsNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeType
        self.resumedFreeType = PKG_Slots_Client_GrandDragonsFreeRetType.Create(); r = self.resumedFreeType:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeRet
        self.resumedFreeRet = PKG_Slots_Client_GrandDragonsFreeRet.Create(); r = self.resumedFreeRet:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_GrandDragonsEnterResumed.__index = PKG_Slots_Client_GrandDragonsEnterResumed

--[[
发财树 请求免费类型
]]
PKG_Client_Slots_GrandDragonsFreeType = {
    typeName = "PKG_Client_Slots_GrandDragonsFreeType",
    typeId = 30253,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_GrandDragonsFreeType)
        end
        --[[
        押注类型
        ]]
...
PKG_Client_Slots_GrandDragonsFreeType.__index = PKG_Client_Slots_GrandDragonsFreeType
...
PKG_GrandDragons_Cell = {
    typeName = "PKG_GrandDragons_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_GrandDragons_Cell)
        end
        --[[
        点对应下标
        ]]
        ...
        o.icon = 0 -- PKG.GrandDragons.GrandDragonsSymbol
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_GrandDragons_Cell.__index = PKG_GrandDragons_Cell
...
PKG_GrandDragons_Line = {
    typeName = "PKG_GrandDragons_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_GrandDragons_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.GrandDragons.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_GrandDragons_Line.__index = PKG_GrandDragons_Line
...
local o = ObjMgr
o.Register(PKG_GrandDragons_GrandDragonsBase)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_GrandDragonsNormalRet)
o.Register(PKG_Slots_Client_GrandDragonsFreeRetType)
o.Register(PKG_Slots_Client_GrandDragonsFreeRet)
o.Register(PKG_Client_Slots_GrandDragonsFreeSpin)
o.Register(PKG_Slots_Client_OfflineCheck)
o.Register(PKG_Slots_Client_Leave_Success)
o.Register(PKG_Client_Slots_GrandDragonsNormalSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_GrandDragonsEnterResumed)
o.Register(PKG_Client_Slots_GrandDragonsFreeType)
