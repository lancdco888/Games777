...
require('g_net')
CodeGen_slot_324_md5 ="#*MD5<71a535098ca354adf07cf06e21153bba>*#"

PKG_JuLong_FreeSpin = {
    typeName = "PKG_JuLong_FreeSpin",
    typeId = 32401,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_JuLong_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_JuLong_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- wildBet
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_JuLong_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- slotMoneyGift
...
PKG_JuLong_FreeSpin.__index = PKG_JuLong_FreeSpin

PKG_JuLong_NormalSpin = {
    typeName = "PKG_JuLong_NormalSpin",
    typeId = 32400,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_JuLong_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_JuLong_NormalSpin.__index = PKG_JuLong_NormalSpin

--[[
普通旋转
]]
PKG_Slots_Client_JuLongNormalRet = {
    typeName = "PKG_Slots_Client_JuLongNormalRet",
    typeId = 32410,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_JuLongNormalRet)
        end
        o.normalSpin = PKG_JuLong_NormalSpin.Create() -- PKG.JuLong.NormalSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- normalSpin
        self.normalSpin = PKG_JuLong_NormalSpin.Create(); r = self.normalSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_JuLongNormalRet.__index = PKG_Slots_Client_JuLongNormalRet
...
PKG_Slots_Client_JuLongTypeRet = {
    typeName = "PKG_Slots_Client_JuLongTypeRet",
    typeId = 32412,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_JuLongTypeRet)
        end
        o.selectType = PKG_JuLong_SelectType.Create() -- PKG.JuLong.SelectType
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- selectType
        self.selectType = PKG_JuLong_SelectType.Create(); r = self.selectType:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_JuLongTypeRet.__index = PKG_Slots_Client_JuLongTypeRet

--[[
免费旋转
]]
PKG_Slots_Client_JuLongFreeRet = {
    typeName = "PKG_Slots_Client_JuLongFreeRet",
    typeId = 32411,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_JuLongFreeRet)
        end
        o.freeSpin = PKG_JuLong_FreeSpin.Create() -- PKG.JuLong.FreeSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- freeSpin
        self.freeSpin = PKG_JuLong_FreeSpin.Create(); r = self.freeSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_JuLongFreeRet.__index = PKG_Slots_Client_JuLongFreeRet
...
PKG_Slots_Client_JuLongLastRes = {
    typeName = "PKG_Slots_Client_JuLongLastRes",
    typeId = 32414,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_JuLongLastRes)
        end
        o.remainData = PKG_JuLong_RemainData.Create() -- PKG.JuLong.RemainData
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- remainData
        self.remainData = PKG_JuLong_RemainData.Create(); r = self.remainData:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_JuLongLastRes.__index = PKG_Slots_Client_JuLongLastRes

--[[
断线重连
]]
PKG_Slots_Client_JuLongEnterResumed = {
    typeName = "PKG_Slots_Client_JuLongEnterResumed",
    typeId = 32413,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_JuLongEnterResumed)
        end
        --[[
        押注等级
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_JuLongNormalRet.Create() -- PKG.Slots_Client.JuLongNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_JuLongFreeRet.Create() -- PKG.Slots_Client.JuLongFreeRet
        --[[
        恢复选择状态
        ]]
        o.resumedType = PKG_Slots_Client_JuLongTypeRet.Create() -- PKG.Slots_Client.JuLongTypeRet
    ...
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_JuLongNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_JuLongFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        -- resumedType
        self.resumedType = PKG_Slots_Client_JuLongTypeRet.Create(); r = self.resumedType:Read(om)
        if r ~= 0 then return r end
        -- lastMsgType
...
PKG_Slots_Client_JuLongEnterResumed.__index = PKG_Slots_Client_JuLongEnterResumed

--[[
请求普通旋转
]]
PKG_Client_Slots_JuLongNormalSpin = {
    typeName = "PKG_Client_Slots_JuLongNormalSpin",
    typeId = 32420,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_JuLongNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_JuLongNormalSpin.__index = PKG_Client_Slots_JuLongNormalSpin
...
PKG_Client_Slots_JuLongLastReq = {
    typeName = "PKG_Client_Slots_JuLongLastReq",
    typeId = 32423,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_JuLongLastReq)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_JuLongLastReq.__index = PKG_Client_Slots_JuLongLastReq

--[[
选择免费类型
]]
PKG_Client_Slots_JuLongFreeType = {
    typeName = "PKG_Client_Slots_JuLongFreeType",
    typeId = 32422,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_JuLongFreeType)
        end
        --[[
        点击位置
        ]]
...
PKG_Client_Slots_JuLongFreeType.__index = PKG_Client_Slots_JuLongFreeType

--[[
请求免费旋转
]]
PKG_Client_Slots_JuLongFreeSpin = {
    typeName = "PKG_Client_Slots_JuLongFreeSpin",
    typeId = 32421,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_JuLongFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_JuLongFreeSpin.__index = PKG_Client_Slots_JuLongFreeSpin
...
PKG_JuLong_Cell = {
    typeName = "PKG_JuLong_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_JuLong_Cell)
        end
        --[[
        点对应下标
        ]]
    ...
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- SymbolValue
        r, self.SymbolValue = d:Rvi64()
        if r ~= 0 then return r end
        -- Symbolbet
        r, self.Symbolbet = d:Rvi32()
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
        ...
        d:Wvi32(self.icon)
        -- SymbolValue
        d:Wvi64(self.SymbolValue)
        -- Symbolbet
        d:Wvi32(self.Symbolbet)
    end
}
PKG_JuLong_Cell.__index = PKG_JuLong_Cell
...
PKG_JuLong_Line = {
    typeName = "PKG_JuLong_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_JuLong_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.cellNum = 0 -- Int32
        o.lineCells = {} -- List<PKG.JuLong.Cell>
        o.lineCells2 = {} -- List<PKG.JuLong.Cell>
        o.mode = 0 -- Int32
        return o
    end,
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- winCoin2
        r, self.winCoin2 = d:Rd()
        if r ~= 0 then return r end
        -- icon
        r, self.icon = d:Rvi32()
        if r ~= 0 then return r end
        -- icon2
        r, self.icon2 = d:Rvi32()
        if r ~= 0 then return r end
        -- cellNum
        r, self.cellNum = d:Rvi32()
        if r ~= 0 then return r end
        -- lineCells
        r, len = d:Rvu32()
        if len > d:GetLeft() then return -1 end
...
PKG_JuLong_Line.__index = PKG_JuLong_Line
...
PKG_JuLong_RemainGraph = {
    typeName = "PKG_JuLong_RemainGraph",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_JuLong_RemainGraph)
        end
        o.betMoney = 0 -- Double
        o.lvID = 0 -- Int32
        o.grids = {} -- List<PKG.JuLong.Cell>
...
PKG_JuLong_RemainGraph.__index = PKG_JuLong_RemainGraph
...
PKG_JuLong_SelectType = {
    typeName = "PKG_JuLong_SelectType",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_JuLong_SelectType)
        end
        o.index = 0 -- Int32
        o.freeTime = 0 -- Int32
        o.wildMin = 0 -- Int32
    ...
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- wildMin
        r, self.wildMin = d:Rvi32()
        if r ~= 0 then return r end
        -- wildMax
        r, self.wildMax = d:Rvi32()
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
        ...
        -- wildMin
        d:Wvi32(self.wildMin)
        -- wildMax
        d:Wvi32(self.wildMax)
    end
}
PKG_JuLong_SelectType.__index = PKG_JuLong_SelectType

PKG_JuLong_RemainData = {
    typeName = "PKG_JuLong_RemainData",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_JuLong_RemainData)
        end
        o.graphs = {} -- List<PKG.JuLong.RemainGraph>
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        self.graphs = o
        for i = 1, len do
            o[i] = PKG_JuLong_RemainGraph.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_JuLong_RemainData.__index = PKG_JuLong_RemainData
...
local o = ObjMgr
o.Register(PKG_JuLong_FreeSpin)
o.Register(PKG_JuLong_NormalSpin)
o.Register(PKG_Slots_Client_JuLongNormalRet)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_JuLongTypeRet)
o.Register(PKG_Slots_Client_JuLongFreeRet)
...
o.Register(PKG_Slots_Client_JuLongLastRes)
o.Register(PKG_Slots_Client_JuLongEnterResumed)
o.Register(PKG_Client_Slots_JuLongNormalSpin)
...
o.Register(PKG_Client_Slots_JuLongLastReq)
o.Register(PKG_Client_Slots_JuLongFreeType)
o.Register(PKG_Client_Slots_JuLongFreeSpin)
