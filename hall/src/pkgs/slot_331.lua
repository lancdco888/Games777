...
CodeGen_slot_216_md5 ="#*MD5<41aee4424304312f85747f21943c8806>*#"

PKG_Golden88_Golden88Symbol = {
    Golden88Wild = 1,
    Golden88Luo = 2,
    Golden88Long = 3,
    Golden88Zhu = 4,
...
PKG_Golden88_NormalSpin = {
    typeName = "PKG_Golden88_NormalSpin",
    typeId = 30271,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Golden88_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.Golden88.Cell>
        --[[
        替代的倍率
        ]]
        o.wildBet = 0 -- Int32
        ...
        o.lines = {} -- List<PKG.Golden88.Line>
        --[[
        是否进入收集游戏
        ]]
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_Golden88_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- wildBet
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_Golden88_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoCollect
...
PKG_Golden88_NormalSpin.__index = PKG_Golden88_NormalSpin

--[[
免费类型选择
]]
PKG_Golden88_FreeType = {
    typeName = "PKG_Golden88_FreeType",
    typeId = 30272,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Golden88_FreeType)
        end
        --[[
        倍率类型
        ]]
...
PKG_Golden88_FreeType.__index = PKG_Golden88_FreeType

--[[
Sugar请求特殊旋转图形
]]
PKG_Golden88_FreeSpin = {
    typeName = "PKG_Golden88_FreeSpin",
    typeId = 30273,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Golden88_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_Golden88_FreeSpin.__index = PKG_Golden88_FreeSpin

--[[
狂野蛮牛-普通结果
]]
PKG_Slots_Client_Golden88NormalRet = {
    typeName = "PKG_Slots_Client_Golden88NormalRet", -- : PKG_Golden88_NormalSpin
    typeId = 30277,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_Golden88NormalRet)
        end
        PKG_Golden88_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_Golden88_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_Golden88_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_Golden88NormalRet.__index = PKG_Slots_Client_Golden88NormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_Golden88FreeRetType = {
    typeName = "PKG_Slots_Client_Golden88FreeRetType", -- : PKG_Golden88_FreeType
    typeId = 30278,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_Golden88FreeRetType)
        end
        PKG_Golden88_FreeType.Create(o)
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- base read
        r = PKG_Golden88_FreeType.Read(self, om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_Golden88_FreeType.Write(self, om)
    end
}
PKG_Slots_Client_Golden88FreeRetType.__index = PKG_Slots_Client_Golden88FreeRetType

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_Golden88FreeRet = {
    typeName = "PKG_Slots_Client_Golden88FreeRet", -- : PKG_Golden88_FreeSpin
    typeId = 30279,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_Golden88FreeRet)
        end
        PKG_Golden88_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_Golden88_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_Golden88_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_Golden88FreeRet.__index = PKG_Slots_Client_Golden88FreeRet
...
PKG_Client_Slots_Golden88FreeSpin = {
    typeName = "PKG_Client_Slots_Golden88FreeSpin",
    typeId = 30276,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_Golden88FreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_Golden88FreeSpin.__index = PKG_Client_Slots_Golden88FreeSpin
...
PKG_Slots_Client_Golden88EnterResumed = {
    typeName = "PKG_Slots_Client_Golden88EnterResumed",
    typeId = 30280,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_Golden88EnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_Golden88NormalRet.Create() -- PKG.Slots_Client.Golden88NormalRet
        --[[
        恢复免费游戏类型
        ]]
        o.resumedFreeTypeRet = PKG_Slots_Client_Golden88FreeRetType.Create() -- PKG.Slots_Client.Golden88FreeRetType
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFreeRet = PKG_Slots_Client_Golden88FreeRet.Create() -- PKG.Slots_Client.Golden88FreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_Golden88NormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeTypeRet
        self.resumedFreeTypeRet = PKG_Slots_Client_Golden88FreeRetType.Create(); r = self.resumedFreeTypeRet:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeRet
        self.resumedFreeRet = PKG_Slots_Client_Golden88FreeRet.Create(); r = self.resumedFreeRet:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_Golden88EnterResumed.__index = PKG_Slots_Client_Golden88EnterResumed

--[[
发财树 请求免费类型
]]
PKG_Client_Slots_Golden88FreeType = {
    typeName = "PKG_Client_Slots_Golden88FreeType",
    typeId = 30275,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_Golden88FreeType)
        end
        --[[
        押注类型
        ]]
...
PKG_Client_Slots_Golden88FreeType.__index = PKG_Client_Slots_Golden88FreeType

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_Golden88NormalSpin = {
    typeName = "PKG_Client_Slots_Golden88NormalSpin",
    typeId = 30274,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_Golden88NormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_Golden88NormalSpin.__index = PKG_Client_Slots_Golden88NormalSpin
...
PKG_Golden88_Cell = {
    typeName = "PKG_Golden88_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Golden88_Cell)
        end
        --[[
        点对应下标
        ]]
        ...
        o.icon = 0 -- PKG.Golden88.Golden88Symbol
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_Golden88_Cell.__index = PKG_Golden88_Cell

PKG_Golden88_Line = {
    typeName = "PKG_Golden88_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Golden88_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.Golden88.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_Golden88_Line.__index = PKG_Golden88_Line
...
local o = ObjMgr
o.Register(PKG_Golden88_NormalSpin)
o.Register(PKG_Golden88_FreeType)
o.Register(PKG_Golden88_FreeSpin)
o.Register(PKG_Slots_Client_Golden88NormalRet)
o.Register(PKG_Slots_Client_Golden88FreeRetType)
o.Register(PKG_Slots_Client_Golden88FreeRet)
o.Register(PKG_Slots_Client_Leave_Success)
o.Register(PKG_Slots_Client_LockLeaveSuccess)
o.Register(PKG_Client_Slots_Golden88FreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_Golden88EnterResumed)
o.Register(PKG_Client_Slots_Golden88FreeType)
o.Register(PKG_Client_Slots_Golden88NormalSpin)
