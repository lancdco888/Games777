...
CodeGen_slot_211_md5 ="#*MD5<d2c2309959427efae45ba4aa1d0358c4>*#"

PKG_MissBunny_MissBunnySymbol = {
    ServerMonkeyWild = 1,
    ServerMonkeyFree = 2,
    ServerMonkeyAA = 3,
    ServerMonkeyBB = 4,
...
PKG_MissBunny_NormalSpin = {
    typeName = "PKG_MissBunny_NormalSpin",
    typeId = 30231,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_MissBunny_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.MissBunny.Cell>
        --[[
        (符合连线规则)
        ]]
        o.lines = {} -- List<PKG.MissBunny.Line>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_MissBunny_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- lines
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_MissBunny_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
...
PKG_MissBunny_NormalSpin.__index = PKG_MissBunny_NormalSpin

--[[
生成图形数组和相关结果的基类
]]
PKG_MissBunny_FreeSpin = {
    typeName = "PKG_MissBunny_FreeSpin",
    typeId = 30232,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_MissBunny_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.listWild = {} -- List<PKG.MissBunny.WildBet>
        --[[
    ...
    Read = function(self, om)
        ...
        self.listWild = o
        for i = 1, len do
            o[i] = PKG_MissBunny_WildBet.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- bonusWinCoin
...
PKG_MissBunny_FreeSpin.__index = PKG_MissBunny_FreeSpin

--[[
生成图形数组和相关结果的基类
]]
PKG_MissBunny_SpecialSpin = {
    typeName = "PKG_MissBunny_SpecialSpin",
    typeId = 30233,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_MissBunny_SpecialSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_MissBunny_SpecialSpin.__index = PKG_MissBunny_SpecialSpin
...
PKG_Slots_Client_MissBunnyNormalRet = {
    typeName = "PKG_Slots_Client_MissBunnyNormalRet", -- : PKG_MissBunny_NormalSpin
    typeId = 30237,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_MissBunnyNormalRet)
        end
        PKG_MissBunny_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_MissBunny_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_MissBunny_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_MissBunnyNormalRet.__index = PKG_Slots_Client_MissBunnyNormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_MissBunnyFreeRet = {
    typeName = "PKG_Slots_Client_MissBunnyFreeRet", -- : PKG_MissBunny_FreeSpin
    typeId = 30238,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_MissBunnyFreeRet)
        end
        PKG_MissBunny_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_MissBunny_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_MissBunny_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_MissBunnyFreeRet.__index = PKG_Slots_Client_MissBunnyFreeRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_MissBunnySpecialRet = {
    typeName = "PKG_Slots_Client_MissBunnySpecialRet", -- : PKG_MissBunny_SpecialSpin
    typeId = 30239,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_MissBunnySpecialRet)
        end
        PKG_MissBunny_SpecialSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_MissBunny_SpecialSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_MissBunny_SpecialSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_MissBunnySpecialRet.__index = PKG_Slots_Client_MissBunnySpecialRet
...
PKG_Slots_Client_MissBunnyEnterResumed = {
    typeName = "PKG_Slots_Client_MissBunnyEnterResumed",
    typeId = 30240,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_MissBunnyEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_MissBunnyNormalRet.Create() -- PKG.Slots_Client.MissBunnyNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFreeRet = PKG_Slots_Client_MissBunnyFreeRet.Create() -- PKG.Slots_Client.MissBunnyFreeRet
        --[[
        恢复特殊游戏结果
        ]]
        o.resumedspecialRet = PKG_Slots_Client_MissBunnySpecialRet.Create() -- PKG.Slots_Client.MissBunnySpecialRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_MissBunnyNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeRet
        self.resumedFreeRet = PKG_Slots_Client_MissBunnyFreeRet.Create(); r = self.resumedFreeRet:Read(om)
        if r ~= 0 then return r end
        -- resumedspecialRet
        self.resumedspecialRet = PKG_Slots_Client_MissBunnySpecialRet.Create(); r = self.resumedspecialRet:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_MissBunnyEnterResumed.__index = PKG_Slots_Client_MissBunnyEnterResumed

--[[
Sugar请求特殊旋转图形
]]
PKG_Client_Slots_MissBunnySpecialSpin = {
    typeName = "PKG_Client_Slots_MissBunnySpecialSpin",
    typeId = 30236,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_MissBunnySpecialSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_MissBunnySpecialSpin.__index = PKG_Client_Slots_MissBunnySpecialSpin

--[[
Sugar请求特殊旋转图形
]]
PKG_Client_Slots_MissBunnyFreeSpin = {
    typeName = "PKG_Client_Slots_MissBunnyFreeSpin",
    typeId = 30235,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_MissBunnyFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_MissBunnyFreeSpin.__index = PKG_Client_Slots_MissBunnyFreeSpin

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_MissBunnyNormalSpin = {
    typeName = "PKG_Client_Slots_MissBunnyNormalSpin",
    typeId = 30234,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_MissBunnyNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_MissBunnyNormalSpin.__index = PKG_Client_Slots_MissBunnyNormalSpin
...
PKG_MissBunny_Cell = {
    typeName = "PKG_MissBunny_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_MissBunny_Cell)
        end
        --[[
        点对应下标
        ]]
        ...
        o.icon = 0 -- PKG.MissBunny.MissBunnySymbol
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_MissBunny_Cell.__index = PKG_MissBunny_Cell

PKG_MissBunny_Line = {
    typeName = "PKG_MissBunny_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_MissBunny_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.MissBunny.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_MissBunny_Line.__index = PKG_MissBunny_Line
...
PKG_MissBunny_WildBet = {
    typeName = "PKG_MissBunny_WildBet",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_MissBunny_WildBet)
        end
        o.index = 0 -- Int32
        o.bet = 0 -- Int32
        return o
...
PKG_MissBunny_WildBet.__index = PKG_MissBunny_WildBet
...
local o = ObjMgr
o.Register(PKG_MissBunny_NormalSpin)
o.Register(PKG_MissBunny_FreeSpin)
o.Register(PKG_MissBunny_SpecialSpin)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_MissBunnyNormalRet)
o.Register(PKG_Slots_Client_MissBunnyFreeRet)
o.Register(PKG_Slots_Client_MissBunnySpecialRet)
...
o.Register(PKG_Slots_Client_MissBunnyEnterResumed)
o.Register(PKG_Client_Slots_MissBunnySpecialSpin)
o.Register(PKG_Client_Slots_MissBunnyFreeSpin)
o.Register(PKG_Client_Slots_MissBunnyNormalSpin)
