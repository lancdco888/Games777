...
require('g_net')
CodeGen_slot_350_md5 ="#*MD5<5d65f06b26d37de28ddfa7e785f1918d>*#"

--[[
Sugar请求特殊旋转图形
]]
PKG_RoyalMonkey_NormalSpin = {
    typeName = "PKG_RoyalMonkey_NormalSpin",
    typeId = 35000,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_RoyalMonkey_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.RoyalMonkey.Cell>
        --[[
        哪些列 要刷新整列的特征 数组长度一定是5   00012 之类的信息
        ]]
        o.listInfo = {} -- List<Int32>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
        ...
        o.lines = {} -- List<PKG.RoyalMonkey.Line>
        --[[
        是否进入收集游戏
        ]]
        ...
        --[[
        12选三 额外钱的数据 没有2维数组  就这样写了 abcd  大中小巨
        ]]
        o.plusA = {} -- List<Double>
        o.plusB = {} -- List<Double>
        o.plusC = {} -- List<Double>
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_RoyalMonkey_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- listInfo
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_RoyalMonkey_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoCollect
...
PKG_RoyalMonkey_NormalSpin.__index = PKG_RoyalMonkey_NormalSpin

--[[
免费类型选择
]]
PKG_RoyalMonkey_FreeType = {
    typeName = "PKG_RoyalMonkey_FreeType",
    typeId = 35001,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_RoyalMonkey_FreeType)
        end
        --[[
        倍率类型
        ]]
...
PKG_RoyalMonkey_FreeType.__index = PKG_RoyalMonkey_FreeType

--[[
Sugar请求特殊旋转图形
]]
PKG_RoyalMonkey_FreeSpin = {
    typeName = "PKG_RoyalMonkey_FreeSpin",
    typeId = 35002,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_RoyalMonkey_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_RoyalMonkey_FreeSpin.__index = PKG_RoyalMonkey_FreeSpin

--[[
财富之树-普通结果
]]
PKG_Slots_Client_RoyalMonkeyNormalRet = {
    typeName = "PKG_Slots_Client_RoyalMonkeyNormalRet", -- : PKG_RoyalMonkey_NormalSpin
    typeId = 35010,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_RoyalMonkeyNormalRet)
        end
        PKG_RoyalMonkey_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_RoyalMonkey_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_RoyalMonkey_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_RoyalMonkeyNormalRet.__index = PKG_Slots_Client_RoyalMonkeyNormalRet

--[[
财富之树 免费游戏结果
]]
PKG_Slots_Client_RoyalMonkeyFreeRetType = {
    typeName = "PKG_Slots_Client_RoyalMonkeyFreeRetType", -- : PKG_RoyalMonkey_FreeType
    typeId = 35011,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_RoyalMonkeyFreeRetType)
        end
        PKG_RoyalMonkey_FreeType.Create(o)
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- base read
        r = PKG_RoyalMonkey_FreeType.Read(self, om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_RoyalMonkey_FreeType.Write(self, om)
    end
}
PKG_Slots_Client_RoyalMonkeyFreeRetType.__index = PKG_Slots_Client_RoyalMonkeyFreeRetType

--[[
财富之树 免费游戏结果
]]
PKG_Slots_Client_RoyalMonkeyFreeRet = {
    typeName = "PKG_Slots_Client_RoyalMonkeyFreeRet", -- : PKG_RoyalMonkey_FreeSpin
    typeId = 35012,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_RoyalMonkeyFreeRet)
        end
        PKG_RoyalMonkey_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_RoyalMonkey_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_RoyalMonkey_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_RoyalMonkeyFreeRet.__index = PKG_Slots_Client_RoyalMonkeyFreeRet
...
PKG_Client_Slots_RoyalMonkeyFreeSpin = {
    typeName = "PKG_Client_Slots_RoyalMonkeyFreeSpin",
    typeId = 35022,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_RoyalMonkeyFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_RoyalMonkeyFreeSpin.__index = PKG_Client_Slots_RoyalMonkeyFreeSpin
...
PKG_Slots_Client_RoyalMonkeyEnterResumed = {
    typeName = "PKG_Slots_Client_RoyalMonkeyEnterResumed",
    typeId = 35013,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_RoyalMonkeyEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_RoyalMonkeyNormalRet.Create() -- PKG.Slots_Client.RoyalMonkeyNormalRet
        --[[
        恢复免费游戏类型
        ]]
        o.resumedFreeTypeRet = PKG_Slots_Client_RoyalMonkeyFreeRetType.Create() -- PKG.Slots_Client.RoyalMonkeyFreeRetType
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFreeRet = PKG_Slots_Client_RoyalMonkeyFreeRet.Create() -- PKG.Slots_Client.RoyalMonkeyFreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_RoyalMonkeyNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeTypeRet
        self.resumedFreeTypeRet = PKG_Slots_Client_RoyalMonkeyFreeRetType.Create(); r = self.resumedFreeTypeRet:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeRet
        self.resumedFreeRet = PKG_Slots_Client_RoyalMonkeyFreeRet.Create(); r = self.resumedFreeRet:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_RoyalMonkeyEnterResumed.__index = PKG_Slots_Client_RoyalMonkeyEnterResumed

--[[
发财树 请求免费类型
]]
PKG_Client_Slots_RoyalMonkeyFreeType = {
    typeName = "PKG_Client_Slots_RoyalMonkeyFreeType",
    typeId = 35021,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_RoyalMonkeyFreeType)
        end
        --[[
        押注类型
        ]]
...
PKG_Client_Slots_RoyalMonkeyFreeType.__index = PKG_Client_Slots_RoyalMonkeyFreeType

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_RoyalMonkeyNormalSpin = {
    typeName = "PKG_Client_Slots_RoyalMonkeyNormalSpin",
    typeId = 35020,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_RoyalMonkeyNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_RoyalMonkeyNormalSpin.__index = PKG_Client_Slots_RoyalMonkeyNormalSpin
...
PKG_RoyalMonkey_Cell = {
    typeName = "PKG_RoyalMonkey_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_RoyalMonkey_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_RoyalMonkey_Cell.__index = PKG_RoyalMonkey_Cell

PKG_RoyalMonkey_Line = {
    typeName = "PKG_RoyalMonkey_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_RoyalMonkey_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.RoyalMonkey.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_RoyalMonkey_Line.__index = PKG_RoyalMonkey_Line
...
local o = ObjMgr
o.Register(PKG_RoyalMonkey_NormalSpin)
o.Register(PKG_RoyalMonkey_FreeType)
o.Register(PKG_RoyalMonkey_FreeSpin)
o.Register(PKG_Slots_Client_RoyalMonkeyNormalRet)
o.Register(PKG_Slots_Client_RoyalMonkeyFreeRetType)
o.Register(PKG_Slots_Client_RoyalMonkeyFreeRet)
...
o.Register(PKG_Client_Slots_RoyalMonkeyFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_RoyalMonkeyEnterResumed)
o.Register(PKG_Client_Slots_RoyalMonkeyFreeType)
o.Register(PKG_Client_Slots_RoyalMonkeyNormalSpin)
