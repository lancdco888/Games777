...
CodeGen_slot_252_md5 ="#*MD5<6c2cb5eb399f9a13e5216c323f349efb>*#"

--[[
生成图形数组和相关结果的基类
]]
PKG_DoubleBlessings_NormalSpin = {
    typeName = "PKG_DoubleBlessings_NormalSpin",
    typeId = 30501,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DoubleBlessings_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.DoubleBlessings.Cell>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
        ...
        o.lines = {} -- List<PKG.DoubleBlessings.Line>
        --[[
        是否进入收集游戏
        ]]
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_DoubleBlessings_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_DoubleBlessings_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoCollect
...
PKG_DoubleBlessings_NormalSpin.__index = PKG_DoubleBlessings_NormalSpin

--[[
生成图形数组和相关结果的基类
]]
PKG_DoubleBlessings_FreeSpin = {
    typeName = "PKG_DoubleBlessings_FreeSpin",
    typeId = 30502,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DoubleBlessings_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_DoubleBlessings_FreeSpin.__index = PKG_DoubleBlessings_FreeSpin
...
PKG_Slots_Client_DoubleBlessingsNormalRet = {
    typeName = "PKG_Slots_Client_DoubleBlessingsNormalRet", -- : PKG_DoubleBlessings_NormalSpin
    typeId = 30505,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DoubleBlessingsNormalRet)
        end
        PKG_DoubleBlessings_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_DoubleBlessings_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_DoubleBlessings_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_DoubleBlessingsNormalRet.__index = PKG_Slots_Client_DoubleBlessingsNormalRet

--[[
Sugar-彩虹触发的免费游戏结果
]]
PKG_Slots_Client_DoubleBlessingsFreeRet = {
    typeName = "PKG_Slots_Client_DoubleBlessingsFreeRet", -- : PKG_DoubleBlessings_FreeSpin
    typeId = 30506,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DoubleBlessingsFreeRet)
        end
        PKG_DoubleBlessings_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        o.levelUpMoney = 0 -- Int64
        o.levelUpMoneys = {} -- List<Int64>
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_DoubleBlessings_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_DoubleBlessings_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_DoubleBlessingsFreeRet.__index = PKG_Slots_Client_DoubleBlessingsFreeRet
...
PKG_Client_Slots_DoubleBlessingsFreeSpin = {
    typeName = "PKG_Client_Slots_DoubleBlessingsFreeSpin",
    typeId = 30504,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_DoubleBlessingsFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_DoubleBlessingsFreeSpin.__index = PKG_Client_Slots_DoubleBlessingsFreeSpin
...
PKG_Slots_Client_DoubleBlessingsEnterResumed = {
    typeName = "PKG_Slots_Client_DoubleBlessingsEnterResumed",
    typeId = 30507,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DoubleBlessingsEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_DoubleBlessingsNormalRet.Create() -- PKG.Slots_Client.DoubleBlessingsNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFreeRet = PKG_Slots_Client_DoubleBlessingsFreeRet.Create() -- PKG.Slots_Client.DoubleBlessingsFreeRet
        --[[
        游戏彩金已开的数组
        ]]
        o.cells = {} -- List<Int32>
    ...
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_DoubleBlessingsNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeRet
        self.resumedFreeRet = PKG_Slots_Client_DoubleBlessingsFreeRet.Create(); r = self.resumedFreeRet:Read(om)
        if r ~= 0 then return r end
        -- cells
        r, len = d:Rvu32()
        if len > d:GetLeft() then return -1 end
...
PKG_Slots_Client_DoubleBlessingsEnterResumed.__index = PKG_Slots_Client_DoubleBlessingsEnterResumed

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_DoubleBlessingsNormalSpin = {
    typeName = "PKG_Client_Slots_DoubleBlessingsNormalSpin",
    typeId = 30503,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_DoubleBlessingsNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_DoubleBlessingsNormalSpin.__index = PKG_Client_Slots_DoubleBlessingsNormalSpin
...
PKG_DoubleBlessings_Cell = {
    typeName = "PKG_DoubleBlessings_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DoubleBlessings_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_DoubleBlessings_Cell.__index = PKG_DoubleBlessings_Cell

PKG_DoubleBlessings_Line = {
    typeName = "PKG_DoubleBlessings_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DoubleBlessings_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.DoubleBlessings.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_DoubleBlessings_Line.__index = PKG_DoubleBlessings_Line
...
local o = ObjMgr
o.Register(PKG_DoubleBlessings_NormalSpin)
o.Register(PKG_DoubleBlessings_FreeSpin)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_DoubleBlessingsNormalRet)
o.Register(PKG_Slots_Client_DoubleBlessingsFreeRet)
o.Register(PKG_Slots_Client_Leave_Success)
o.Register(PKG_Client_Slots_DoubleBlessingsFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_DoubleBlessingsEnterResumed)
o.Register(PKG_Client_Slots_DoubleBlessingsNormalSpin)
