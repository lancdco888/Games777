...
CodeGen_slot_257_md5 ="#*MD5<dae37b807d0c7a5554f872f0eb3a14bc>*#"

--[[
生成图形数组和相关结果的基类
]]
PKG_DuanWu_NormalSpin = {
    typeName = "PKG_DuanWu_NormalSpin",
    typeId = 30531,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DuanWu_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.lines = {} -- List<PKG.DuanWu.Line>
        --[[
        箱子倍率数组
        ]]
        o.boxsbet = {} -- List<Int32>
        --[[
        大奖锁定
        ]]
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_DuanWu_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_DuanWu_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- boxsbet
...
PKG_DuanWu_NormalSpin.__index = PKG_DuanWu_NormalSpin

--[[
生成图形数组和相关结果的基类
]]
PKG_DuanWu_FreeSpin = {
    typeName = "PKG_DuanWu_FreeSpin",
    typeId = 30532,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DuanWu_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_DuanWu_FreeSpin.__index = PKG_DuanWu_FreeSpin
...
PKG_Slots_Client_DuanWuNormalRet = {
    typeName = "PKG_Slots_Client_DuanWuNormalRet", -- : PKG_DuanWu_NormalSpin
    typeId = 30535,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DuanWuNormalRet)
        end
        PKG_DuanWu_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_DuanWu_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_DuanWu_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_DuanWuNormalRet.__index = PKG_Slots_Client_DuanWuNormalRet

--[[
Sugar-彩虹触发的免费游戏结果
]]
PKG_Slots_Client_DuanWuFreeRet = {
    typeName = "PKG_Slots_Client_DuanWuFreeRet", -- : PKG_DuanWu_FreeSpin
    typeId = 30536,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DuanWuFreeRet)
        end
        PKG_DuanWu_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        o.levelUpMoney = 0 -- Int64
        o.levelUpMoneys = {} -- List<Int64>
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_DuanWu_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_DuanWu_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_DuanWuFreeRet.__index = PKG_Slots_Client_DuanWuFreeRet
...
PKG_Client_Slots_DuanWuFreeSpin = {
    typeName = "PKG_Client_Slots_DuanWuFreeSpin",
    typeId = 30534,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_DuanWuFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_DuanWuFreeSpin.__index = PKG_Client_Slots_DuanWuFreeSpin
...
PKG_Slots_Client_DuanWuEnterResumed = {
    typeName = "PKG_Slots_Client_DuanWuEnterResumed",
    typeId = 30537,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DuanWuEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_DuanWuNormalRet.Create() -- PKG.Slots_Client.DuanWuNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFreeRet = PKG_Slots_Client_DuanWuFreeRet.Create() -- PKG.Slots_Client.DuanWuFreeRet
        --[[
        游戏彩金已开的数组
        ]]
        o.cells = {} -- List<Int32>
    ...
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_DuanWuNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeRet
        self.resumedFreeRet = PKG_Slots_Client_DuanWuFreeRet.Create(); r = self.resumedFreeRet:Read(om)
        if r ~= 0 then return r end
        -- cells
        r, len = d:Rvu32()
        if len > d:GetLeft() then return -1 end
...
PKG_Slots_Client_DuanWuEnterResumed.__index = PKG_Slots_Client_DuanWuEnterResumed

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_DuanWuNormalSpin = {
    typeName = "PKG_Client_Slots_DuanWuNormalSpin",
    typeId = 30533,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_DuanWuNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_DuanWuNormalSpin.__index = PKG_Client_Slots_DuanWuNormalSpin
...
PKG_DuanWu_Cell = {
    typeName = "PKG_DuanWu_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DuanWu_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_DuanWu_Cell.__index = PKG_DuanWu_Cell

PKG_DuanWu_Line = {
    typeName = "PKG_DuanWu_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_DuanWu_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.DuanWu.Cell>
        --[[
        是否中奖彩金
        ]]
        o.caijintype = 0 -- Int32
        return o
    end,
    Read = function(self, om)
        local d = om.d
    ...
    Write = function(self, om)
        ...
        -- caijintype
        d:Wvi32(self.caijintype)
    end
}
PKG_DuanWu_Line.__index = PKG_DuanWu_Line
...
local o = ObjMgr
o.Register(PKG_DuanWu_NormalSpin)
o.Register(PKG_DuanWu_FreeSpin)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_DuanWuNormalRet)
o.Register(PKG_Slots_Client_DuanWuFreeRet)
o.Register(PKG_Slots_Client_Leave_Success)
o.Register(PKG_Client_Slots_DuanWuFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_DuanWuEnterResumed)
o.Register(PKG_Client_Slots_DuanWuNormalSpin)
