...
CodeGen_slot_361_md5 ="#*MD5<7f64a0ceccc387727975722990d5507b>*#"

--[[
生成图形数组和相关结果的基类
]]
PKG_FortuneRabbit_NormalSpin = {
    typeName = "PKG_FortuneRabbit_NormalSpin",
    typeId = 36111,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_FortuneRabbit_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.FortuneRabbit.Cell>
        --[[
        (符合连线规则)
        ]]
        o.lines = {} -- List<PKG.FortuneRabbit.Line>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_FortuneRabbit_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- lines
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_FortuneRabbit_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
...
PKG_FortuneRabbit_NormalSpin.__index = PKG_FortuneRabbit_NormalSpin

--[[
生成图形数组和相关结果的基类
]]
PKG_FortuneRabbit_FreeSpin = {
    typeName = "PKG_FortuneRabbit_FreeSpin",
    typeId = 36112,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_FortuneRabbit_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_FortuneRabbit_FreeSpin.__index = PKG_FortuneRabbit_FreeSpin
...
PKG_Slots_Client_FortuneRabbitNormalRet = {
    typeName = "PKG_Slots_Client_FortuneRabbitNormalRet",
    typeId = 36115,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_FortuneRabbitNormalRet)
        end
        o.normalSpin = PKG_FortuneRabbit_NormalSpin.Create() -- PKG.FortuneRabbit.NormalSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- normalSpin
        self.normalSpin = PKG_FortuneRabbit_NormalSpin.Create(); r = self.normalSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_FortuneRabbitNormalRet.__index = PKG_Slots_Client_FortuneRabbitNormalRet

--[[
Sugar-彩虹触发的免费游戏结果
]]
PKG_Slots_Client_FortuneRabbitFreeRet = {
    typeName = "PKG_Slots_Client_FortuneRabbitFreeRet",
    typeId = 36116,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_FortuneRabbitFreeRet)
        end
        o.freeSpin = PKG_FortuneRabbit_FreeSpin.Create() -- PKG.FortuneRabbit.FreeSpin
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- freeSpin
        self.freeSpin = PKG_FortuneRabbit_FreeSpin.Create(); r = self.freeSpin:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_FortuneRabbitFreeRet.__index = PKG_Slots_Client_FortuneRabbitFreeRet
...
PKG_Client_Slots_FortuneRabbitFreeSpin = {
    typeName = "PKG_Client_Slots_FortuneRabbitFreeSpin",
    typeId = 36114,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_FortuneRabbitFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_FortuneRabbitFreeSpin.__index = PKG_Client_Slots_FortuneRabbitFreeSpin
...
PKG_Slots_Client_FortuneRabbitEnterResumed = {
    typeName = "PKG_Slots_Client_FortuneRabbitEnterResumed",
    typeId = 36117,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_FortuneRabbitEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_FortuneRabbitNormalRet.Create() -- PKG.Slots_Client.FortuneRabbitNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFreeRet = PKG_Slots_Client_FortuneRabbitFreeRet.Create() -- PKG.Slots_Client.FortuneRabbitFreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_FortuneRabbitNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeRet
        self.resumedFreeRet = PKG_Slots_Client_FortuneRabbitFreeRet.Create(); r = self.resumedFreeRet:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_FortuneRabbitEnterResumed.__index = PKG_Slots_Client_FortuneRabbitEnterResumed

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_FortuneRabbitNormalSpin = {
    typeName = "PKG_Client_Slots_FortuneRabbitNormalSpin",
    typeId = 36113,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_FortuneRabbitNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_FortuneRabbitNormalSpin.__index = PKG_Client_Slots_FortuneRabbitNormalSpin
...
PKG_FortuneRabbit_Cell = {
    typeName = "PKG_FortuneRabbit_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_FortuneRabbit_Cell)
        end
        --[[
        点对应下标
        ]]
        ...
        o.icon = 0 -- Int32
        --[[
        点对应图形Id的类型 0为常规图形 其他为有奖图形 1普通奖励 
        ]]
...
PKG_FortuneRabbit_Cell.__index = PKG_FortuneRabbit_Cell

PKG_FortuneRabbit_Line = {
    typeName = "PKG_FortuneRabbit_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_FortuneRabbit_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.FortuneRabbit.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_FortuneRabbit_Line.__index = PKG_FortuneRabbit_Line
...
local o = ObjMgr
o.Register(PKG_FortuneRabbit_NormalSpin)
o.Register(PKG_FortuneRabbit_FreeSpin)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_FortuneRabbitNormalRet)
o.Register(PKG_Slots_Client_FortuneRabbitFreeRet)
o.Register(PKG_Slots_Client_Leave_Success)
o.Register(PKG_Client_Slots_FortuneRabbitFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_FortuneRabbitEnterResumed)
o.Register(PKG_Client_Slots_FortuneRabbitNormalSpin)
