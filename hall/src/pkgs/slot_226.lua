...
CodeGen_slot_226_md5 ="#*MD5<644e4cf723745efebd6d818f2ed4ff93>*#"

PKG_LeprechaunStackGold_LeprechaunStackGoldSymbol = {
    StackGoldWild = 1,
    StackGoldBaoZang = 2,
    StackGoldJingLing = 3,
    StackGoldShuiJing = 4,
...
PKG_LeprechaunStackGold_NormalSpin = {
    typeName = "PKG_LeprechaunStackGold_NormalSpin",
    typeId = 30351,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_LeprechaunStackGold_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.LeprechaunStackGold.Cell>
        --[[
        进入免费游戏的次数
        ]]
        o.freeTime = 0 -- Int32
        o.freelist = {} -- List<PKG.LeprechaunStackGold.Freeinfo>
        --[[
        (符合连线规则)
        ]]
        o.lines = {} -- List<PKG.LeprechaunStackGold.Line>
        return o
    end,
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_LeprechaunStackGold_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- freeTime
        ...
        self.freelist = o
        for i = 1, len do
            o[i] = PKG_LeprechaunStackGold_Freeinfo.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- lines
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_LeprechaunStackGold_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_LeprechaunStackGold_NormalSpin.__index = PKG_LeprechaunStackGold_NormalSpin

--[[
免费类型选择
]]
PKG_LeprechaunStackGold_FreeType = {
    typeName = "PKG_LeprechaunStackGold_FreeType",
    typeId = 30352,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_LeprechaunStackGold_FreeType)
        end
        o.count = 0 -- Int32
        return o
    end,
...
PKG_LeprechaunStackGold_FreeType.__index = PKG_LeprechaunStackGold_FreeType

--[[
Sugar请求特殊旋转图形
]]
PKG_LeprechaunStackGold_FreeSpin = {
    typeName = "PKG_LeprechaunStackGold_FreeSpin",
    typeId = 30353,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_LeprechaunStackGold_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_LeprechaunStackGold_FreeSpin.__index = PKG_LeprechaunStackGold_FreeSpin
...
PKG_Slots_Client_LeprechaunStackGoldNormalRet = {
    typeName = "PKG_Slots_Client_LeprechaunStackGoldNormalRet", -- : PKG_LeprechaunStackGold_NormalSpin
    typeId = 30357,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_LeprechaunStackGoldNormalRet)
        end
        PKG_LeprechaunStackGold_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_LeprechaunStackGold_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_LeprechaunStackGold_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_LeprechaunStackGoldNormalRet.__index = PKG_Slots_Client_LeprechaunStackGoldNormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_LeprechaunStackGoldFreeTypeRet = {
    typeName = "PKG_Slots_Client_LeprechaunStackGoldFreeTypeRet", -- : PKG_LeprechaunStackGold_FreeType
    typeId = 30358,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_LeprechaunStackGoldFreeTypeRet)
        end
        PKG_LeprechaunStackGold_FreeType.Create(o)
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- base read
        r = PKG_LeprechaunStackGold_FreeType.Read(self, om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_LeprechaunStackGold_FreeType.Write(self, om)
    end
}
PKG_Slots_Client_LeprechaunStackGoldFreeTypeRet.__index = PKG_Slots_Client_LeprechaunStackGoldFreeTypeRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_LeprechaunStackGoldFreeRet = {
    typeName = "PKG_Slots_Client_LeprechaunStackGoldFreeRet", -- : PKG_LeprechaunStackGold_FreeSpin
    typeId = 30359,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_LeprechaunStackGoldFreeRet)
        end
        PKG_LeprechaunStackGold_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_LeprechaunStackGold_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_LeprechaunStackGold_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_LeprechaunStackGoldFreeRet.__index = PKG_Slots_Client_LeprechaunStackGoldFreeRet
...
PKG_Slots_Client_LeprechaunStackGoldEnterResumed = {
    typeName = "PKG_Slots_Client_LeprechaunStackGoldEnterResumed",
    typeId = 30360,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_LeprechaunStackGoldEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_LeprechaunStackGoldNormalRet.Create() -- PKG.Slots_Client.LeprechaunStackGoldNormalRet
        --[[
        恢复免费游戏类型
        ]]
        o.resumedFreeTypeRet = PKG_Slots_Client_LeprechaunStackGoldFreeTypeRet.Create() -- PKG.Slots_Client.LeprechaunStackGoldFreeTypeRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFreeRet = PKG_Slots_Client_LeprechaunStackGoldFreeRet.Create() -- PKG.Slots_Client.LeprechaunStackGoldFreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_LeprechaunStackGoldNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeTypeRet
        self.resumedFreeTypeRet = PKG_Slots_Client_LeprechaunStackGoldFreeTypeRet.Create(); r = self.resumedFreeTypeRet:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeRet
        self.resumedFreeRet = PKG_Slots_Client_LeprechaunStackGoldFreeRet.Create(); r = self.resumedFreeRet:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
        ...
        -- resumedFreeTypeRet
        self.resumedFreeTypeRet:Write(om)
        -- resumedFreeRet
        self.resumedFreeRet:Write(om)
    end
}
PKG_Slots_Client_LeprechaunStackGoldEnterResumed.__index = PKG_Slots_Client_LeprechaunStackGoldEnterResumed

--[[
Sugar请求特殊旋转图形
]]
PKG_Client_Slots_LeprechaunStackGoldFreeSpin = {
    typeName = "PKG_Client_Slots_LeprechaunStackGoldFreeSpin",
    typeId = 30356,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_LeprechaunStackGoldFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_LeprechaunStackGoldFreeSpin.__index = PKG_Client_Slots_LeprechaunStackGoldFreeSpin

--[[
发财树 请求免费类型
]]
PKG_Client_Slots_LeprechaunStackGoldFreeType = {
    typeName = "PKG_Client_Slots_LeprechaunStackGoldFreeType",
    typeId = 30355,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_LeprechaunStackGoldFreeType)
        end
        --[[
        押注类型
        ]]
...
PKG_Client_Slots_LeprechaunStackGoldFreeType.__index = PKG_Client_Slots_LeprechaunStackGoldFreeType

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_LeprechaunStackGoldNormalSpin = {
    typeName = "PKG_Client_Slots_LeprechaunStackGoldNormalSpin",
    typeId = 30354,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_LeprechaunStackGoldNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_LeprechaunStackGoldNormalSpin.__index = PKG_Client_Slots_LeprechaunStackGoldNormalSpin
...
PKG_LeprechaunStackGold_Cell = {
    typeName = "PKG_LeprechaunStackGold_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_LeprechaunStackGold_Cell)
        end
        --[[
        点对应下标
        ]]
        ...
        o.icon = 0 -- PKG.LeprechaunStackGold.LeprechaunStackGoldSymbol
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_LeprechaunStackGold_Cell.__index = PKG_LeprechaunStackGold_Cell

PKG_LeprechaunStackGold_Line = {
    typeName = "PKG_LeprechaunStackGold_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_LeprechaunStackGold_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.LeprechaunStackGold.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_LeprechaunStackGold_Line.__index = PKG_LeprechaunStackGold_Line

PKG_LeprechaunStackGold_Freeinfo = {
    typeName = "PKG_LeprechaunStackGold_Freeinfo",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_LeprechaunStackGold_Freeinfo)
        end
        o.index = 0 -- Int32
        o.time = 0 -- Int32
        return o
...
PKG_LeprechaunStackGold_Freeinfo.__index = PKG_LeprechaunStackGold_Freeinfo
...
local o = ObjMgr
o.Register(PKG_LeprechaunStackGold_NormalSpin)
o.Register(PKG_LeprechaunStackGold_FreeType)
o.Register(PKG_LeprechaunStackGold_FreeSpin)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_LeprechaunStackGoldNormalRet)
o.Register(PKG_Slots_Client_LeprechaunStackGoldFreeTypeRet)
o.Register(PKG_Slots_Client_LeprechaunStackGoldFreeRet)
...
o.Register(PKG_Slots_Client_LeprechaunStackGoldEnterResumed)
o.Register(PKG_Client_Slots_LeprechaunStackGoldFreeSpin)
o.Register(PKG_Client_Slots_LeprechaunStackGoldFreeType)
o.Register(PKG_Client_Slots_LeprechaunStackGoldNormalSpin)
