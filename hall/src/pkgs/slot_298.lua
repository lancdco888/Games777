...
CodeGen_slot_296_md5 ="#*MD5<4a3e76d9b9a466fcaeb8cfbb2a92b1f3>*#"

--[[
Sugar请求特殊旋转图形
]]
PKG_TigerPrincess_NormalSpin = {
    typeName = "PKG_TigerPrincess_NormalSpin",
    typeId = 30751,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_TigerPrincess_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.TigerPrincess.Cell>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
        ...
        o.lines = {} -- List<PKG.TigerPrincess.Line>
        return o
    end,
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_TigerPrincess_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_TigerPrincess_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_TigerPrincess_NormalSpin.__index = PKG_TigerPrincess_NormalSpin

--[[
Sugar请求免费旋转图形
]]
PKG_TigerPrincess_FreeSpin = {
    typeName = "PKG_TigerPrincess_FreeSpin",
    typeId = 30752,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_TigerPrincess_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_TigerPrincess_FreeSpin.__index = PKG_TigerPrincess_FreeSpin
...
PKG_Slots_Client_TigerPrincessNormalRet = {
    typeName = "PKG_Slots_Client_TigerPrincessNormalRet", -- : PKG_TigerPrincess_NormalSpin
    typeId = 30755,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_TigerPrincessNormalRet)
        end
        PKG_TigerPrincess_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_TigerPrincess_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_TigerPrincess_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_TigerPrincessNormalRet.__index = PKG_Slots_Client_TigerPrincessNormalRet

--[[
财神赐宝 免费游戏结果
]]
PKG_Slots_Client_TigerPrincessFreeRet = {
    typeName = "PKG_Slots_Client_TigerPrincessFreeRet", -- : PKG_TigerPrincess_FreeSpin
    typeId = 30756,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_TigerPrincessFreeRet)
        end
        PKG_TigerPrincess_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_TigerPrincess_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_TigerPrincess_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_TigerPrincessFreeRet.__index = PKG_Slots_Client_TigerPrincessFreeRet
...
PKG_Client_Slots_TigerPrincessFreeSpin = {
    typeName = "PKG_Client_Slots_TigerPrincessFreeSpin",
    typeId = 30754,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_TigerPrincessFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_TigerPrincessFreeSpin.__index = PKG_Client_Slots_TigerPrincessFreeSpin
...
PKG_Slots_Client_TigerPrincessEnterResumed = {
    typeName = "PKG_Slots_Client_TigerPrincessEnterResumed",
    typeId = 30757,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_TigerPrincessEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_TigerPrincessNormalRet.Create() -- PKG.Slots_Client.TigerPrincessNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_TigerPrincessFreeRet.Create() -- PKG.Slots_Client.TigerPrincessFreeRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_TigerPrincessNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_TigerPrincessFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_TigerPrincessEnterResumed.__index = PKG_Slots_Client_TigerPrincessEnterResumed

--[[
财神赐宝  普通旋转
]]
PKG_Client_Slots_TigerPrincessNormalSpin = {
    typeName = "PKG_Client_Slots_TigerPrincessNormalSpin",
    typeId = 30753,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_TigerPrincessNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_TigerPrincessNormalSpin.__index = PKG_Client_Slots_TigerPrincessNormalSpin
...
PKG_TigerPrincess_Cell = {
    typeName = "PKG_TigerPrincess_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_TigerPrincess_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_TigerPrincess_Cell.__index = PKG_TigerPrincess_Cell

PKG_TigerPrincess_Line = {
    typeName = "PKG_TigerPrincess_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_TigerPrincess_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.TigerPrincess.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_TigerPrincess_Line.__index = PKG_TigerPrincess_Line
...
local o = ObjMgr
o.Register(PKG_TigerPrincess_NormalSpin)
o.Register(PKG_TigerPrincess_FreeSpin)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_TigerPrincessNormalRet)
o.Register(PKG_Slots_Client_TigerPrincessFreeRet)
o.Register(PKG_Slots_Client_Leave_Success)
o.Register(PKG_Client_Slots_TigerPrincessFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_TigerPrincessEnterResumed)
o.Register(PKG_Client_Slots_TigerPrincessNormalSpin)
