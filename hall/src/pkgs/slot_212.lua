...
CodeGen_slot_212_md5 ="#*MD5<8329c1d64c00c8d60ed7513c554f0af2>*#"

PKG_SnowGoddess_SnowGoddessSymbol = {
    SymbolWild = 1,
    SymbolFire = 2,
    SymbolGoddess = 3,
    SymbolLu = 4,
...
PKG_SnowGoddess_NormalSpin = {
    typeName = "PKG_SnowGoddess_NormalSpin",
    typeId = 30391,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_SnowGoddess_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.SnowGoddess.Cell>
        --[[
        是否进入特殊游戏
        ]]
        o.intoFree = 0 -- Int32
        ...
        o.lines = {} -- List<PKG.SnowGoddess.Line>
        return o
    end,
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_SnowGoddess_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_SnowGoddess_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        return 0
...
PKG_SnowGoddess_NormalSpin.__index = PKG_SnowGoddess_NormalSpin

--[[
生成图形数组和相关结果的基类
]]
PKG_SnowGoddess_FreeSpin = {
    typeName = "PKG_SnowGoddess_FreeSpin",
    typeId = 30392,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_SnowGoddess_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_SnowGoddess_FreeSpin.__index = PKG_SnowGoddess_FreeSpin

--[[
生成图形数组和相关结果的基类
]]
PKG_SnowGoddess_SpecialSpin = {
    typeName = "PKG_SnowGoddess_SpecialSpin",
    typeId = 30393,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_SnowGoddess_SpecialSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.SnowGoddess.Cell>
        o.addPos = {} -- List<PKG.SnowGoddess.Cell>
        --[[
        总次数
        ]]
        o.allCount = 0 -- Int32
...
PKG_SnowGoddess_SpecialSpin.__index = PKG_SnowGoddess_SpecialSpin

--[[
狂野蛮牛-普通结果
]]
PKG_Slots_Client_SnowGoddessNormalRet = {
    typeName = "PKG_Slots_Client_SnowGoddessNormalRet", -- : PKG_SnowGoddess_NormalSpin
    typeId = 30397,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_SnowGoddessNormalRet)
        end
        PKG_SnowGoddess_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_SnowGoddess_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_SnowGoddess_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_SnowGoddessNormalRet.__index = PKG_Slots_Client_SnowGoddessNormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_SnowGoddessFreeRet = {
    typeName = "PKG_Slots_Client_SnowGoddessFreeRet", -- : PKG_SnowGoddess_FreeSpin
    typeId = 30398,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_SnowGoddessFreeRet)
        end
        PKG_SnowGoddess_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_SnowGoddess_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_SnowGoddess_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_SnowGoddessFreeRet.__index = PKG_Slots_Client_SnowGoddessFreeRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_SnowGoddessSpecialRet = {
    typeName = "PKG_Slots_Client_SnowGoddessSpecialRet", -- : PKG_SnowGoddess_SpecialSpin
    typeId = 30399,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_SnowGoddessSpecialRet)
        end
        PKG_SnowGoddess_SpecialSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_SnowGoddess_SpecialSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_SnowGoddess_SpecialSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_SnowGoddessSpecialRet.__index = PKG_Slots_Client_SnowGoddessSpecialRet
...
PKG_Client_Slots_SnowGoddessSpecialSpin = {
    typeName = "PKG_Client_Slots_SnowGoddessSpecialSpin",
    typeId = 30396,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_SnowGoddessSpecialSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_SnowGoddessSpecialSpin.__index = PKG_Client_Slots_SnowGoddessSpecialSpin
...
PKG_Slots_Client_SnowGoddessEnterResumed = {
    typeName = "PKG_Slots_Client_SnowGoddessEnterResumed",
    typeId = 30400,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_SnowGoddessEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_SnowGoddessNormalRet.Create() -- PKG.Slots_Client.SnowGoddessNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFreeRet = PKG_Slots_Client_SnowGoddessFreeRet.Create() -- PKG.Slots_Client.SnowGoddessFreeRet
        --[[
        恢复特殊游戏结果
        ]]
        o.resumedspecialRet = PKG_Slots_Client_SnowGoddessSpecialRet.Create() -- PKG.Slots_Client.SnowGoddessSpecialRet
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_SnowGoddessNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFreeRet
        self.resumedFreeRet = PKG_Slots_Client_SnowGoddessFreeRet.Create(); r = self.resumedFreeRet:Read(om)
        if r ~= 0 then return r end
        -- resumedspecialRet
        self.resumedspecialRet = PKG_Slots_Client_SnowGoddessSpecialRet.Create(); r = self.resumedspecialRet:Read(om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
...
PKG_Slots_Client_SnowGoddessEnterResumed.__index = PKG_Slots_Client_SnowGoddessEnterResumed

--[[
Sugar请求特殊旋转图形
]]
PKG_Client_Slots_SnowGoddessFreeSpin = {
    typeName = "PKG_Client_Slots_SnowGoddessFreeSpin",
    typeId = 30395,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_SnowGoddessFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_SnowGoddessFreeSpin.__index = PKG_Client_Slots_SnowGoddessFreeSpin

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_SnowGoddessNormalSpin = {
    typeName = "PKG_Client_Slots_SnowGoddessNormalSpin",
    typeId = 30394,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_SnowGoddessNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_SnowGoddessNormalSpin.__index = PKG_Client_Slots_SnowGoddessNormalSpin
...
PKG_SnowGoddess_Cell = {
    typeName = "PKG_SnowGoddess_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_SnowGoddess_Cell)
        end
        --[[
        点对应下标
        ]]
        ...
        o.icon = 0 -- PKG.SnowGoddess.SnowGoddessSymbol
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_SnowGoddess_Cell.__index = PKG_SnowGoddess_Cell

PKG_SnowGoddess_Line = {
    typeName = "PKG_SnowGoddess_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_SnowGoddess_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.SnowGoddess.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_SnowGoddess_Line.__index = PKG_SnowGoddess_Line
...
local o = ObjMgr
o.Register(PKG_SnowGoddess_NormalSpin)
o.Register(PKG_SnowGoddess_FreeSpin)
o.Register(PKG_SnowGoddess_SpecialSpin)
o.Register(PKG_Slots_Client_SnowGoddessNormalRet)
o.Register(PKG_Slots_Client_SnowGoddessFreeRet)
o.Register(PKG_Slots_Client_SnowGoddessSpecialRet)
...
o.Register(PKG_Client_Slots_SnowGoddessSpecialSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_SnowGoddessEnterResumed)
o.Register(PKG_Client_Slots_SnowGoddessFreeSpin)
o.Register(PKG_Client_Slots_SnowGoddessNormalSpin)
