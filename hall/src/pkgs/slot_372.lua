...
CodeGen_slot_372_md5 ="#*MD5<a57b40deb8db87b02b114c913ad27569>*#"

--[[
Sugar请求特殊旋转图形
]]
PKG_PigAndWolf_NormalSpin = {
    typeName = "PKG_PigAndWolf_NormalSpin",
    typeId = 37291,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_PigAndWolf_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.PigAndWolf.Cell>
        o.wildBet = 0 -- Int32
        --[[
        是否进入免费游戏
        ]]
        ...
        o.lines = {} -- List<PKG.PigAndWolf.Line>
        --[[
        大奖锁定
        ]]
        ...
        o.otherGrids = {} -- List<PKG.PigAndWolf.Cell>
        return o
    end,
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_PigAndWolf_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- wildBet
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_PigAndWolf_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- lockStates
...
PKG_PigAndWolf_NormalSpin.__index = PKG_PigAndWolf_NormalSpin

--[[
Sugar请求免费旋转图形
]]
PKG_PigAndWolf_FreeSpin = {
    typeName = "PKG_PigAndWolf_FreeSpin",
    typeId = 37293,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_PigAndWolf_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
    ...
    Write = function(self, om)
        ...
        -- accuLineCoin
        d:Wd(self.accuLineCoin)
    end
}
PKG_PigAndWolf_FreeSpin.__index = PKG_PigAndWolf_FreeSpin

--[[
Sugar请求特殊旋转图形
]]
PKG_PigAndWolf_SpecialSpin = {
    typeName = "PKG_PigAndWolf_SpecialSpin",
    typeId = 37294,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_PigAndWolf_SpecialSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_PigAndWolf_SpecialSpin.__index = PKG_PigAndWolf_SpecialSpin

--[[
猪和狼-普通结果
]]
PKG_Slots_Client_PigAndWolfNormalRet = {
    typeName = "PKG_Slots_Client_PigAndWolfNormalRet", -- : PKG_PigAndWolf_NormalSpin
    typeId = 37211,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_PigAndWolfNormalRet)
        end
        PKG_PigAndWolf_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_PigAndWolf_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_PigAndWolf_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_PigAndWolfNormalRet.__index = PKG_Slots_Client_PigAndWolfNormalRet
...
PKG_Slots_Client_PigAndWolfFreeRet = {
    typeName = "PKG_Slots_Client_PigAndWolfFreeRet", -- : PKG_PigAndWolf_FreeSpin
    typeId = 37213,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_PigAndWolfFreeRet)
        end
        PKG_PigAndWolf_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_PigAndWolf_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_PigAndWolf_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_PigAndWolfFreeRet.__index = PKG_Slots_Client_PigAndWolfFreeRet

--[[
猪和狼 特殊结果
]]
PKG_Slots_Client_PigAndWolfSpecialSpinRet = {
    typeName = "PKG_Slots_Client_PigAndWolfSpecialSpinRet", -- : PKG_PigAndWolf_SpecialSpin
    typeId = 37214,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_PigAndWolfSpecialSpinRet)
        end
        PKG_PigAndWolf_SpecialSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_PigAndWolf_SpecialSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_PigAndWolf_SpecialSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_PigAndWolfSpecialSpinRet.__index = PKG_Slots_Client_PigAndWolfSpecialSpinRet
...
PKG_Slots_Client_PigAndWolfEnterResumed = {
    typeName = "PKG_Slots_Client_PigAndWolfEnterResumed",
    typeId = 37215,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_PigAndWolfEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_PigAndWolfNormalRet.Create() -- PKG.Slots_Client.PigAndWolfNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_PigAndWolfFreeRet.Create() -- PKG.Slots_Client.PigAndWolfFreeRet
        --[[
        恢复特殊游戏结果
        ]]
        o.resumedSpecial = PKG_Slots_Client_PigAndWolfSpecialSpinRet.Create() -- PKG.Slots_Client.PigAndWolfSpecialSpinRet
        o.MoneyA = 0 -- Double
        o.MoneyB = 0 -- Double
        --[[
        免费游戏中的彩金已开的数组
    ...
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_PigAndWolfNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_PigAndWolfFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        -- resumedSpecial
        self.resumedSpecial = PKG_Slots_Client_PigAndWolfSpecialSpinRet.Create(); r = self.resumedSpecial:Read(om)
        if r ~= 0 then return r end
        -- MoneyA
        r, self.MoneyA = d:Rd()
        if r ~= 0 then return r end
...
PKG_Slots_Client_PigAndWolfEnterResumed.__index = PKG_Slots_Client_PigAndWolfEnterResumed

--[[
猪和狼 请求特殊旋转图形
]]
PKG_Client_Slots_PigAndWolfSpecialSpin = {
    typeName = "PKG_Client_Slots_PigAndWolfSpecialSpin",
    typeId = 37204,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_PigAndWolfSpecialSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_PigAndWolfSpecialSpin.__index = PKG_Client_Slots_PigAndWolfSpecialSpin

--[[
猪和狼 请求免费旋转图形
]]
PKG_Client_Slots_PigAndWolfFreeSpin = {
    typeName = "PKG_Client_Slots_PigAndWolfFreeSpin",
    typeId = 37203,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_PigAndWolfFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_PigAndWolfFreeSpin.__index = PKG_Client_Slots_PigAndWolfFreeSpin

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_PigAndWolfNormalSpin = {
    typeName = "PKG_Client_Slots_PigAndWolfNormalSpin",
    typeId = 37201,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_PigAndWolfNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_PigAndWolfNormalSpin.__index = PKG_Client_Slots_PigAndWolfNormalSpin
...
PKG_PigAndWolf_Cell = {
    typeName = "PKG_PigAndWolf_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_PigAndWolf_Cell)
        end
        --[[
        点对应下标
        ]]
        ...
        o.icon = 0 -- Int32
        --[[
        点对应图形Id的类型 0为常规图形 其他为有奖图形 1是Mini 2是双倍Mini 3是Minor 4是Major 5是Grand
        ]]
        ...
        o.FromIndex = 0 -- Int32
        --[[
        滚分的值，当FromIndex=-2的时候才有意义
        ]]
        o.X10SymbolValue = 0 -- Double
        return o
    end,
    Read = function(self, om)
        local d = om.d
        ...
        if r ~= 0 then return r end
        -- FromIndex
        r, self.FromIndex = d:Rvi32()
        if r ~= 0 then return r end
        -- X10SymbolValue
        r, self.X10SymbolValue = d:Rd()
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
        ...
        d:Wvi32(self.ishide)
        -- FromIndex
        d:Wvi32(self.FromIndex)
        -- X10SymbolValue
        d:Wd(self.X10SymbolValue)
    end
}
PKG_PigAndWolf_Cell.__index = PKG_PigAndWolf_Cell

PKG_PigAndWolf_Line = {
    typeName = "PKG_PigAndWolf_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_PigAndWolf_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.PigAndWolf.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_PigAndWolf_Line.__index = PKG_PigAndWolf_Line
...
local o = ObjMgr
o.Register(PKG_PigAndWolf_NormalSpin)
o.Register(PKG_PigAndWolf_FreeSpin)
o.Register(PKG_PigAndWolf_SpecialSpin)
o.Register(PKG_Slots_Client_PigAndWolfNormalRet)
o.Register(PKG_Slots_Client_Enter_Success)
o.Register(PKG_Slots_Client_PigAndWolfFreeRet)
o.Register(PKG_Slots_Client_PigAndWolfSpecialSpinRet)
...
o.Register(PKG_Slots_Client_PigAndWolfEnterResumed)
o.Register(PKG_Client_Slots_PigAndWolfSpecialSpin)
o.Register(PKG_Client_Slots_PigAndWolfFreeSpin)
o.Register(PKG_Client_Slots_PigAndWolfNormalSpin)
