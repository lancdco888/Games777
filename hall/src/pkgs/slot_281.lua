...
CodeGen_slot_281_md5 ="#*MD5<0b20dbddd4a2d4b1a444dd89931542ad>*#"

--[[
Sugar请求特殊旋转图形
]]
PKG_Dragonsdeluxe_NormalSpin = {
    typeName = "PKG_Dragonsdeluxe_NormalSpin",
    typeId = 30681,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Dragonsdeluxe_NormalSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
        ...
        o.grids = {} -- List<PKG.Dragonsdeluxe.Cell>
        --[[
        是否进入免费游戏
        ]]
        o.intoFree = 0 -- Int32
        ...
        o.lines = {} -- List<PKG.Dragonsdeluxe.Line>
        --[[
        是否进入收集游戏
        ]]
    ...
    Read = function(self, om)
        ...
        self.grids = o
        for i = 1, len do
            o[i] = PKG_Dragonsdeluxe_Cell.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoFree
        ...
        self.lines = o
        for i = 1, len do
            o[i] = PKG_Dragonsdeluxe_Line.Create(); r = o[i]:Read(om)
            if r ~= 0 then return r end
        end
        if r ~= 0 then return r end
        -- intoCollect
...
PKG_Dragonsdeluxe_NormalSpin.__index = PKG_Dragonsdeluxe_NormalSpin

--[[
免费类型选择
]]
PKG_Dragonsdeluxe_FreeType = {
    typeName = "PKG_Dragonsdeluxe_FreeType",
    typeId = 30682,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Dragonsdeluxe_FreeType)
        end
        --[[
        倍率类型
        ]]
...
PKG_Dragonsdeluxe_FreeType.__index = PKG_Dragonsdeluxe_FreeType

--[[
Sugar请求特殊旋转图形
]]
PKG_Dragonsdeluxe_FreeSpin = {
    typeName = "PKG_Dragonsdeluxe_FreeSpin",
    typeId = 30683,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Dragonsdeluxe_FreeSpin)
        end
        --[[
        (一次旋转押注 )
        ]]
...
PKG_Dragonsdeluxe_FreeSpin.__index = PKG_Dragonsdeluxe_FreeSpin

--[[
狂野蛮牛-普通结果
]]
PKG_Slots_Client_DragonsdeluxeNormalRet = {
    typeName = "PKG_Slots_Client_DragonsdeluxeNormalRet", -- : PKG_Dragonsdeluxe_NormalSpin
    typeId = 30687,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DragonsdeluxeNormalRet)
        end
        PKG_Dragonsdeluxe_NormalSpin.Create(o)
    ...
    Read = function(self, om)
        ...
        local r, n, o
        -- base read
        r = PKG_Dragonsdeluxe_NormalSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
    ...
    Write = function(self, om)
        ...
        local o, len
        -- base read
        PKG_Dragonsdeluxe_NormalSpin.Write(self, om)
        -- slotMoneyGift
...
PKG_Slots_Client_DragonsdeluxeNormalRet.__index = PKG_Slots_Client_DragonsdeluxeNormalRet

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_DragonsdeluxeFreeRetType = {
    typeName = "PKG_Slots_Client_DragonsdeluxeFreeRetType", -- : PKG_Dragonsdeluxe_FreeType
    typeId = 30688,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DragonsdeluxeFreeRetType)
        end
        PKG_Dragonsdeluxe_FreeType.Create(o)
        return o
    end,
    Read = function(self, om)
        local d = om.d
        local r, n
        -- base read
        r = PKG_Dragonsdeluxe_FreeType.Read(self, om)
        if r ~= 0 then return r end
        return 0
    end,
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_Dragonsdeluxe_FreeType.Write(self, om)
    end
}
PKG_Slots_Client_DragonsdeluxeFreeRetType.__index = PKG_Slots_Client_DragonsdeluxeFreeRetType

--[[
狂野蛮牛 免费游戏结果
]]
PKG_Slots_Client_DragonsdeluxeFreeRet = {
    typeName = "PKG_Slots_Client_DragonsdeluxeFreeRet", -- : PKG_Dragonsdeluxe_FreeSpin
    typeId = 30689,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DragonsdeluxeFreeRet)
        end
        PKG_Dragonsdeluxe_FreeSpin.Create(o)
        o.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create() -- PKG.SlotsBase.SlotMoneyGift
        o.slotMoney = PKG_SlotsBase_SlotMoney.Create() -- PKG.SlotsBase.SlotMoney
        return o
    end,
    Read = function(self, om)
        ...
        local r, n
        -- base read
        r = PKG_Dragonsdeluxe_FreeSpin.Read(self, om)
        if r ~= 0 then return r end
        -- slotMoneyGift
        self.slotMoneyGift = PKG_SlotsBase_SlotMoneyGift.Create(); r = self.slotMoneyGift:Read(om)
        if r ~= 0 then return r end
    ...
    Write = function(self, om)
        local d = om.d
        -- base read
        PKG_Dragonsdeluxe_FreeSpin.Write(self, om)
        -- slotMoneyGift
        self.slotMoneyGift:Write(om)
        -- slotMoney
        self.slotMoney:Write(om)
...
PKG_Slots_Client_DragonsdeluxeFreeRet.__index = PKG_Slots_Client_DragonsdeluxeFreeRet
...
PKG_Client_Slots_DragonsdeluxeFreeSpin = {
    typeName = "PKG_Client_Slots_DragonsdeluxeFreeSpin",
    typeId = 30686,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_DragonsdeluxeFreeSpin)
        end
        return o
    end,
    Read = function(self, om)
...
PKG_Client_Slots_DragonsdeluxeFreeSpin.__index = PKG_Client_Slots_DragonsdeluxeFreeSpin
...
PKG_Slots_Client_DragonsdeluxeEnterResumed = {
    typeName = "PKG_Slots_Client_DragonsdeluxeEnterResumed",
    typeId = 30690,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Slots_Client_DragonsdeluxeEnterResumed)
        end
        --[[
        进入游戏的常规数据恢复
        ]]
        ...
        o.resumedNormal = PKG_Slots_Client_DragonsdeluxeNormalRet.Create() -- PKG.Slots_Client.DragonsdeluxeNormalRet
        --[[
        恢复免费游戏结果
        ]]
        o.resumedFree = PKG_Slots_Client_DragonsdeluxeFreeRet.Create() -- PKG.Slots_Client.DragonsdeluxeFreeRet
        --[[
        恢复免费类型结果
        ]]
        o.freeType = PKG_Slots_Client_DragonsdeluxeFreeRetType.Create() -- PKG.Slots_Client.DragonsdeluxeFreeRetType
        --[[
        游戏彩金已开的数组
        ]]
        o.cells = {} -- List<Int32>
    ...
    Read = function(self, om)
        ...
        if r ~= 0 then return r end
        -- resumedNormal
        self.resumedNormal = PKG_Slots_Client_DragonsdeluxeNormalRet.Create(); r = self.resumedNormal:Read(om)
        if r ~= 0 then return r end
        -- resumedFree
        self.resumedFree = PKG_Slots_Client_DragonsdeluxeFreeRet.Create(); r = self.resumedFree:Read(om)
        if r ~= 0 then return r end
        -- freeType
        self.freeType = PKG_Slots_Client_DragonsdeluxeFreeRetType.Create(); r = self.freeType:Read(om)
        if r ~= 0 then return r end
        -- cells
        r, len = d:Rvu32()
        if len > d:GetLeft() then return -1 end
...
PKG_Slots_Client_DragonsdeluxeEnterResumed.__index = PKG_Slots_Client_DragonsdeluxeEnterResumed

--[[
发财树 请求免费类型
]]
PKG_Client_Slots_DragonsdeluxeFreeType = {
    typeName = "PKG_Client_Slots_DragonsdeluxeFreeType",
    typeId = 30685,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_DragonsdeluxeFreeType)
        end
        --[[
        押注类型
        ]]
...
PKG_Client_Slots_DragonsdeluxeFreeType.__index = PKG_Client_Slots_DragonsdeluxeFreeType

--[[
Sugar请求获取生成图形
]]
PKG_Client_Slots_DragonsdeluxeNormalSpin = {
    typeName = "PKG_Client_Slots_DragonsdeluxeNormalSpin",
    typeId = 30684,
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Client_Slots_DragonsdeluxeNormalSpin)
        end
        --[[
        押注金额
        ]]
...
PKG_Client_Slots_DragonsdeluxeNormalSpin.__index = PKG_Client_Slots_DragonsdeluxeNormalSpin
...
PKG_Dragonsdeluxe_Cell = {
    typeName = "PKG_Dragonsdeluxe_Cell",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Dragonsdeluxe_Cell)
        end
        --[[
        点对应下标
        ]]
...
PKG_Dragonsdeluxe_Cell.__index = PKG_Dragonsdeluxe_Cell

PKG_Dragonsdeluxe_Line = {
    typeName = "PKG_Dragonsdeluxe_Line",
    Create = function(o)
        if o == nil then
            o = {}
            setmetatable(o, PKG_Dragonsdeluxe_Line)
        end
        --[[
        中奖线(eg:1号线)
        ]]
        ...
        o.lineCells = {} -- List<PKG.Dragonsdeluxe.Cell>
        return o
    end,
    Read = function(self, om)
        local d = om.d
...
PKG_Dragonsdeluxe_Line.__index = PKG_Dragonsdeluxe_Line
...
local o = ObjMgr
o.Register(PKG_Dragonsdeluxe_NormalSpin)
o.Register(PKG_Dragonsdeluxe_FreeType)
o.Register(PKG_Dragonsdeluxe_FreeSpin)
o.Register(PKG_Slots_Client_DragonsdeluxeNormalRet)
o.Register(PKG_Slots_Client_DragonsdeluxeFreeRetType)
o.Register(PKG_Slots_Client_DragonsdeluxeFreeRet)
...
o.Register(PKG_Client_Slots_DragonsdeluxeFreeSpin)
o.Register(PKG_Slots_Client_SyncPlayerStates)
o.Register(PKG_Slots_Client_CollectValue)
o.Register(PKG_Slots_Client_DragonsdeluxeEnterResumed)
o.Register(PKG_Client_Slots_DragonsdeluxeFreeType)
o.Register(PKG_Client_Slots_DragonsdeluxeNormalSpin)
