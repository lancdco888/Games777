-- @ref https://github.com/u0u0/Lua-utils/blob/master/src/app/utils/TableViewPro.lua
...
function TableView.attachTo(scrollView)
	-- assert(tolua.type(scrollView) == "axui.ScrollView")
...
cc.TableViewPro = TableView
cc.TableViewCellPro = TableViewCell
cc.TableViewFillOrderPro = TableViewFillOrder
cc.TableViewDirectionPro = TableViewDirection
cc.TableViewFuncTypePro = TableViewFuncType