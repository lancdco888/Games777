...
function BigWin:ctor(game)
    self.game = game
    self.render = FairyGUI.UIPackage.CreateObject("Game481", "BigWin")
...
function BigWin:OnComplete(curTransitionName,bigWinAudioName)
    ...
    Utils.PlaySound("ui://Game481/"..bigWinAudioName.."_end")
    ...
    Utils.SetTimeout(function()
        ...
        -- Utils.PlaySound("ui://Game481/bgm_bigwin_end")
...
function BigWin:PlayScoreAnim(curWinCoin, callback)
    ...
    self.render:GetTransition(curTransitionName.."-in"):Play(function()
            ...
            Utils.PlaySound("ui://Game481/win_applause")
        ...
        self.scoreSoundHandler = Utils.PlaySound("ui://Game481/"..bigWinAudioName,true)
