...
---@class Game482Hub extends GameProtocolHub
local Game482Hub = class("Game482Hub", super)

function Game482Hub:parseNormalSpinRet(aData)
    local ret = { 
        normalSpin = {
        }
    }
...
function Game482Hub:parseFreeSpinRet(aData)
...
function Game482Hub:parseResumeData(aEnter, aEnterData, aResume)
...
function Game482Hub:parseResults(results)
    -- dump(results,"Game482Hub:parseResults>>>>>>>>>>>>>>>>>>",6)
    local result = {
        array = {}
    }
...
function Game482Hub:parseGrids(grids)
    local res = {}
...
function Game482Hub:parseLineGrids(lineCells)
    local res = {}
...
function Game482Hub:parseLines(lines)
    local res = {}
...
function Game482Hub:parseResult(aData)
    return {
