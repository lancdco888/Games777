...
function PkgHub:ctor(...)
    ...
    self.protoMap = {
        ...
        ['PKG_Slots_Client_GatesOfOlympusFreeRet'] = 'PB.Slots_Client.GatesOfOlympusFreeRet',
        ['PKG_Client_Slots_GatesOfOlympusNormalSpin'] = 'PB.Client_Slots.GatesOfOlympusNormalSpin',
        ['PKG_Slots_Client_Leave_Success'] = 'PB.Slots_Client.Leave_Success',
        ['PKG_Slots_Client_CollectValue'] = 'PB.Slots_Client.CollectValue',
        ['PKG_Slots_Client_GatesOfOlympusNormalRet'] = 'PB.Slots_Client.GatesOfOlympusNormalRet',
        ['PKG_Slots_Client_GatesOfOlympusEnterResumed'] = 'PB.Slots_Client.GatesOfOlympusEnterResumed',
        ...
        ['PKG_Client_Slots_GatesOfOlympusFreeSpin'] = 'PB.Client_Slots.GatesOfOlympusFreeSpin',
...
function PkgHub:Pkg2Pb(pkg)
    ...
    if pkg.typeName == 'PKG_Slots_Client_GatesOfOlympusFreeRet' then
        pb.freeSpin = {}
        ...
        for ik, iv in pairs(pkg.freeSpin.results.array) do
            ...
            for jk, jv in pairs(iv.grids) do
                ...
                pb.freeSpin.results.array[ik].grids[jk].value = jv.value
            end
            ...
            for jk, jv in pairs(iv.lines) do
                ...
                for kk, kv in pairs(jv.lineCells) do
                    ...
                    pb.freeSpin.results.array[ik].lines[jk].lineCells[kk].value = kv.value
                end
            end
        end
        ...
        pb.freeSpin.totalFreeTime = pkg.freeSpin.totalFreeTime
        pb.freeSpin.freeTime = pkg.freeSpin.freeTime
        pb.freeSpin.newFreeTime = pkg.freeSpin.newFreeTime
        pb.freeSpin.AccuScale = pkg.freeSpin.AccuScale
        return pb
    ...
    elseif pkg.typeName == 'PKG_Slots_Client_CollectValue' then
        ...
        return pb
    elseif pkg.typeName == 'PKG_Slots_Client_GatesOfOlympusNormalRet' then
        pb.normalSpin = {}
        ...
        for ik, iv in pairs(pkg.normalSpin.results.array) do
            ...
            for jk, jv in pairs(iv.grids) do
                ...
                pb.normalSpin.results.array[ik].grids[jk].value = jv.value
            end
            ...
            for jk, jv in pairs(iv.lines) do
                ...
                for kk, kv in pairs(jv.lineCells) do
                    ...
                    pb.normalSpin.results.array[ik].lines[jk].lineCells[kk].value = kv.value
                end
            end
        end
        ...
        return pb
    elseif pkg.typeName == 'PKG_Slots_Client_GatesOfOlympusEnterResumed' then
        pb.lvID = pkg.lvID
        ...
        for ik, iv in pairs(pkg.resumedNormal.normalSpin.results.array) do
            ...
            for jk, jv in pairs(iv.grids) do
                ...
                pb.resumedNormal.normalSpin.results.array[ik].grids[jk].value = jv.value
            end
            ...
            for jk, jv in pairs(iv.lines) do
                ...
                for kk, kv in pairs(jv.lineCells) do
                    ...
                    pb.resumedNormal.normalSpin.results.array[ik].lines[jk].lineCells[kk].value = kv.value
                end
            end
        end
        ...
        -- 警告:使用模糊匹配 resumedFree -> resumedFreeRet 开始
        pb.resumedFree = {}
        pb.resumedFree.freeSpin = {}
        pb.resumedFree.freeSpin.bet = pkg.resumedFreeRet.freeSpin.bet
        pb.resumedFree.freeSpin.winCoin = pkg.resumedFreeRet.freeSpin.winCoin
        pb.resumedFree.freeSpin.results = {}
        pb.resumedFree.freeSpin.results.array = {}
        
        for ik, iv in pairs(pkg.resumedFreeRet.freeSpin.results.array) do
            ...
            for jk, jv in pairs(iv.grids) do
                ...
                pb.resumedFree.freeSpin.results.array[ik].grids[jk].value = jv.value
            end
            ...
            for jk, jv in pairs(iv.lines) do
                ...
                for kk, kv in pairs(jv.lineCells) do
                    ...
                    pb.resumedFree.freeSpin.results.array[ik].lines[jk].lineCells[kk].value = kv.value
                end
            end
        end
        
        pb.resumedFree.freeSpin.slotMoneyGift = {}
        pb.resumedFree.freeSpin.slotMoneyGift.money_gift = pkg.resumedFreeRet.freeSpin.slotMoneyGift.money_gift
        pb.resumedFree.freeSpin.slotMoneyGift.money_gift_safe = pkg.resumedFreeRet.freeSpin.slotMoneyGift.money_gift_safe
        pb.resumedFree.freeSpin.slotMoneyGift.amount_of_gift = pkg.resumedFreeRet.freeSpin.slotMoneyGift.amount_of_gift
        pb.resumedFree.freeSpin.slotMoney = {}
        pb.resumedFree.freeSpin.slotMoney.money = pkg.resumedFreeRet.freeSpin.slotMoney.money
        pb.resumedFree.freeSpin.slotMoney.money_safe = pkg.resumedFreeRet.freeSpin.slotMoney.money_safe
        pb.resumedFree.freeSpin.bonusWinCoin = pkg.resumedFreeRet.freeSpin.bonusWinCoin
        pb.resumedFree.freeSpin.totalFreeTime = pkg.resumedFreeRet.freeSpin.totalFreeTime
        pb.resumedFree.freeSpin.freeTime = pkg.resumedFreeRet.freeSpin.freeTime
        pb.resumedFree.freeSpin.newFreeTime = pkg.resumedFreeRet.freeSpin.newFreeTime
        pb.resumedFree.freeSpin.AccuScale = pkg.resumedFreeRet.freeSpin.AccuScale
        -- 警告:使用模糊匹配 resumedFree -> resumedFreeRet 结束
...
function PkgHub:Pb2Pkg(pb)
    if pb._msgName_ == 'PB.Client_Slots.GatesOfOlympusNormalSpin' then
        local pkg = PKG_Client_Slots_GatesOfOlympusNormalSpin.Create()
        pkg.betMoney = pb.betMoney
        pkg.lvID = pb.lvID
        pkg.moneyType = pb.moneyType
        return pkg
    elseif pb._msgName_ == 'PB.Client_Slots.GatesOfOlympusFreeSpin' then
        local pkg = PKG_Client_Slots_GatesOfOlympusFreeSpin.Create()
        return pkg
    end
