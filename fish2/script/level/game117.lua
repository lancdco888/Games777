...
local InitTimeline = function()
    ...
    local scene2 = FishEventHelper.CreateScene(53)
    ...
    do
        ...
        for i = 10, 300, 14 do
            scene.AddFishBornEvent(i, {
                fish = {10113,10114,10115,10071},      -- 指定鱼组
                fishTypeCount = {1},
                intervalTime = 1,
