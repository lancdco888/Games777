...
local InitTimeline = function()
    ...
    --场景1：赤焰龙龟304 场景6 ，狂暴火龙309 场景5
    do
     
        local scene = scene1
        scene.PushFishGroups(fishGroup)
        scene.AddSwitchBgEvent(0, 18)   -- 场景
        ...
        -- 第一段场景时间划分
            ...
            scene.AddBossWarningEvent(t1 +2.5, FF_G.BossWarning_BossCome, {fishTypeId = 304})
        ...
        -- 第二段场景时间划分
            ...
            scene.AddBossWarningEvent(t1+t2+t3 +2.5, FF_G.BossWarning_BossCome, {fishTypeId = 309})
            scene.AddSwitchBgMusicEvent(t1+t2+t3+2.8, "bossstage") --下个场景音效
            scene.AddSwitchBgEvent(t1+t2+t3 +2.5, 5) -- 场景
    ...
    --场景3：凤凰207 场景7，狂暴火龙309 场景5
    
    do
     
        local scene = scene3
        scene.PushFishGroups(fishGroup)
        scene.AddSwitchBgEvent(0, 4)   -- 场景
        ...
        -- 第一段场景时间划分
            ...
            -- scene.AddSwitchBgMusicEvent(t1, "jingbao") --警报响
            scene.AddBossWarningEvent(t1, FF_G.BossWarning_Purple) --预警泛紫
            scene.AddBossWarningEvent(t1 +2.5, FF_G.BossWarning_BossCome, {fishTypeId = 207})
            for i = t1+2.8+34 , t1+t2 , 30+37+34 do
                scene.AddSwitchBgMusicEvent(i, "bg_king") --30
            end
            for i = t1+2.8+30+34 ,t1+t2, 30+37+34 do
        ...
        -- 第二段场景时间划分
            ...
            scene.AddSwitchBgEvent(t1+t2+t3 +4.5, 5) -- 场景
        ...
        -- 炸弹，钻头蟹
            ...
            for i = t1+t2+t3+18, t1+t2+t3+t4+t5-40, 45 do
                scene.AddFishBornEvent(i, {
                    fish = fishGroup["Carb"],
                    fishTypeCount = {1},
                    pathwayGroup = "Group_Carb",
    ...
    do
        ...
        -- 炸弹，钻头蟹
            ...
            for i = t1+t2+t3+8, t1+t2+t3+t4+t5-40, 21 do
                scene.AddFishBornEvent(i, {
                    fish = fishGroup["Carb"],
                    fishTypeCount = {1},
                    pathwayGroup = "Group_Carb",
